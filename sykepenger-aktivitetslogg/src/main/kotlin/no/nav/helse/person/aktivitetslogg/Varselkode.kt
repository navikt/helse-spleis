...
enum class Varselkode(
    ...
    RV_SØ_5("Søknaden inneholder Permisjonsdager utenfor sykdomsvindu", avviklet = true),
    RV_SØ_6("Søknaden inneholder egenmeldingsdager etter sykmeldingsperioden", avviklet = true),
    RV_SØ_7("Søknaden inneholder Arbeidsdager utenfor sykdomsvindu", avviklet = true),
    ...
    RV_IM_22("Det er mottatt flere inntektsmeldinger på kort tid for samme arbeidsgiver", avviklet = true),
    RV_IM_23("Arbeidsgiver har oppgitt hullete arbeidsgiverperiode og begrunnelse for redusert utbetaling i arbeidsgiverperiode", avviklet = true),
    ...
    RV_IM_28("Inntektsmeldingen oppgir flere arbeidsforhold"),
    ...
    RV_IT_17("Forespurt overstyring av inntekt hvor skjæringstidspunktet ligger i infotrygd", avviklet = true),
    ...
    RV_IT_38("En utbetaling i Infotrygd har medført at perioden nå vil utbetales", avviklet = true),
    ...
    RV_VV_10("Fant ikke vilkårsgrunnlag. Kan ikke vilkårsprøve på nytt etter ny informasjon fra saksbehandler.", avviklet = true),
    ...
    RV_IV_14("Èn arbeidsgiver, ingen inntekter i samme måned som skjæringstidspunktet, siste ankomne inntektsmelding er lagt til grunn", avviklet = true),
    ...
    RV_UT_9("Forventet ikke å annullere på utbetaling", avviklet = true),
    RV_UT_10("Forventet ikke overførtkvittering på utbetaling", avviklet = true),
    RV_UT_11("Forventet ikke kvittering på utbetaling", avviklet = true),
    RV_UT_12("Forventet ikke simulering på utbetaling", avviklet = true),
    ...
    RV_UT_18("Utbetaling markert som ikke godkjent automatisk", avviklet = true),
    RV_UT_19("Utbetaling markert som ikke godkjent av saksbehandler", avviklet = true),
    ...
    RV_UT_25("Forventet ikke å overføre utbetalingen", avviklet = true),
    ...
    RV_RV_2("Forkaster avvist revurdering ettersom vedtaksperioden ikke har tidligere utbetalte utbetalinger.", avviklet = true),
