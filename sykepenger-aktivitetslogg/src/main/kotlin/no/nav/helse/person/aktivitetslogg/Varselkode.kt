...
enum class Varselkode(
    ...
    RV_SØ_14(
        "Mottatt flere søknader for annen periode enn siste skjæringstidspunkt",
        avviklet = true,
    ),
    RV_SØ_15(
    ...
    RV_SØ_17(
        "Søker er ikke gammel nok på søknadstidspunktet til å søke sykepenger uten fullmakt fra verge"
    ),
    RV_SØ_18("Søknaden inneholder andre inntektskilder enn ANDRE_ARBEIDSFORHOLD", avviklet = true),
    RV_SØ_19("Søknad forlenger en forkastet periode", avviklet = true),
    ...
    RV_SØ_40(
        "Støtter ikke søknadstypen for forlengelser vilkårsprøvd i Infotrygd",
        avviklet = true,
    ),
    RV_SØ_41(
        "Støtter kun søknadstypen hvor den aktuelle arbeidsgiveren er den eneste i sykepengegrunnlaget",
        avviklet = true,
    ),
    ...
    RV_SØ_43(
        "Arbeidsledigsøknad er lagt til grunn, undersøk refusjonsopplysningene før du utbetaler"
    ),
    RV_SØ_44(
        "I søknaden er det oppgitt at den sykmeldte har et arbeidsforhold som ikke er registrert i AA-registeret."
    ),
    ...
    RV_IM_10(
        "Første fraværsdag i inntektsmeldingen er forskjellig fra foregående tilstøtende periode",
        avviklet = true,
    ),
    RV_IM_11(
    ...
    RV_IM_13(
        "Første fraværsdag i inntektsmeldingen er utenfor sykmeldingsperioden",
        avviklet = true,
    ),
    RV_IM_14(
    ...
    RV_IM_17(
        "Inntektsmelding inneholder ikke arbeidsgiverperiode. Vurder om  arbeidsgiverperioden beregnes riktig",
        avviklet = true,
    ),
    RV_IM_18(
    ...
    RV_IM_20(
        "Finner ikke informasjon om refusjon i inntektsmelding og personen har brukerutbetaling",
        avviklet = true,
    ),
    RV_IM_21(
    ...
    RV_IM_23(
        "Arbeidsgiver har oppgitt hullete arbeidsgiverperiode og begrunnelse for redusert utbetaling i arbeidsgiverperiode"
    ),
    RV_IM_24("Det har kommet ny inntektsmelding, vurder om arbeidsgiverperiode er riktig"),
    RV_IM_25(
        "Arbeidsgiver har redusert utbetaling av arbeidsgiverperioden grunnet ferie eller avspasering"
    ),
    ...
    RV_IT_6(
        "Det er en ugyldig utbetalingsperiode i Infotrygd (mangler fom- eller tomdato)",
        avviklet = true,
    ),
    RV_IT_7(
    ...
    RV_IT_8(
        "Det er en ugyldig utbetalingsperiode i Infotrygd (utbetalingsgrad mangler)",
        avviklet = true,
    ),
    RV_IT_9(
        "Det er en ugyldig utbetalingsperiode i Infotrygd (utbetalingsgrad er mindre eller lik 0)",
        avviklet = true,
    ),
    ...
    RV_IT_15("Personen er ikke registrert som normal arbeidstaker i Infotrygd", avviklet = true),
    RV_IT_16("Støtter ikke saker med vilkårsgrunnlag i Infotrygd", avviklet = true),
    RV_IT_17(
        "Forespurt overstyring av inntekt hvor skjæringstidspunktet ligger i infotrygd",
        avviklet = true,
    ),
    RV_IT_18(
        "Avslutter perioden fordi tilstøtende, eller nyere periode, gikk til Infotrygd",
        avviklet = true,
    ),
    RV_IT_19(
        "Dagsatsen har endret seg minst én gang i en historisk, sammenhengende periode i Infotrygd.",
        avviklet = true,
    ),
    RV_IT_20(
    ...
    RV_IT_25(
        "Har utbetalt periode i Infotrygd nærmere enn 18 dager fra første dag",
        avviklet = true,
    ),
    RV_IT_26(
    ...
    RV_IT_36(
        "Periode som før var uten utbetalingsdager har nå utbetalingsdager etter endringer fra Infotrygd",
        avviklet = true,
    ),
    ...
    RV_VV_10(
        "Fant ikke vilkårsgrunnlag. Kan ikke vilkårsprøve på nytt etter ny informasjon fra saksbehandler."
    ),
    RV_VV_11(
        "Vilkårsgrunnlaget ligger i infotrygd. Det er ikke støttet i revurdering eller overstyring.",
        avviklet = true,
    ),
    RV_VV_12(
        "Kan ikke overstyre inntekt uten at det foreligger et vilkårsgrunnlag",
        avviklet = true,
    ),
    RV_VV_13(
    ...
    RV_IV_8(
        "Perioden har flere skjæringstidspunkter og det er dager hvor inntekten derfor er satt til 0 kr",
        avviklet = true,
    ),
    ...
    RV_SV_3(
        "Mangler inntekt for sykepengegrunnlag som følge av at skjæringstidspunktet har endret seg",
        avviklet = true,
    ),
    RV_SV_4(
    ...
    RV_SI_2(
        "Simulering av revurdert utbetaling feilet. Utbetalingen må annulleres",
        avviklet = true,
    ),
    RV_SI_3("Det er simulert et negativt beløp."),
    RV_SI_4("Ingenting ble simulert", avviklet = true),
    RV_SI_5(
        "Simulering har endret dagsats eller antall på én eller flere utbetalingslinjer",
        avviklet = true,
    ),
    ...
    // UT: Utbetaling
    RV_UT_1(
        "Utbetaling av revurdert periode ble avvist av saksbehandler. Utbetalingen må annulleres",
        avviklet = true,
    ),
    ...
    RV_RV_2(
        "Forkaster avvist revurdering ettersom vedtaksperioden ikke har tidligere utbetalte utbetalinger."
    ),
    RV_RV_3(
        "Forespurt revurdering av inntekt hvor personen har flere arbeidsgivere (inkl. ghosts)",
        avviklet = true,
    ),
    ...
    RV_RV_7(
        "En tidligere periode er annullert. Den må være utbetalt i Infotrygd før denne perioden kan behandles."
    ),
    ...
    RV_VT_5("Forventet ikke utbetaling", avviklet = true),
    ...
    RV_AN_4(
        "Personen har blitt tilbakestilt og kan derfor ha avvik i historikken fra infotrygd.",
        avviklet = true,
    ),
