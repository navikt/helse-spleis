...
enum class GraphQLUtbetalingstatus {
    ...
    IkkeGodkjent,
    Overfort,
    @Deprecated("skal slettes") Sendt,
    Ubetalt,
    @Deprecated("skal slettes") UtbetalingFeilet,
    Utbetalt,
}

data class GraphQLSykdomsdagkilde(val id: UUID, val type: GraphQLSykdomsdagkildetype)
...
data class GraphQLPeriodevilkar(val sykepengedager: Sykepengedager, val alder: Alder) {
