...
class SykdomstidslinjeIteratorTest {
    ...
    fun `sykmelding mandag til søndag fører til 7 dager hvor vi teller med helg`() {
        ...
        assertEquals(7, sykdager.syketilfeller().first().tidslinje.antallSykedagerHvorViTellerMedHelg())
    }
    ...
    fun `sykmelding mandag til lørdag fører til 6 dager`() {
        ...
        assertEquals(6, sykedager.syketilfeller().first().tidslinje.antallSykedagerHvorViTellerMedHelg())
        assertEquals(5, sykedager.syketilfeller().first().tidslinje.antallSykedagerHvorViIkkeTellerMedHelg())
    }
