...
class Utbetalingstidslinje private constructor(
    private val utbetalingsdager: SortedMap<LocalDate, Utbetalingsdag>,
    ...
    companion object {
        ...
        fun betale(tidslinjer: List<Utbetalingstidslinje>): List<Utbetalingstidslinje> = beregnDagForDag(tidslinjer, Økonomi::betal)

        fun totalSykdomsgrad(tidslinjer: List<Utbetalingstidslinje>): List<Utbetalingstidslinje> =
            beregnDagForDag(tidslinjer, Økonomi::totalSykdomsgrad)
    ...
    private fun tidligsteDato(other: Utbetalingstidslinje) = minOf(this.førsteDato, other.førsteDato)
    ...
    operator fun get(dato: LocalDate) = utbetalingsdager[dato] ?: UkjentDag(dato, Økonomi.ikkeBetalt())

    override fun toString(): String =
        utbetalingsdager.values
    ...
    class Builder {
        ...
        fun addArbeidsgiverperiodedagNav(
            dato: LocalDate,
            økonomi: Økonomi,
        ) {
