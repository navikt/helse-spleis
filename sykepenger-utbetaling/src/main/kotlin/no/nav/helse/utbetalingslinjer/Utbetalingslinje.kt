...
class Utbetalingslinje(
    ...
    companion object {
        ...
        fun List<Utbetalingslinje>.kobleTil(fagsystemId: String) =
            map { linje ->
        ...
        private fun fjernLinjerUtenUtbetalingsdager(linjer: List<Utbetalingslinje>) = linjer.filterNot { it.beløp == null || it.beløp == 0 }
    ...
    fun slåSammenLinje(førsteLinjeIForrige: Utbetalingslinje): Utbetalingslinje? {
        if (this.beløp != førsteLinjeIForrige.beløp ||
