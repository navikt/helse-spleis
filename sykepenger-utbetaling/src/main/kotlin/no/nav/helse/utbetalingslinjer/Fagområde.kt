...
enum class Fagområde(val verdi: String, private val klassekode: Klassekode) {
    ...
    fun linje(fagsystemId: String, økonomi: Økonomi, dato: LocalDate, grad: Int) =
        Utbetalingslinje(
            ...
            dato,
            Satstype.Daglig,
            økonomi.dagligBeløpForFagområde(this),
            grad,
            fagsystemId,
    ...
    fun kanLinjeUtvides(linje: Utbetalingslinje, økonomi: Økonomi, grad: Int) =
        grad == linje.grad &&
            (linje.beløp == null || linje.beløp == økonomi.dagligBeløpForFagområde(this))
