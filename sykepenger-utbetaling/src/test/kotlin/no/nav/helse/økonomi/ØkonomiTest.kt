...
internal class ØkonomiTest {
    ...
    private val `6g` = 561804.årlig

    @Test
    fun `er 6g-begrensning selv om dekningsgrunnlaget er lavere`() {
        val over6g = `6g` + 260.daglig
        val økonomi =
            listOf(100.prosent.sykdomsgrad.inntekt(over6g, dekningsgrunnlag = `6g`, `6G` = `6g`))
        val betalte = Økonomi.betal(økonomi)
        assertTrue(betalte.er6GBegrenset()) {
            "sykepengegrunnlaget regnes ut fra innrapportert inntekt (§ 8-28) og ikke dekningsgrunnlaget"
        }
    }
    ...
    fun `akkurat under 20-prosent-grensen`() {
        val økonomi =
            listOf(
                8.prosent.sykdomsgrad.inntekt(30000.månedlig, `6G` = `6g`),
                54.prosent.sykdomsgrad.inntekt(10312.40.månedlig, `6G` = `6g`),
            )
    ...
    fun `total sykdomsgrad regnes ut fra aktuell dagsinntekt`() {
        ...
        val økonomi =
            listOf(
                100.prosent.sykdomsgrad.inntekt(inntekt, dekningsgrunnlag = inntekt, `6G` = `6g`),
                50.prosent.sykdomsgrad.inntekt(inntekt, dekningsgrunnlag = INGEN, `6G` = `6g`),
            )
    ...
    fun `to arbeidsgivere gikk inn i en bar og ba om 20 prosent hver`() {
        ...
        val økonomi =
            listOf(
                20.prosent.sykdomsgrad.inntekt(inntektA1, `6G` = `6g`),
                20.prosent.sykdomsgrad.inntekt(inntektA2, `6G` = `6g`),
            )
    ...
    fun `kan ikke sette dagsats mer enn en gang`() {
        assertThrows<IllegalStateException> {
            25.prosent.sykdomsgrad
                .inntekt(1200.daglig, 1200.daglig, `6G` = `6g`)
                .inntekt(800.daglig, 800.daglig, `6G` = `6g`)
        }
    }
    ...
    fun singelsykegrad() {
        assertEquals(
            75.prosent,
            listOf(75.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`))
                .totalSykdomsgrad(),
        )
    }
    ...
    fun singelsykegradUtenInntekt() {
        assertEquals(
            75.prosent,
            listOf(75.prosent.sykdomsgrad.inntekt(0.daglig, 0.daglig, `6G` = `6g`))
                .totalSykdomsgrad(),
        )
    }
    ...
    fun `to arbeidsgivere`() {
        assertEquals(
            38.prosent,
            listOf(
                    50.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`),
                    20.prosent.sykdomsgrad.inntekt(800.daglig, 800.daglig, `6G` = `6g`),
                )
                .totalSykdomsgrad()
                .also { assertFalse(it.erUnderGrensen()) },
        )
    }
    ...
    fun `to arbeidsgivereUtenInntekt`() {
        assertEquals(
            35.prosent,
            listOf(
                    50.prosent.sykdomsgrad.inntekt(0.daglig, 0.daglig, `6G` = `6g`),
                    20.prosent.sykdomsgrad.inntekt(0.daglig, 0.daglig, `6G` = `6g`),
                )
                .totalSykdomsgrad()
                .also { assertFalse(it.erUnderGrensen()) },
        )
    ...
    fun `flere arbeidsgivere`() {
        assertEquals(
            ...
            listOf(
                    50.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`),
                    20.prosent.sykdomsgrad.inntekt(800.daglig, 800.daglig, `6G` = `6g`),
                    60.prosent.sykdomsgrad.inntekt(2000.daglig, 2000.daglig, `6G` = `6g`),
                )
                .totalSykdomsgrad(),
        )
    }
    ...
    fun `låst økonomi fungerer ikke som arbeidsdag ved total sykdomsgrad`() {
        assertEquals(
            ...
            listOf(
                    50.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`),
                    20.prosent.sykdomsgrad.inntekt(800.daglig, 800.daglig, `6G` = `6g`),
                    60.prosent.sykdomsgrad.inntekt(2000.daglig, 2000.daglig, `6G` = `6g`).lås(),
                )
                .totalSykdomsgrad()
                .also { assertFalse(it.erUnderGrensen()) },
        )
    ...
    fun `kan låse igjen hvis allerede låst`() {
        assertDoesNotThrow {
            50.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`).lås().lås()
        }
    }

    @Test
    fun `kan ikke låses etter betaling`() {
        50.prosent.sykdomsgrad
            .inntekt(1200.daglig, 1200.daglig, `6G` = `6g`, refusjonsbeløp = 1200.daglig)
            .also { økonomi ->
    ...
    fun `arbeidsgiverrefusjon med inntekt`() {
        100.prosent.sykdomsgrad
            .inntekt(1000.daglig, `6G` = `6g`, refusjonsbeløp = 1000.daglig)
            .also { økonomi ->
    ...
    fun `dekningsgrunnlag returns clone`() {
        50.prosent.sykdomsgrad.also { original ->
            assertNotSame(original, original.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`))
        }
    }

    @Test
    fun `kan ikke låses etter utbetaling`() {
        50.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`).also { økonomi ->
            val betalte = listOf(økonomi).betal()
            assertThrows<IllegalStateException> { betalte.single().lås() }
        }
    }
    ...
    fun `toMap med dekningsgrunnlag`() {
        val økonomi = 79.5.prosent.sykdomsgrad.inntekt(1200.4.daglig, 1200.4.daglig, `6G` = `6g`)
        assertEquals(79.5, økonomi.inspektør.grad.toDouble())
    ...
    fun `toIntMap med dekningsgrunnlag`() {
        79.5.prosent.sykdomsgrad.inntekt(1200.4.daglig, 1200.4.daglig, `6G` = `6g`).also { økonomi
            ->
            assertEquals(79.5, økonomi.inspektør.grad.toDouble())
            assertEquals(1200.4.daglig, økonomi.inspektør.dekningsgrunnlag)
        }
    ...
    fun `kan beregne betaling bare en gang`() {
        assertThrows<IllegalStateException> {
            listOf(80.prosent.sykdomsgrad.inntekt(1200.daglig, 1200.daglig, `6G` = `6g`))
                .betal()
                .betal()
        }
    }
    ...
    fun `arbeidsgiver og person splittes tilsvarer totalt`() {
        100.prosent.sykdomsgrad
            .inntekt(999.daglig, `6G` = `6g`, refusjonsbeløp = 499.5.daglig)
            .also {
                val betalte = listOf(it).betal()
                betalte.single().also { økonomi ->
    ...
    fun `tre arbeidsgivere uten grenser`() {
        val a = 50.prosent.sykdomsgrad.inntekt(600.daglig, `6G` = `6g`, refusjonsbeløp = 300.daglig)
        val b = 20.prosent.sykdomsgrad.inntekt(400.daglig, `6G` = `6g`, refusjonsbeløp = 400.daglig)
        val c = 60.prosent.sykdomsgrad.inntekt(1000.daglig, `6G` = `6g`, refusjonsbeløp = 0.daglig)
        val betalte =
            listOf(a, b, c).betal().also { assertEquals(49.prosent, it.totalSykdomsgrad()) }
        betalte.forEach { assertFalse(it.er6GBegrenset()) }
    ...
    fun `tre arbeidsgivere med persongrense`() {
        ...
        val b = 20.prosent.sykdomsgrad.inntekt(800.daglig, `6G` = `6g`, refusjonsbeløp = 800.daglig)
        val c = 60.prosent.sykdomsgrad.inntekt(2000.daglig, `6G` = `6g`, refusjonsbeløp = 0.daglig)
        val betalte =
            listOf(a, b, c).betal().also {
                assertEquals(49.prosent, it.totalSykdomsgrad())
                // grense = 1059
            }
        betalte.forEach { assertTrue(it.er6GBegrenset()) }
    ...
    fun `tre arbeidsgivere over 6G, ingen personutbetaling`() {
        val a =
            40.prosent.sykdomsgrad.inntekt(
                30000.månedlig,
                `6G` = `6g`,
        ...
        val b =
            50.prosent.sykdomsgrad.inntekt(
                10000.månedlig,
                `6G` = `6g`,
                refusjonsbeløp = 10000.månedlig,
            )
        val c =
            70.prosent.sykdomsgrad.inntekt(
                15000.månedlig,
                `6G` = `6g`,
    ...
    fun `tre arbeidsgivere med arbeidsgivere`() {
        val a =
            50.prosent.sykdomsgrad.inntekt(4800.daglig, `6G` = `6g`, refusjonsbeløp = 2400.daglig)
        val b =
            20.prosent.sykdomsgrad.inntekt(3200.daglig, `6G` = `6g`, refusjonsbeløp = 3200.daglig)
        val c = 60.prosent.sykdomsgrad.inntekt(8000.daglig, `6G` = `6g`, refusjonsbeløp = 0.daglig)
        val betalte = listOf(a, b, c).betal()
        assertEquals(49.prosent, betalte.totalSykdomsgrad())
        assertTrue(betalte.er6GBegrenset())
        assertUtbetaling(betalte[0], 691.0, 0.0) // (1059 / (1200 + 640)) * 1200
    ...
    fun `eksempel fra regneark`() {
        ...
        val c =
            20.prosent.sykdomsgrad.inntekt(
                31000.månedlig,
                `6G` = `6g`,
    ...
    fun `Sykdomdsgrad rundes opp`() {
        ...
        val b =
            21.prosent.sykdomsgrad.inntekt(
                10000.daglig,
                10000.daglig,
                `6G` = `6g`,
                refusjonsbeløp = 10000.daglig,
    ...
    fun `fordeling mellom arbeidsgivere med lik inntekt og refusjon 1`() {
        val a =
            100.prosent.sykdomsgrad.inntekt(
                15000.månedlig,
                `6G` = `6g`,
                refusjonsbeløp = 15000.månedlig,
            )
        ...
        val betalte = listOf(a, b).betal().also { assertEquals(100.prosent, it.totalSykdomsgrad()) }
        betalte.forEach { assertFalse(it.er6GBegrenset()) }
        assertForventetFeil(
            ...
            nå = {
                assertEquals(
                    1384,
                    betalte.mapNotNull { it.inspektør.arbeidsgiverbeløp }.summer().dagligInt,
                )
    ...
    fun `tilkommen inntekt - total grad bestemmes ut fra sykepengegrunnlaget`() {
        ...
        val a =
            80.prosent.sykdomsgrad.inntekt(
                50000.månedlig,
                beregningsgrunnlag = 50000.månedlig,
                `6G` = `6G`,
            )
        val b =
            100.prosent.sykdomsgrad.inntekt(
        ...
        val betalte =
            listOf(a, b).betal().also { assertEquals(15, it.totalSykdomsgrad().toDouble().toInt()) }
    ...
    fun `tilkommen inntekt - mer i tilkommen enn 6G`() {
        ...
        val a =
            100.prosent.sykdomsgrad.inntekt(
                31000.månedlig,
                beregningsgrunnlag = 31000.månedlig,
                `6G` = `6G`,
            )
        val b =
            0.prosent.sykdomsgrad.inntekt(
                50000.månedlig,
                beregningsgrunnlag = INGEN,
                refusjonsbeløp = INGEN,
                `6G` = `6G`,
        ...
        val betalte =
            listOf(a, b).betal().also { assertEquals(0, it.totalSykdomsgrad().toDouble().toInt()) }
    ...
    fun `Tilkommen inntekt - fordeler ikke personbeløp ved avsluttet arbeidsforhold`() {
        val `6G` = `6g`
        val a =
            0.prosent.sykdomsgrad.inntekt(INGEN, beregningsgrunnlag = 31000.månedlig, `6G` = `6G`)
        val b =
            100.prosent.sykdomsgrad.inntekt(10000.månedlig, beregningsgrunnlag = INGEN, `6G` = `6G`)
    ...
    fun `fordeling mellom arbeidsgivere mde ulik inntekt og refusjon`() {
        ...
        assertForventetFeil(
            forklaring =
                "arbeidsgiver 2 har høyere avrundingsdifferanse enn arbeidsgiver 1, og bør få den 1 kr diffen." +
    ...
    private fun assertUtbetaling(
        økonomi: Økonomi,
        expectedArbeidsgiver: Double,
        expectedPerson: Double,
    ) {
        assertEquals(
            expectedArbeidsgiver.daglig,
            økonomi.inspektør.arbeidsgiverbeløp,
            "arbeidsgiverbeløp problem",
        )
        assertEquals(expectedPerson.daglig, økonomi.inspektør.personbeløp, "personbeløp problem")
    }

    private val Prosentdel.sykdomsgrad
        get() = Økonomi.sykdomsgrad(this)
...
private fun Throwable.håndterØnsketOppførselFeil(forklaring: String?) =
    when (this) {
        is AssertionError ->
            println(
                "☹️ Det er kjent at vi ikke har ønsket oppførsel for ${forklaring ?: "denne testen"} ☹️️"
            )
...
private fun assertForventetFeil(forklaring: String? = null, nå: () -> Unit, ønsket: () -> Unit) {
    runCatching(nå)
        .exceptionOrNull()
        ?.håndterNåOppførselFeil(harØnsketOppførsel = runCatching(ønsket).isSuccess)
