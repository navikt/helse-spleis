...
/**
 * Tar høyde for helg i dag-generering. Eks: 12.NAV fra en mandag gir 10 sykedager i 2 hele
 * arbeidsuker + 2 sykHelg-dager
 */
fun tidslinjeOf(
    ...
    Utbetalingstidslinje.Builder()
        .apply {
            val finnSkjæringstidspunktFor = { dato: LocalDate ->
                skjæringstidspunkter.filter { dato >= it }.maxOrNull() ?: dato
            }
            utbetalingsdager.fold(startDato) {
                startDato,
                (
                    antallDagerFun,
                    utbetalingsdag,
                ...
                repeat(antallDager) {
                    ...
                    val økonomi =
                        Økonomi.sykdomsgrad(grad.prosent)
                            .inntekt(
                                dekningsgrunnlag,
                                `6G` = `6G`,
                                refusjonsbeløp = arbeidsgiverbeløp,
                            )
...
fun Int.AP(dekningsgrunnlag: Int) =
    Utbetalingsdager(
        antallDager = { this },
...
fun Int.NAP(dekningsgrunnlag: Int, grad: Number = 100.0) =
    Utbetalingsdager(
        antallDager = { this },
...
fun Int.HELG(dekningsgrunnlag: Int, grad: Number = 100.0) =
    Utbetalingsdager(
        antallDager = { this },
...
fun Int.ARB(dekningsgrunnlag: Int) =
    Utbetalingsdager(
        antallDager = { this },
...
fun Int.FRI(dekningsgrunnlag: Int) =
    Utbetalingsdager(
        antallDager = { this },
...
fun Int.FOR(dekningsgrunnlag: Int) =
    Utbetalingsdager(
        antallDager = { this },
...
val Int.UKJ
    get() = Utbetalingsdager(antallDager = { this }, addDagFun = { dato, _ -> addUkjentDag(dato) })

val Int.UTELATE
    get() =
        Utbetalingsdager(antallDager = { this }, addDagFun = { _, _ -> }, dekningsgrunnlag = INGEN)
