...
fun tidslinjeOf(
    ...
    .apply {
        ...
        utbetalingsdager.fold(
            startDato,
        ) { startDato, (antallDagerFun, utbetalingsdag, helgedag, dekningsgrunnlag, grad, arbeidsgiverbeløp) ->
            var dato = startDato
...
fun Int.NAV(
    ...
    this
}, dekningsgrunnlag.daglig, grad, refusjonsbeløp.daglig)
...
fun Int.NAV(
    ...
    this
}, dekningsgrunnlag, grad, refusjonsbeløp)
