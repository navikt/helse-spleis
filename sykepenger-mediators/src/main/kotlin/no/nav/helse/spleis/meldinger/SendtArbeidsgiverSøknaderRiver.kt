...
internal class SendtArbeidsgiverSøknaderRiver(
    ...
    override fun validate(message: JsonMessage) {
        ...
        message.interestedIn("sporsmal", "arbeidGjenopptatt", "andreInntektskilder", "permitteringer", "merknaderFraSykmelding", "korrigerer", "opprinneligSendt", "utenlandskSykmelding", "sendTilGosys", "egenmeldingsdagerFraSykmelding")
