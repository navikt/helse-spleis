...
internal abstract class SøknadBuilder {
    ...
    internal fun sykmeldingSkrevet(sykmeldingSkrevet: LocalDateTime) = apply {
        this.sykmeldingSkrevet = sykmeldingSkrevet
    }

    internal fun fødselsdato(fødselsdato: LocalDate) = apply { this.fødselsdato = fødselsdato }

    internal fun organisasjonsnummer(organisasjonsnummer: String) = apply {
    ...
    internal fun egenmeldinger(egenmeldinger: List<Periode>) = apply {
        this.egenmeldinger = egenmeldinger
    }

    internal fun arbeidUtenforNorge(arbeidUtenforNorge: Boolean) = apply {
        this.arbeidUtenforNorge = arbeidUtenforNorge
    }
