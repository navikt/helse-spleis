...
internal class HelseBuilder(dataSource: DataSource, kafkaRapid: KafkaRapid, hendelseProducer: KafkaProducer<String, String>) {
    ...
    private val hendelseRecorder: HendelseRecorder =
        HendelseRecorder(dataSource)

    internal val personRestInterface: PersonRestInterface
    private val personRepository: PersonRepository =
        PersonPostgresRepository(dataSource)
