...
import no.nav.helse.spleis.serde.migration.RefusjonsopplysningerIVilkårsgrunnlag.vilkårsgrunnlagMedRefusjonsopplysninger
...
internal class V194RefusjonsopplysningerIVilkårsgrunnlagDryRun: JsonMigration(version = 194) {
    ...
    override fun doMigration(jsonNode: ObjectNode, meldingerSupplier: MeldingerSupplier) {
        ...
        try {
            ...
            val vilkårsgrunnlagEtter = vilkårsgrunnlagMedRefusjonsopplysninger(jsonNode) ?: return
