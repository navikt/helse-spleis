...
import no.nav.helse.spleis.serde.migration.Sykefraværstilfeller.Vedtaksperiode.Companion.aktiveSkjæringstidspunkter
import no.nav.helse.spleis.serde.migration.Sykefraværstilfeller.Vedtaksperiode.Companion.førsteAktiveIkkeAvsluttetUtenUtbetalingTilstander
import no.nav.helse.spleis.serde.migration.Sykefraværstilfeller.Vedtaksperiode.Companion.kunForkastetEllerAvsluttetUtenUtbetaling
import no.nav.helse.spleis.serde.migration.Sykefraværstilfeller.Vedtaksperiode.Companion.overlappendeVedtaksperioder
import no.nav.helse.spleis.serde.migration.Sykefraværstilfeller.Vedtaksperiode.Companion.skjæringstidspunkter
