...
internal class PersonDao(
    ...
    fun hentEllerOpprettPerson(
        ...
        sessionOf(dataSource, returnGeneratedKey = true).use {
            it.transaction { txSession ->
                val (personId, person) =
                    hentPersonEllerOpprettNy(txSession, subsumsjonslogg, hendelseRepository, personidentifikator, lagNyPerson, historiskeFolkeregisteridenter)
    ...
    private fun hentPersonEllerOpprettNy(
        ...
        lagNyPerson: () -> Person?,
        historiskeFolkeregisteridenter: Set<Personidentifikator>
    ): Pair<Long, Person>? = gjenopprettFraTidligereBehandling(txSession, subsumsjonslogg, hendelseRepository, personidentifikator, historiskeFolkeregisteridenter) ?: opprettNyPerson(txSession, lagNyPerson)
