...
internal class OverstyrInntektMedRefusjonsopplysningerMessage(val packet: JsonMessage) : HendelseMessage(packet) {
    ...
    private val refusjonsopplysninger = Refusjonsopplysning.Refusjonsopplysninger.RefusjonsopplysningerBuilder().apply {
        packet["refusjonsopplysninger"].map { refusjonsopplysning ->
            leggTil(Refusjonsopplysning(
