...
internal class VilkårsgrunnlagMessage(
    ...
    private val inntekterForOpptjeningsvurdering =
        mapSkatteopplysninger(packet["@løsning.${Aktivitet.Behov.Behovtype.InntekterForOpptjeningsvurdering.name}"])
    ...
    private val vilkårsgrunnlag
        get() = Vilkårsgrunnlag(
            ...
            inntekterForOpptjeningsvurdering = no.nav.helse.hendelser.InntekterForOpptjeningsvurdering(
