...
import no.nav.helse.spleis.serde.mapping.JsonDagType
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.ARBEIDSDAG_INNTEKTSMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.ARBEIDSDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.EGENMELDINGSDAG_INNTEKTSMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.EGENMELDINGSDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.FERIEDAG_INNTEKTSMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.FERIEDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.FORELDET_SYKEDAG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.FRISK_HELGEDAG_INNTEKTSMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.FRISK_HELGEDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.IMPLISITT_DAG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.PERMISJONSDAG_AAREG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.PERMISJONSDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.STUDIEDAG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.SYKEDAG_SYKMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.SYKEDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.SYK_HELGEDAG_SYKMELDING
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.SYK_HELGEDAG_SØKNAD
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.UBESTEMTDAG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.UTENLANDSDAG
import no.nav.helse.spleis.serde.migration.V6LeggTilNySykdomstidslinje.JsonDagTypePreV10.valueOf
