...
import no.nav.helse.spleis.serde.migration.BrukteVilkårsgrunnlag.brukteVilkårsgrunnlag
import org.slf4j.LoggerFactory

internal class V177LoggingAvForkastOgFlyttVilkårsgrunnlag : JsonMigration(version = 177) {
    ...
    override fun doMigration(jsonNode: ObjectNode, meldingerSupplier: MeldingerSupplier) {
        try {
            brukteVilkårsgrunnlag(jsonNode, "V177LoggingAvForkastOgFlyttVilkårsgrunnlag")
        } catch (e: Exception) {
