...
internal class MinimumSykdomsgradVurdertMessage(
    ...
    private val perioderMedMinimumSykdomsgradVurdertOK =
        packet["perioderMedMinimumSykdomsgradVurdertOk"].map(::asPeriode)
    private val perioderMedMinimumSykdomsgradVurdertIkkeOK =
        packet["perioderMedMinimumSykdomsgradVurdertIkkeOk"].map(::asPeriode)
