            ...
            arbeidsgivere =
                person.arbeidsgivere.map { arbeidsgiver ->
                    AvstemtArbeidsgiver(
                        ...
                        vedtaksperioder =
                            arbeidsgiver.vedtaksperioder.map { mapTilVedtaksperiode(it) },
                        forkastedeVedtaksperioder =
                            arbeidsgiver.forkastede.map { mapTilVedtaksperiode(it.vedtaksperiode) },
                        utbetalinger =
            ...
            utbetalinger =
                vedtaksperiode.behandlinger.behandlinger.flatMap { generasjon ->
                    generasjon.endringer
                        .filterNot { endring ->
                            endring.utbetalingstatus === UtbetalingTilstandDto.FORKASTET
                        }
...
data class AvstemmerDto(val fødselsnummer: String, val arbeidsgivere: List<AvstemtArbeidsgiver>)
