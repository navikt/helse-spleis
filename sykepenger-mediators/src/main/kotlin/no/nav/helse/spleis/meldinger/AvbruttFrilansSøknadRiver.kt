...
internal class AvbruttFrilansSøknadRiver(
    rapidsConnection: RapidsConnection,
    messageMediator: IMessageMediator
) : HendelseRiver(rapidsConnection, messageMediator) {

    override val eventNames = setOf("avbrutt_frilanser_søknad")
    override val riverName = "Avbrutt frilanser søknad"
    ...
    override fun createMessage(packet: JsonMessage) = AvbruttSøknadMessage(
        ...
        behandlingsporing = Behandlingsporing.Yrkesaktivitet.Frilans
    )
}
