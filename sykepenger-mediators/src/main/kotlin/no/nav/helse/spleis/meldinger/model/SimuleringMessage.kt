...
internal class SimuleringMessage(packet: JsonMessage, override val meldingsporing: Meldingsporing) :
    ...
    private val simuleringResultat =
        packet["@løsning.${Behovtype.Simulering.name}.simulering"]
                                        ...
                                        SimuleringResultatDto.SimulertUtbetaling(
                                            ...
                                            utbetalesTil =
                                                SimuleringResultatDto.Mottaker(
                                                    ...
                                                    navn =
                                                        utbetaling.path("utbetalesTilNavn").asText(),
                                                ),
                                            ...
                                            detaljer =
                                                utbetaling.path("detaljer").map { detalj ->
                                                    SimuleringResultatDto.Detaljer(
                                                        ...
                                                        uføregrad =
                                                            detalj.path("uforegrad").asInt(),
                                                        utbetalingstype =
                                                            detalj.path("utbetalingsType").asText(),
                                                        refunderesOrgnummer =
                                                            detalj.path("refunderesOrgNr").asText(),
                                                        tilbakeføring =
                                                            detalj
                                                                .path("tilbakeforing")
                                                                .asBoolean(),
                                                        sats =
                                                            SimuleringResultatDto.Sats(
                                                                sats =
                                                                    detalj.path("sats").asDouble(),
                                                                antall =
                                                                    detalj
                                                                        .path("antallSats")
                                                                        .asInt(),
                                                                type =
                                                                    detalj.path("typeSats").asText(),
                                                            ),
                                                    )
                                                },
                                        )
