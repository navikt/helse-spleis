...
internal class HendelseMediator(
    ...
    override fun behandle(message: HendelseMessage, context: MessageContext) {
        try {
            ...
            withMDC(err.kontekst()) {
                sikkerLogg.error(
                    "alvorlig feil i aktivitetslogg: ${err.message}\n\t${message.toJson()}",
                    err,
                )
            }
        }
    ...
    override fun behandle(
        ...
        opprettPersonOgHåndter(
            personopplysninger,
            message,
            context,
            historiskeFolkeregisteridenter,
        ) { person, aktivitetslogg ->
    ...
    override fun behandle(
        ...
        opprettPersonOgHåndter(personopplysninger, message, context, emptySet()) {
            person,
            aktivitetslogg ->
    ...
    override fun behandle(
        ...
        person(personidentifikator, message, emptySet(), EmptyLog, null) { person ->
            ...
            context.publish(
                avstemmer.tilJsonMessage().toJson().also {
    ...
    override fun behandle(
        ...
        hentPersonOgHåndter(nyPersonidentifikator, null, message, context, gamleIdenter) {
            person,
            aktivitetslogg ->
            ...
            context.publish(
                JsonMessage.newMessage(
                        "slackmelding",
                        mapOf("melding" to "Det er en person som har byttet ident."),
                    )
                    .toJson()
            )
        }
    ...
    private fun ferdigstill(
        ...
        if (aktivitetslogg.harFunksjonelleFeilEllerVerre())
            sikkerLogg.info("aktivitetslogg inneholder errors:\n${aktivitetslogg.toString()}")
