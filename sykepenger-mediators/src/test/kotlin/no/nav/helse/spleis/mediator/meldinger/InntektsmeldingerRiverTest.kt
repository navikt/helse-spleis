...
internal class InntektsmeldingerRiverTest : RiverTest() {
    ...
    private val ValidInntektsmelding =
        Inntektsmeldingkontrakt(
                ...
                endringIRefusjoner =
                    listOf(
                        EndringIRefusjon(endringsdato = LocalDate.now(), beloep = BigDecimal.ONE)
                    ),
                opphoerAvNaturalytelser = emptyList(),
                gjenopptakelseNaturalytelser = emptyList(),
                arbeidsgiverperioder =
                    listOf(Periode(fom = LocalDate.now(), tom = LocalDate.now())),
            ...
            .asObjectNode()
    private val ValidInntektsmeldingUtenRefusjon =
        Inntektsmeldingkontrakt(
                inntektsmeldingId = UUID.randomUUID().toString(),
                arbeidstakerFnr = "fødselsnummer",
                arbeidstakerAktorId = "aktørId",
