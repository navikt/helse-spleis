...
internal class ArbeidsopplysningerKorrigertTest : AbstractEndToEndMediatorTest() {
    ...
    fun `Sender ut arbeidsopplysninger_korrigert når arbeidsgiveropplysninger endres av en korrigerende IM`() {
        ...
        val korrigertInntektsmelding =
            sendInntektsmelding(listOf(Periode(fom = 1.januar, tom = 31.januar)), førsteFraværsdag = 1.januar, beregnetInntekt = 30000.0)
        ...
        val korrigerendeInntektsmelding =
            sendInntektsmelding(listOf(Periode(fom = 1.januar, tom = 31.januar)), førsteFraværsdag = 1.januar, beregnetInntekt = 30500.0)
