...
internal class RevurderingAvsluttetUtenUtbetalingTest : AbstractEndToEndMediatorTest() {
    ...
    fun `revurdering ved inntektsmelding for korte perioder`() {
        ...
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 3.januar, tom = 5.januar, sykmeldingsgrad = 100))
        )
        sendNySøknad(SoknadsperiodeDTO(fom = 6.januar, tom = 10.januar, sykmeldingsgrad = 100))
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 6.januar, tom = 10.januar, sykmeldingsgrad = 100))
        )
        sendNySøknad(SoknadsperiodeDTO(fom = 11.januar, tom = 17.januar, sykmeldingsgrad = 100))
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 11.januar, tom = 17.januar, sykmeldingsgrad = 100))
        )
        sendInntektsmelding(
    ...
    fun `revurdering ved inntektsmelding for korte perioder - endring av skjæringstidspunkt`() {
        ...
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 8.januar, tom = 10.januar, sykmeldingsgrad = 100))
        )
        sendNySøknad(SoknadsperiodeDTO(fom = 11.januar, tom = 22.januar, sykmeldingsgrad = 100))
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 11.januar, tom = 22.januar, sykmeldingsgrad = 100))
        )
        sendNySøknad(SoknadsperiodeDTO(fom = 23.januar, tom = 23.januar, sykmeldingsgrad = 100))
        sendSøknad(
            perioder =
                listOf(SoknadsperiodeDTO(fom = 23.januar, tom = 23.januar, sykmeldingsgrad = 100))
        )
        sendInntektsmelding(
            listOf(
    ...
    private constructor(private val messages: MutableList<ILoggingEvent>) :
        AppenderBase<ILoggingEvent>(), Iterable<ILoggingEvent> by (messages) {
