...
internal class ReberegningTest : AbstractEndToEndMediatorTest() {
    ...
    fun `vedtaksperiode_reberegnet event`() {
        Toggles.KorrigertSøknadToggle.enable {
            ...
            sendKorrigerendeSøknad(listOf(SoknadsperiodeDTO(fom = 1.januar, tom = 31.januar, sykmeldingsgrad = 100)), listOf(FravarDTO(31.januar, 31.januar, FravarstypeDTO.FERIE)))
