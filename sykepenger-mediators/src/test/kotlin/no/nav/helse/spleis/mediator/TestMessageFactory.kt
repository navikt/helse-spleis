...
internal class TestMessageFactory(
    ...
    private companion object {
        ...
        private fun Inntektsmelding.toMapMedFelterFraSpedisjon(
            fødselsdato: LocalDate
        ): Map<String, Any> =
    ...
    fun lagNySøknad(
        ...
        return nyHendelse(
            "ny_søknad",
            nySøknad.toMapMedFelterFraSpedisjon(fødselsdato, historiskeFolkeregisteridenter),
        )
    }
    ...
    fun lagSøknadArbeidsgiver(
        ...
        return nyHendelse(
            ...
            sendtSøknad.toMapMedFelterFraSpedisjon(fødselsdato, historiskeFolkeregisteridenter),
        )
    }
    ...
    fun lagInntektsmeldingReplay(vedtaksperiodeId: UUID, inntektsmelding: String) =
        objectMapper
            ...
            .let { node -> UUID.fromString(node.path("@id").asText()) to node.toString() }
    ...
    fun lagUtbetalingshistorikkEtterInfotrygdendring(
        sykepengehistorikk: List<UtbetalingshistorikkTestdata> = emptyList()
    ): Pair<String, String> {
        return nyHendelse(
            "behov",
    ...
    fun lagUtbetalingshistorikkForFeriepenger(
        testdata: UtbetalingshistorikkForFeriepengerTestdata
    ) =
        lagBehovMedLøsning(
            ...
            løsninger =
                mapOf(
                    "SykepengehistorikkForFeriepenger" to
                        mapOf(
                            "feriepengerSkalBeregnesManuelt" to
                                testdata.feriepengerSkalBeregnesManuelt,
                            "utbetalinger" to
                            ...
                            "arbeidskategorikoder" to
                                testdata.arbeidskategorikoder.map {
                                    mapOf("kode" to it.kode, "fom" to it.fom, "tom" to it.tom)
                                },
                        )
                ),
        )
    ...
    class UtbetalingshistorikkForFeriepengerTestdata(
        ...
        class Arbeidskategori(val kode: String, val fom: LocalDate, val tom: LocalDate)
    }
    ...
    class UtbetalingshistorikkTestdata(
        ...
        companion object {
            fun List<UtbetalingshistorikkTestdata>.toJson() =
                mapOf("Sykepengehistorikk" to map { data -> data.toJson() })
        }
    }

    class PleiepengerTestdata(val fom: LocalDate, val tom: LocalDate, val grad: Int)

    class OmsorgspengerTestdata(val fom: LocalDate, val tom: LocalDate, val grad: Int)

    class OpplæringspengerTestdata(val fom: LocalDate, val tom: LocalDate, val grad: Int)
    ...
    class ArbeidsavklaringspengerTestdata(val fom: LocalDate, val tom: LocalDate)

    class DagpengerTestdata(val fom: LocalDate, val tom: LocalDate)
    ...
    class Subsumsjon(paragraf: String?, ledd: String?, bokstav: String?) {
        val toMap =
            mutableMapOf("paragraf" to paragraf)
                .apply {
                    ledd?.let { this["ledd"] = ledd }
                    bokstav?.let { this["bokstav"] = bokstav }
                }
                .toMap()
    }

    class Refusjonsopplysning(fom: LocalDate, tom: LocalDate?, beløp: Double) {
        val toMap =
            mutableMapOf("fom" to fom, "beløp" to beløp)
                .apply { tom?.let { this["tom"] = it } }
                .toMap()
    }
    ...
    data class SkjønnsmessigFastsatt(val organisasjonsnummer: String, val årlig: Double?)
                ...
                mapOf(
                    ...
                    "Pleiepenger" to
                        pleiepenger.map { data ->
                            mapOf("fom" to data.fom, "tom" to data.tom, "grad" to data.grad)
                        },
                    "Omsorgspenger" to
                    ...
                    Arbeidsavklaringspenger.name to
                        mapOf(
                            "meldekortperioder" to
                                arbeidsavklaringspenger.map { data ->
                                    mapOf("fom" to data.fom, "tom" to data.tom)
                                }
                        ),
                    Dagpenger.name to
                        mapOf(
    ...
    fun lagSykepengegrunnlagForArbeidsgiver(
        ...
        return lagBehovMedLøsning(
            ...
            løsninger =
                mapOf(
                    "InntekterForSykepengegrunnlagForArbeidsgiver" to
                        inntekterForSykepengegrunnlag.map {
                            mapOf(
                                "årMåned" to it.måned,
                                "inntektsliste" to
            ...
            ekstraFelter =
                mapOf(
                    "InntekterForSykepengegrunnlagForArbeidsgiver" to
                        mapOf("skjæringstidspunkt" to skjæringstidspunkt)
                ),
        )
    }
        ...
        return lagBehovMedLøsning(
            ...
            løsninger =
                mapOf(
                    ...
                    InntekterForSykepengegrunnlag.name to
                        inntekterForSykepengegrunnlag.map {
                            mapOf(
                                "årMåned" to it.måned,
                                "inntektsliste" to
                    ...
                    InntekterForOpptjeningsvurdering.name to
                        inntekterForOpptjeningsvurdering.map {
                            mapOf(
                                "årMåned" to it.måned,
                                "inntektsliste" to
                                    it.inntekter.map { inntekt ->
            ...
            ekstraFelter =
                mapOf(
                    ...
                    InntekterForOpptjeningsvurdering.name to
                        mapOf("skjæringstidspunkt" to skjæringstidspunkt),
                    ArbeidsforholdV2.name to mapOf("skjæringstidspunkt" to skjæringstidspunkt),
                    Medlemskap.name to mapOf("skjæringstidspunkt" to skjæringstidspunkt),
                ),
        )
    }
        ...
        return lagBehovMedLøsning(
                ...
                mapOf(
                    "Simulering" to
                        mapOf(
                            ...
                            "feilmelding" to
                                if (status == SimuleringMessage.Simuleringstatus.OK) null
                                else "FEIL I SIMULERING",
                            "simulering" to
                                if (status != SimuleringMessage.Simuleringstatus.OK) null
                                else
                                    mapOf(
            ...
            ekstraFelter =
                mapOf(
                    ...
                    "Simulering" to mapOf("fagsystemId" to fagsystemId, "fagområde" to fagområde),
                ),
        )
    }

    fun lagEtterbetaling(fagsystemId: String, gyldighetsdato: LocalDate): Pair<String, String> {
        return nyHendelse(
    ...
    fun lagEtterbetalingMedHistorikk(
        ...
        return lagBehovMedLøsning(
            behov = listOf("Sykepengehistorikk"),
            løsninger = mapOf("Sykepengehistorikk" to emptyList<Any>()),
            ekstraFelter = mapOf("fagsystemId" to fagsystemId, "gyldighetsdato" to gyldighetsdato),
            vedtaksperiodeId = null,
            tilstand = null,
        )
    }
    ...
    fun lagUtbetalingsgodkjenning(
        ...
        return lagBehovMedLøsning(
            ...
            ekstraFelter = mapOf("utbetalingId" to utbetalingId),
        )
    }

    fun lagUtbetalingpåminnelse(
        utbetalingId: UUID,
    ...
    fun lagDødsmelding(dødsdato: LocalDate): Pair<String, String> {
        return nyHendelse(
            "dødsmelding",
            mapOf("fødselsnummer" to fødselsnummer, "dødsdato" to "$dødsdato"),
        )
    }

    fun lagPersonPåminnelse(): Pair<String, String> {
        return nyHendelse("person_påminnelse", mapOf("fødselsnummer" to fødselsnummer))
    }
            ...
            løsninger =
                mapOf(
                    "Utbetaling" to
                        mapOf(
                            "status" to
                                if (utbetalingOK) Oppdragstatus.AKSEPTERT.name
                                else Oppdragstatus.AVVIST.name,
    ...
    fun lagAvstemming() = nyHendelse("person_avstemming", mapOf("fødselsnummer" to fødselsnummer))

    fun lagMigrate() = nyHendelse("json_migrate", mapOf("fødselsnummer" to fødselsnummer))
    ...
    fun lagOverstyringTidslinje(dager: List<ManuellOverskrivingDag>): Pair<String, String> {
        return nyHendelse(
            ...
            mutableMapOf(
                ...
                "organisasjonsnummer" to organisasjonsnummer,
                "dager" to
                    dager.map { mapOf("dato" to it.dato, "type" to it.type, "grad" to it.grad) },
            ),
        )
    }
                ...
                "overstyrteArbeidsforhold" to
                    overstyrteArbeidsforhold.map {
                        mutableMapOf<String, Any>(
                            ...
                            .apply {
                                it.forklaring?.let { forklaring -> this["forklaring"] = forklaring }
                            }
                    },
            ),
        )
                    ...
                    arbeidsgiveropplysninger.map { arbeidgiver ->
                        mutableMapOf(
                                ...
                                "refusjonsopplysninger" to
                                    arbeidgiver.refusjonsopplysninger?.map { it.toMap },
                            )
                            .apply { arbeidgiver.subsumsjon?.let { this["subsumsjon"] = it.toMap } }
                    },
            ),
        )
            ...
            mutableMapOf(
                ...
                "perioderMedMinimumSykdomsgradVurdertOk" to
                    perioderMedMinimumSykdomsgradVurdertOK.map {
                        mutableMapOf("fom" to it.first, "tom" to it.second)
                    },
    ...
    internal fun lagInfotrygdendringer(endringsmeldingId: String = "1234567") =
        nyHendelse(
            "infotrygdendring",
            mutableMapOf("fødselsnummer" to fødselsnummer, "endringsmeldingId" to endringsmeldingId),
        )
    ...
    fun lagIdentOpphørt(fnr: String, nyttFnr: String) =
        nyHendelse(
            "ident_opphørt",
            mapOf(
                "fødselsnummer" to fnr,
                "nye_identer" to
                    mapOf("fødselsnummer" to nyttFnr, "aktørId" to "aktørId", "npid" to null),
                "gamle_identer" to listOf(mapOf("ident" to fnr, "type" to "FØDSELSNUMMER")),
            ),
        )
}
