...
internal class BehovkontraktTest : AbstractEndToEndMediatorTest() {
    ...
    fun vilkårsgrunnlag() {
        ...
        assertOpptjeningdetaljer(behov)
    }
    ...
    fun ytelser() {
        ...
        val behov = testRapid.inspektør.melding(testRapid.inspektør.antall() - 1)
        assertVedtaksperiodeBehov(behov, Arbeidsavklaringspenger, Dødsinfo, Foreldrepenger, Institusjonsopphold, Omsorgspenger, Opplæringspenger, Pleiepenger, Sykepengehistorikk)
