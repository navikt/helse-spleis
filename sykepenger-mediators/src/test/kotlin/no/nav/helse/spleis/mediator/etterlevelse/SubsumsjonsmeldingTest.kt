...
internal class SubsumsjonsmeldingTest {
    ...
    private val schema by lazy {
        JsonSchemaFactory
            ...
            .getSchema(
                URI(
                    "https://raw.githubusercontent.com/navikt/helse/c53bc453251b7878135f31d5d1070e5406ae4af1/subsumsjon/json-schema-1.0.0.json",
                ),
            )
    }
    ...
    private fun assertSubsumsjonsmelding(melding: JsonNode) {
        try {
            ...
            LoggerFactory
                .getLogger(
                    SubsumsjonsmeldingTest::class.java,
