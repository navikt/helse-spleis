...
internal class PåminnelserTest : AbstractEndToEndMediatorTest() {
    ...
    fun `påminnelse når vedtaksperiode ikke finnes`() {
        ...
        assertEquals(8, testRapid.inspektør.antall())
        val melding = testRapid.inspektør.melding(7)
    ...
    fun `påminnelse for feil tilstand`() {
        ...
        sendNyPåminnelse(0)
        val vedtaksperiodeIkkePåminnet = testRapid.inspektør.melding(7)
    ...
    fun `påminnelse for riktig tilstand`() {
        ...
        val vedtaksperiodePåminnet = testRapid.inspektør.melding(7)
