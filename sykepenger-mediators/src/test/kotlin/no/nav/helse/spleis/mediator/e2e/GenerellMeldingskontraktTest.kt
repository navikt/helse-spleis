...
internal class GenerellMeldingskontraktTest : AbstractEndToEndMediatorTest() {
    ...
    fun `vedtaksperiode endret`() {
        ...
        assertTrue(
            testRapid.inspektør.indeksFor(vedtaksperiodeOpprettet) < testRapid.inspektør.indeksFor(
    ...
    fun `vedtaksperiode annullert`() {
        ...
        sendAnnullering(
            testRapid.inspektør.etterspurteBehov(Aktivitet.Behov.Behovtype.Utbetaling)
                .path("utbetalingId").asText()
        )
