...
internal class InntektsmeldingReplayTest : AbstractEndToEndMediatorTest() {
    ...
    fun `inntektsmelding strekker periode tilbake - uoverstemmelse av refusjonsopplysninger etter replay av inntektsmeldinger`() {
        ...
        sendInntektsmelding(
            listOf(IMPeriode(12.februar(2024), 27.februar(2024))),
            4.mars(2024),
            orgnummer = a1,
        )
    ...
    fun `Replay av inntektsmelding skal ikke gi varsler på tvers av arbeidsgivere`() {
        ...
        sendInntektsmelding(
            listOf(IMPeriode(29.mars, 13.april)),
            førsteFraværsdag = 29.mars,
            orgnummer = a1,
        )
    ...
    fun `Får med oss informasjon fra inntektsmelding også når den kommer før søknad`() {
        ...
        sendInntektsmelding(
            listOf(IMPeriode(fom = 1.januar, tom = 16.januar)),
    ...
    private fun sykmelding(periode: Periode, orgnr: String) =
        sendNySøknad(
            SoknadsperiodeDTO(
                fom = periode.start,
    ...
    private fun søknad(periode: Periode, orgnr: String) =
        sendSøknad(
            perioder =
                listOf(
                    SoknadsperiodeDTO(
