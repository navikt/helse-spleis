...
internal class RevurderingAvsluttetUtenUtbetalingTest : AbstractEndToEndMediatorTest() {
    ...
    fun `revurdering ved inntektsmelding for korte perioder`() {
        ...
        assertTilstander(0, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING", "AVSLUTTET_UTEN_UTBETALING", "AVSLUTTET_UTEN_UTBETALING")
        assertTilstander(1, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING", "AVSLUTTET_UTEN_UTBETALING", "AVSLUTTET_UTEN_UTBETALING")
