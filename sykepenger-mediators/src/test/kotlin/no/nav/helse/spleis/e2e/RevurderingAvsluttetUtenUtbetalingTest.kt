...
internal class RevurderingAvsluttetUtenUtbetalingTest : AbstractEndToEndMediatorTest() {
    ...
    fun `revurdering ved inntektsmelding for korte perioder`() {
        ...
        assertTilstander(1, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK", "AVSLUTTET_UTEN_UTBETALING", "AVSLUTTET_UTEN_UTBETALING")
        assertTilstander(2, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK", "AVSLUTTET_UTEN_UTBETALING", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK",
    ...
    fun `revurdering ved inntektsmelding for korte perioder - endring av skjæringstidspunkt`() {
        ...
        assertTilstander(1, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK",
            "AVSLUTTET_UTEN_UTBETALING", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK", "AVVENTER_BLOKKERENDE_PERIODE", "AVVENTER_VILKÅRSPRØVING", "AVVENTER_HISTORIKK", "AVVENTER_SIMULERING", "AVVENTER_GODKJENNING")
        assertTilstander(2, "AVVENTER_INFOTRYGDHISTORIKK", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK", "AVSLUTTET_UTEN_UTBETALING", "AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK", "AVVENTER_BLOKKERENDE_PERIODE")
    }
