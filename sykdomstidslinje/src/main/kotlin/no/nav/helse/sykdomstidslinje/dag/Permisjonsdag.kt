...
class Permisjonsdag internal constructor(gjelder: LocalDate, hendelse: SykdomstidslinjeHendelse): Dag(gjelder, hendelse) {
    ...
    override fun nøkkel(): Nøkkel =
        when(hendelse.hendelsetype()){
            SykdomstidslinjeHendelse.Type.SendtSøknadMottatt -> Nøkkel.Le_A
