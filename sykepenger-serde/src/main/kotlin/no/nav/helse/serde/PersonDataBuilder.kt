                    ...
                    utbetalinger =
                        it.utbetalinger.map {
                            PersonData.ArbeidsgiverData.VedtaksperiodeData.DataForSimuleringData.SimulertUtbetaling(
                                ...
                                utbetalesTil =
                                    PersonData.ArbeidsgiverData.VedtaksperiodeData.DataForSimuleringData.Mottaker(
                                ...
                                detaljer =
                                    it.detaljer.map {
                                        PersonData.ArbeidsgiverData.VedtaksperiodeData.DataForSimuleringData.Detaljer(
                                            ...
                                            beløp = it.beløp,
                                            klassekode =
                                                PersonData.ArbeidsgiverData.VedtaksperiodeData.DataForSimuleringData.Klassekode(
                                            ...
                                            sats =
                                                PersonData.ArbeidsgiverData.VedtaksperiodeData.DataForSimuleringData.Sats(
                                                    sats = it.sats.sats,
