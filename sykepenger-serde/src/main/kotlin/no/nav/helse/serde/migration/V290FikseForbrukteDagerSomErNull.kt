            ...
            jsonNode.path("arbeidsgivere").forEach { arbeidsgiver ->
                ...
                MDC.putCloseable("orgnr", orgnr).use {
                    arbeidsgiver
                        ...
                        .filter { utbetaling ->
                            !utbetaling.hasNonNull("forbrukteSykedager") ||
                                !utbetaling.hasNonNull("gjenståendeSykedager")
                        }
                        .forEach { utbetaling ->
                            utbetaling as ObjectNode
                            sikkerLogg.info(
                                "migrerer forbrukteSykedager/gjenståendeSykedager for ${utbetaling.path("id").asText()}"
                            )
