...
internal class V283BeregningsgrunnlagPåØkonomi : JsonMigration(283) {
    override val description =
        "setter beregningsgrunnlag lik aktuellDagsinntekt på alle økonomiobjekter"
    ...
    private fun migrer(jsonNode: ObjectNode, aktørId: String) {
        jsonNode.path("arbeidsgivere").forEach { arbeidsgiver ->
            arbeidsgiver.path("utbetalinger").onEach { utbetaling ->
                migrerUtbetaling(aktørId, utbetaling)
            }
        }
    }
