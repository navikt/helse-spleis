...
internal class V303KopiereMaksdatoFraUtbetalingTilBehandling : JsonMigration(version = 303) {
    ...
    private fun migrerEndring(
        ...
        (endring.path("maksdatoresultat") as ObjectNode).apply {
            ...
            if (resultat.startdatoSykepengerettighet == null) {
                putNull("startdatoSykepengerettighet")
            } else {
                put("startdatoSykepengerettighet", "${resultat.startdatoSykepengerettighet}")
            }
    ...
    private companion object {
        ...
        private fun ClosedRange<LocalDate>.datoer() = start.datesUntil(endInclusive.plusDays(1)).toList().toSet()
