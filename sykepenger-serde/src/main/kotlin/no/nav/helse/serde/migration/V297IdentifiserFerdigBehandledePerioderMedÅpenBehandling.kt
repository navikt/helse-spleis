            ...
            jsonNode.path("arbeidsgivere").forEach { arbeidsgiver ->
                ...
                arbeidsgiver
                    ...
                    .forEach { ferdigBehandletVedtaksperiode ->
                        val påminnelse =
                            if (ferdigBehandletVedtaksperiode.path("tilstand").asText() ==
                                "AVSLUTTET"
                            ) {
                                ferdigBehandletVedtaksperiode.validerVedtakIverksatt(aktørId, fødselsnummer, organisasjonsnummer)
                            } else {
                                ferdigBehandletVedtaksperiode.validerAvsluttetUtenVedtak(aktørId, fødselsnummer, organisasjonsnummer)
                            }
    ...
    private companion object {
        ...
        private fun JsonNode.validerAvsluttetUtenVedtak(
            ...
            return sisteBehandling.fom() to
                påminnelse(aktørId, fødselsnummer, organisasjonsnummer, vedtaksperiodeId, "AVSLUTTET_UTEN_UTBETALING")
        }
