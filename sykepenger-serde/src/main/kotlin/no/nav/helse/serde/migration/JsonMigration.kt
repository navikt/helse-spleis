...
internal abstract class JsonMigration(private val version: Int) {
    internal companion object {
        ...
        internal val String.dato
            get() = LocalDate.parse(this)

        internal val String.uuid
        ...
        internal fun migrate(
            ...
            jsonNode.apply {
                ...
                require(sortedMigrations.windowed(2).none { (a, b) -> a.version == b.version }) {
                    "Versjoner må være unike"
                }
    ...
    init {
        require(version > InitialVersion) {
            "Ugyldig versjon for migrering. Må være større enn $InitialVersion"
        }
    }
    ...
    private fun after(jsonNode: ObjectNode) {
        log.info(
            "Successfully migrated json to $version using ${this.javaClass.name}: ${this.description}"
        )
