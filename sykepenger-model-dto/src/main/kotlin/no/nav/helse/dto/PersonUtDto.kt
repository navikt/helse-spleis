...
data class SykmeldingsperioderDto(
...
data class SykdomshistorikkDto(
    val elementer: List<SykdomshistorikkElementDto>,
)
...
data class InfotrygdFerieperiodeDto(
    val periode: PeriodeDto,
)
