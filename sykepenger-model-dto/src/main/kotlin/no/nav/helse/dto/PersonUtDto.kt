...
sealed class SykdomstidslinjeDagDto {
    ...
    data class MeldingTilNavDagDto(override val dato: LocalDate, override val kilde: HendelseskildeDto, val grad: ProsentdelDto) : SykdomstidslinjeDagDto()
    ...
    data class MeldingTilNavHelgedagDto(override val dato: LocalDate, override val kilde: HendelseskildeDto, val grad: ProsentdelDto) : SykdomstidslinjeDagDto()
...
sealed class VedtaksperiodetilstandDto {
    ...
    data object AVVENTER_AVSLUTTET_UTEN_UTBETALING : VedtaksperiodetilstandDto()
    ...
    data object AVVENTER_SØKNAD_FOR_OVERLAPPENDE_PERIODE : VedtaksperiodetilstandDto()
    ...
    data object AVVENTER_REVURDERING_TIL_UTBETALING : VedtaksperiodetilstandDto()
