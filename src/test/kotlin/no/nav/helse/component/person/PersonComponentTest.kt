...
internal class PersonComponentTest {
    ...
    @Test
    fun `nySøknad-sendtSøknad-inntektsmelding fører til at sykepengehistorikk blir etterspurt`() {
    ...
    @Test
    fun `nySøknad-inntektsmelding-sendtSøknad sak fører til at sykepengehistorikk blir etterspurt`() {
        testServer(config = mapOf(
                "KAFKA_BOOTSTRAP_SERVERS" to embeddedKafkaEnvironment.brokersURL,
                "KAFKA_USERNAME" to username,
                "KAFKA_PASSWORD" to password,
