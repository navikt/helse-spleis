...
internal class ArbeidsgiverBuilder(
    ...
    internal companion object {
        fun List<SpekematDTO.PølsepakkeDTO.PølseradDTO>.fjernUnødvendigeRader():
            List<SpekematDTO.PølsepakkeDTO.PølseradDTO> {
            // rader hvor alle pølser er kopiert fra forrige rad - eller blir kopiert til neste rad
            // - kan i praksis fjernes
            // det betyr at vi bare behøver vurdere pølsepakker med minst tre rader siden den vi
            // skal vurdere én rad mot to andre
            if (size <= 2) return this
            val pølseFinnesIRad =
                {
                    rad: SpekematDTO.PølsepakkeDTO.PølseradDTO,
                    pølse: SpekematDTO.PølsepakkeDTO.PølseradDTO.PølseDTO ->
