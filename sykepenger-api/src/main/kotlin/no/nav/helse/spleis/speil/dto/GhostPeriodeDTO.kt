...
internal fun ClosedRange<LocalDate>.erUtenfor(
    fom: LocalDate,
    tom: LocalDate,
) = maxOf(this.start, fom) > minOf(this.endInclusive, tom)

internal fun ClosedRange<LocalDate>.erInni(
    fom: LocalDate,
    tom: LocalDate,
) = this.start > fom && this.endInclusive < tom

internal fun ClosedRange<LocalDate>.overlapperMedHale(
    fom: LocalDate,
    tom: LocalDate,
) = this.start > fom && this.endInclusive >= tom

internal fun ClosedRange<LocalDate>.overlapperMedSnute(
    fom: LocalDate,
    tom: LocalDate,
) = this.start <= fom && this.endInclusive < tom
