...
internal fun createApp(
    ...
    naisApp(
        ...
        timersConfig = { call, _ ->
            this.tag("azp_name", call.principal<JWTPrincipal>()?.get("azp_name") ?: "n/a")
            ...
            mapOf(
                "azp_name" to
                    { call: ApplicationCall ->
                        call.principal<JWTPrincipal>()?.get("azp_name")
                    },
...
internal fun Application.lagApplikasjonsmodul(
    ...
    requestResponseTracing(
        LoggerFactory.getLogger("no.nav.helse.spleis.api.Tracing"),
        meterRegistry,
    )
