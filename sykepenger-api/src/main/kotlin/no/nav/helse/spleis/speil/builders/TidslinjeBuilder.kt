...
internal class UtbetalingstidslinjeBuilder(private val dto: UtbetalingstidslinjeUtDto) {
    private val utbetalingstidslinje by lazy {
        dto.dager.map {
            when (it) {
                is UtbetalingsdagUtDto.ArbeidsdagDto -> UtbetalingstidslinjedagUtenGrad(
                    type = UtbetalingstidslinjedagType.Arbeidsdag,
                    dato = it.dato
                )

                is UtbetalingsdagUtDto.ArbeidsgiverperiodeDagDto -> UtbetalingstidslinjedagUtenGrad(
                    type = UtbetalingstidslinjedagType.ArbeidsgiverperiodeDag,
                    dato = it.dato
                )

                is UtbetalingsdagUtDto.ArbeidsgiverperiodeDagNavDto -> mapUtbetalingsdag(
                    it.dato,
                ...
                is UtbetalingsdagUtDto.ForeldetDagDto -> UtbetalingstidslinjedagUtenGrad(
                ...
                is UtbetalingsdagUtDto.NavDagDto -> mapUtbetalingsdag(
                    it.dato,
                    UtbetalingstidslinjedagType.NavDag,
                    it.økonomi
                )

                is UtbetalingsdagUtDto.NavHelgDagDto -> UtbetalingstidslinjedagUtenGrad(
