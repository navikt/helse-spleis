...
private fun mapDag(dag: SammenslåttDag) = GraphQLDag(
    ...
    sykdomsdagtype = when (dag.sykdomstidslinjedagtype) {
        ...
        SykdomstidslinjedagType.MELDING_TIL_NAV_DAG -> GraphQLSykdomsdagtype.MeldingTilNavDag
        ...
        SykdomstidslinjedagType.AVSLÅTT_MELDING_TIL_NAV_DAG -> GraphQLSykdomsdagtype.AvslattMeldingTilNavDag
    },
    utbetalingsdagtype = when (dag.utbetalingstidslinjedagtype) {
        ...
        UtbetalingstidslinjedagType.Ventetidsdag -> GraphQLUtbetalingsdagType.Ventetidsdag
    },
    ...
    begrunnelser = dag.begrunnelser?.map {
        when (it) {
            ...
            BegrunnelseDTO.MeldingTilNavDagUtenforVentetid -> GraphQLBegrunnelse.MeldingTilNavDagUtenforVentetid
            BegrunnelseDTO.AvslåttMeldingTilNavDag -> GraphQLBegrunnelse.AvslattMeldingTilNavDag
