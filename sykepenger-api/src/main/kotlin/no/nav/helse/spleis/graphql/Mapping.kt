...
private fun mapUtbetaling(utbetaling: Utbetaling) =
    GraphQLUtbetaling(
        ...
        arbeidsgiveroppdrag =
            utbetaling.oppdrag[utbetaling.arbeidsgiverFagsystemId]?.let {
                mapOppdrag(it)
            },
        personoppdrag =
            utbetaling.oppdrag[utbetaling.personFagsystemId]?.let {
                mapOppdrag(it)
            }
    )
...
internal fun mapTidslinjeperiode(
    periode: SpeilTidslinjeperiode,
...
internal fun mapVilkårsgrunnlag(
    id: UUID,
...
private fun mapSykepengergrunnlagsgrense(sykepengegrunnlagsgrenseDTO: SykepengegrunnlagsgrenseDTO) = GraphQLSykepengegrunnlagsgrense(sykepengegrunnlagsgrenseDTO.grunnbeløp, sykepengegrunnlagsgrenseDTO.grense, sykepengegrunnlagsgrenseDTO.virkningstidspunkt)
