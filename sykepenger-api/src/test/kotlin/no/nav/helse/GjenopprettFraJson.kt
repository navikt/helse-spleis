...
internal fun gjenopprettFraJSON(
    fil: String,
    jurist: Subsumsjonslogg = EmptyLog
): Person {
...
private fun String.readResource() = object {}.javaClass.getResource(this)?.readText(Charsets.UTF_8) ?: error("did not find resource <$this>")
