...
internal class ArbeidsgiverHendelsefabrikk(
    ...
    internal fun lagInntektsmeldingReplayUtført(vedtaksperiodeId: UUID) = InntektsmeldingerReplay(UUID.randomUUID(), organisasjonsnummer, vedtaksperiodeId, emptyList())
