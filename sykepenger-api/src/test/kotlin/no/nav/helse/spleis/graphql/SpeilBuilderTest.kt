...
internal class SpeilBuilderTest : AbstractE2ETest() {
    ...
    fun `lager NyeInntektsforhold-pølse for tilkommen inntekt`() {
        ...
        håndterSøknad(
            ...
            tilkomneInntekter = listOf(TilkommenInntekt(fom = 1.februar, tom = 28.februar, orgnummer = "a24", råttBeløp = 10000)),
        )
        håndterYtelser()
    ...
    fun `kan lage NyeInntektsforhold-pølse med peker til riktig vilkårsgrunnlag før noe er utbetalt`() {
        ...
        val førstegangs =
            speilApi().arbeidsgivere.find { it.organisasjonsnummer == "a1" }!!.generasjoner.single().perioder.find {
                it.fom ==
                    1.januar
            } as BeregnetPeriode
