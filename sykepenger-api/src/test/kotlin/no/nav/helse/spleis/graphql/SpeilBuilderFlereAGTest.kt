...
internal class SpeilBuilderFlereAGTest : AbstractE2ETest() {
    ...
    fun `sender med ghost tidslinjer til speil`() {
        ...
        val spleisVilkårsgrunnlagId =
            dto().vilkårsgrunnlagHistorikk.historikk.first().vilkårsgrunnlag.single { it.skjæringstidspunkt == 1.januar }.vilkårsgrunnlagId
    ...
    fun `lager ikke ghosts for forkastede perioder med vilkårsgrunnlag fra spleis`() {
        ...
        val spleisVilkårsgrunnlagId =
            dto().vilkårsgrunnlagHistorikk.historikk.first().vilkårsgrunnlag.single { it.skjæringstidspunkt == 1.februar }.vilkårsgrunnlagId
    ...
    fun `ghost periode kuttes ved skjæringstidspunkt`() {
        ...
        val perioder = speilJson.arbeidsgivere.find { it.organisasjonsnummer == a2 }?.ghostPerioder
        val spleisVilkårsgrunnlagId =
            dto().vilkårsgrunnlagHistorikk.historikk.first().vilkårsgrunnlag.single { it.skjæringstidspunkt == 3.januar }.vilkårsgrunnlagId
        assertEquals(1, perioder?.size)
    ...
    fun `refusjon for flere arbeidsgivere`() {
        ...
        val speilVilkårsgrunnlagIdForAG2 =
            (personDto.arbeidsgivere.last().generasjoner.first().perioder.first() as BeregnetPeriode).vilkårsgrunnlagId
        val vilkårsgrunnlag =
