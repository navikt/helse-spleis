...
internal class SpeilBehandlingerBuilderTest : AbstractE2ETest() {
    ...
    fun `En periode i AvventerInntektsmelding venter på inntektsopplysninger`() {
        ...
        generasjoner {
            0.generasjon { uberegnetPeriode(0) medTilstand AvventerInntektsopplysninger }
        }
    }
    ...
    fun `periodene viser til overstyring av sykepengegrunnlag i hendelser`() {
        ...
        val søknadA1Forlengelse =
            håndterSøknad(Sykdom(26.januar, 31.januar, 100.prosent), orgnummer = a1)
        val søknadA2Forlengelse =
            håndterSøknad(Sykdom(26.januar, 31.januar, 100.prosent), orgnummer = a2)
    ...
    fun `forkastet auu`() {
        ...
        generasjoner {
            ...
            1.generasjon {
                assertEquals(1, size)
                uberegnetPeriode(0) fra
                    1.januar til
                    10.januar medTilstand
                    IngenUtbetaling medHendelser
                    setOf(søknad, im)
            }
            2.generasjon {
                assertEquals(1, size)
    ...
    fun `omgjøre kort periode får referanse til inntektsmeldingen som inneholder inntekten som er lagt til grunn`() {
        ...
        generasjoner {
            ...
            0.generasjon {
                assertEquals(2, size)
                uberegnetPeriode(0) medTilstand
                    ForberederGodkjenning medHendelser
                    setOf(søknad2, inntektsmelding1)
                uberegnetPeriode(1) medTilstand
                    IngenUtbetaling medHendelser
                    setOf(søknad1, inntektsmelding1, inntektsmelding2)
            }
            1.generasjon {
                assertEquals(2, size)
                uberegnetPeriode(0) medTilstand
                ...
                uberegnetPeriode(1) medTilstand
                    IngenUtbetaling medHendelser
                    setOf(søknad1, inntektsmelding1)
            }
        }
    }
    ...
    fun `revurdere før forlengelse utbetales`() {
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(1) fra
                    17.januar til
                    22.januar avType
                    REVURDERING medTilstand
                    TilGodkjenning
                uberegnetPeriode(2) fra 1.januar til 16.januar medTilstand IngenUtbetaling
            }
            1.generasjon {
                assertEquals(2, size)
                beregnetPeriode(0) fra
                    17.januar til
                    22.januar avType
                    UTBETALING medTilstand
                    Utbetalt
    ...
    fun `Manglende generasjon når det kommer IM som endrer AGP ved å endre dager i forkant av perioden`() {
        ...
        håndterInntektsmelding(
            arbeidsgiverperioder = listOf(24.juli til 25.juli, 7.august til 20.august)
        )
        håndterVilkårsgrunnlagTilGodkjenning()
        håndterUtbetalingsgodkjenning()
        håndterUtbetalt()
        ...
        generasjoner {
            ...
            0.generasjon {
                assertEquals(2, size)
                beregnetPeriode(0) avType
                    REVURDERING fra
                    21.august til
                    1.september medTilstand
                    TilGodkjenning
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) avType
                    REVURDERING fra
                    1.februar til
                    28.februar medTilstand
                    TilGodkjenning
                beregnetPeriode(1) avType
                    REVURDERING fra
                    1.januar til
                    31.januar medTilstand
                    IngenUtbetaling
            }
            1.generasjon {
                assertEquals(2, size)
    ...
    fun `revurdere skjæringstidspunktet flere ganger før forlengelsene`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(a1, INNTEKT - 550.daglig, "")),
        )
        håndterYtelserTilGodkjenning()
        generasjoner {
            assertEquals(3, size)
            0.generasjon {
                ...
                uberegnetPeriode(1) fra
                    1.februar til
                    28.februar medTilstand
                    UtbetaltVenterPåAnnenPeriode
                beregnetPeriode(2) avType
                    REVURDERING fra
                    1.januar til
                    31.januar medTilstand
                    TilGodkjenning
    ...
    fun `revurdere skjæringstidspunktet flere ganger`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(a1, INNTEKT - 2.daglig, "")),
        )
        håndterYtelserTilGodkjenning()
        generasjoner {
            assertEquals(3, size)
    ...
    fun `periodetype ved enkel revurdering`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(a1, INNTEKT - 500.0.daglig, "")),
        )
        håndterYtelserTilGodkjenning()
        generasjoner {
            0.generasjon {
                ...
                uberegnetPeriode(0) fra
                    1.februar til
                    28.februar medTilstand
                    UtbetaltVenterPåAnnenPeriode medPeriodetype
                    FORLENGELSE
                beregnetPeriode(1) fra
                    1.januar til
                    31.januar medTilstand
                    TilGodkjenning medPeriodetype
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) fra
                    ...
                    TilGodkjenning medPeriodetype
                    FORLENGELSE
                beregnetPeriode(1) harTidslinje
                    (1.januar til 31.januar to SykdomstidslinjedagType.FORELDET_SYKEDAG) medTilstand
    ...
    fun `annullerer feilet revurdering`() {
        ...
        generasjoner {
            ...
            2.generasjon {
                assertEquals(1, size)
                beregnetPeriode(0) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING medTilstand
                    Utbetalt
            }
        }
        ...
        generasjoner(a1) {
            0.generasjon {
                ...
                val inntektsgrunnlag =
                    vilkårsgrunnlag.inntekter.firstOrNull { it.organisasjonsnummer == a2 }
                assertEquals(
                    Inntekt(Inntektkilde.IkkeRapportert, 0.0, 0.0, null),
    ...
    fun `to perioder - første blir revurdert to ganger, deretter blir andre revurdert`() {
        ...
        håndterOverstyrTidslinje(
            (29.januar til 31.januar).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilUtbetalt()
        håndterYtelserTilGodkjenning()
        håndterUtbetalingsgodkjenning()
        håndterOverstyrTidslinje(
            (29.januar til 31.januar).map { ManuellOverskrivingDag(it, Dagtype.Sykedag, 100) }
        )
        håndterYtelserTilUtbetalt()
        håndterYtelserTilGodkjenning()
        håndterUtbetalingsgodkjenning()
        ...
        håndterOverstyrTidslinje(
            (27.februar til 28.februar).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilGodkjenning()
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Ubetalt avType
                    REVURDERING fra
                    (1.februar til 28.februar) medAntallDager
                    28 forkastet
                    false medTilstand
                    TilGodkjenning
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    REVURDERING fra
                    (1.januar til 31.januar) medAntallDager
                    31 forkastet
                    false medTilstand
                    Utbetalt
            }
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Ubetalt avType
                    REVURDERING fra
                    (2.februar til 28.februar) medAntallDager
                    27 forkastet
                    false medTilstand
                    TilGodkjenning
                beregnetPeriode(1) er
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (1.april til 30.april) medAntallDager
                    30 forkastet
                    false medTilstand
                    Utbetalt
                annullertPeriode(1) er
                    Utbetalingstatus.Annullert avType
                    ANNULLERING fra
                    (1.februar til 28.februar) medAntallDager
                    0 forkastet
                    true medTilstand
                    Annullert
                annullertPeriode(2) er
                    Utbetalingstatus.Annullert avType
                    ANNULLERING fra
                    (1.januar til 31.januar) medAntallDager
                    0 forkastet
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                annullertPeriode(0) er
                    Overført avType
                    ANNULLERING fra
                    (1.mars til 31.mars) medAntallDager
                    0 forkastet
                    true medTilstand
                    TilAnnullering
                beregnetPeriode(1) er
    ...
    fun `to perioder som blir revurdert - deretter forlengelse som så blir revurdert`() {
        ...
        forlengVedtak(1.mars, 31.mars)
        håndterOverstyrTidslinje(
            (1.mars til 31.mars).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilUtbetalt()
    ...
    fun `korte perioder - arbeidsgiversøknader`() {
        ...
        generasjoner {
            0.generasjon {
                uberegnetPeriode(0) fra
                    (1.januar til 15.januar) medAntallDager
                    15 forkastet
                    false medTilstand
                    IngenUtbetaling
            }
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Ubetalt avType
                    UTBETALING fra
                    (16.januar til 15.februar) medTilstand
                    TilGodkjenning
                uberegnetPeriode(1) fra
                    (1.januar til 15.januar) medAntallDager
                    15 forkastet
    ...
    fun `kort periode med forlengelse og revurdering av siste periode`() {
        ...
        håndterOverstyrTidslinje(
            (13.februar til 14.februar).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilGodkjenning()
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Ubetalt avType
                    REVURDERING fra
                    (16.januar til 15.februar) medAntallDager
                    31 forkastet
                    false medTilstand
                    TilGodkjenning
                uberegnetPeriode(1) fra
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    REVURDERING fra
                    (1.januar til 31.januar) medTilstand
                    Utbetalt
            }
            1.generasjon {
                assertEquals(1, size)
    ...
    fun `får riktig vilkår per periode ved revurdering av siste periode`() {
        ...
        generasjoner {
            0.generasjon {
                ...
                beregnetPeriode(1).assertAldersvilkår(true, 25)
                beregnetPeriode(0)
                    .assertSykepengedagerVilkår(29, 219, 1.januar(2019), 1.januar, true)
                beregnetPeriode(1).assertSykepengedagerVilkår(11, 237, 28.desember, 1.januar, true)
            }
            1.generasjon {
                assertEquals(2, size)
    ...
    fun `får riktig vilkår per periode ved revurdering av første periode`() {
        ...
        forlengVedtak(1.februar, 28.februar)
        håndterOverstyrTidslinje(
            (30.januar til 31.januar).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilGodkjenning()
        ...
        generasjoner {
            0.generasjon {
                uberegnetPeriode(0) medTilstand UtbetaltVenterPåAnnenPeriode
                beregnetPeriode(1).assertAldersvilkår(true, 25)
                // Revurdering av tidligere periode medfører at alle perioder berørt av
                // revurderingen deler den samme utbetalingen, og derfor ender opp med samme
                // gjenstående dager, forbrukte dager og maksdato. Kan muligens skrives om i
                // modellen slik at disse tallene kan fiskes ut fra utbetalingen gitt en
                // periode
                beregnetPeriode(1)
                    .assertSykepengedagerVilkår(9, 239, 1.januar(2019), 1.januar, true)
            }
            1.generasjon {
                beregnetPeriode(0).assertSykepengedagerVilkår(31, 217, 28.desember, 1.januar, true)
                beregnetPeriode(1).assertSykepengedagerVilkår(11, 237, 28.desember, 1.januar, true)
    ...
    fun `ta med personoppdrag`() {
        ...
        generasjoner {
            0.generasjon {
                ...
                assertEquals(
                    2161,
                    this.perioder.first().sammenslåttTidslinje[16].utbetalingsinfo!!.personbeløp,
                )
    ...
    fun `lage generasjoner når a2 er i Avventer historikk revurdering og har blitt tildelt utbetaling`() {
        nyeVedtak(1.januar, 31.januar, a1 to 1, a2 to 1)
        håndterOverstyrTidslinje(
            listOf(ManuellOverskrivingDag(17.januar, Dagtype.Feriedag)),
            orgnummer = a1,
        )
        håndterYtelserTilUtbetalt()
        generasjoner(a1) {
    ...
    fun `revurdering til kun ferie`() {
        nyttVedtak(1.januar, 31.januar)
        håndterOverstyrTidslinje(
            (17.januar til 31.januar).map { ManuellOverskrivingDag(it, Dagtype.Feriedag) }
        )
        håndterYtelserTilUtbetalt()
    ...
    fun `avvist utbetaling`() {
        ...
        generasjoner { assertEquals(0, size) }
    }
    ...
    fun `out of order med gap`() {
        ...
        generasjoner {
            ...
            0.generasjon {
                assertEquals(2, size)
                uberegnetPeriode(0) fra
                    (1.mars til 31.mars) medTilstand
                    UtbetaltVenterPåAnnenPeriode
                beregnetPeriode(1) er
                    Ubetalt avType
                    UTBETALING fra
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (1.januar til 20.januar) medTilstand
                    Utbetalt
            }
            1.generasjon {
                assertEquals(2, size)
    ...
    fun `omgjøre kort periode til at nav utbetaler`() {
        ...
        håndterOverstyrTidslinje(
            4.januar.til(19.januar).map { ManuellOverskrivingDag(it, Dagtype.SykedagNav, 100) },
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (4.januar til 20.januar) medTilstand
                    Utbetalt medHendelser
    ...
    fun `omgjøring av eldre kort periode`() {
        ...
        håndterOverstyrTidslinje(
            (1.januar til 4.januar).map { ManuellOverskrivingDag(it, Dagtype.Sykedag, 100) },
            orgnummer = a1,
        )
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (1.januar til 19.januar) medTilstand
                    Utbetalt
            }
            1.generasjon {
                assertEquals(2, size)
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (16.januar til 31.januar) medTilstand
                    Utbetalt
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (1.april til 10.april) medTilstand
                    Utbetalt
                beregnetPeriode(1) er
                    GodkjentUtenUtbetaling avType
                    REVURDERING fra
    ...
    fun `tidligere periode med arbeid får samme arbeidsgiverperiode som nyere periode`() {
        ...
        håndterSøknad(
            Sykdom(1.februar, 28.februar, 100.prosent),
            Søknad.Søknadsperiode.Arbeid(1.februar, 28.februar),
        )
        ...
        generasjoner {
            ...
            0.generasjon {
                ...
                beregnetPeriode(0) er
                    Utbetalingstatus.Utbetalt avType
                    REVURDERING fra
                    (2.mars til 31.mars) medTilstand
                    Utbetalt
                beregnetPeriode(1) er
                    Utbetalingstatus.Utbetalt avType
                    UTBETALING fra
                    (1.februar til 28.februar) medTilstand
                    Utbetalt
                beregnetPeriode(2) er
                    GodkjentUtenUtbetaling avType
                    UTBETALING fra
        ...
        generasjoner {
            ...
            1.generasjon {
                ...
                beregnetPeriode(0) fra
                    2.januar til
                    31.januar er
                    Utbetalingstatus.Utbetalt medTilstand
                    Utbetalt
            }
        }
    }
    ...
    private class Arbeidsgivergenerasjoner(
        ...
        fun SpeilGenerasjonDTO.beregnetPeriode(index: Int): BeregnetPeriode {
            ...
            require(periode is BeregnetPeriode) {
                "Perioden ${periode::class.simpleName} er ikke en beregnet periode!"
            }
            return periode
        }
        ...
        fun SpeilGenerasjonDTO.annullertPeriode(index: Int): AnnullertPeriode {
            val periode = this.perioder[index]
            require(periode is AnnullertPeriode) {
                "Perioden ${periode::class.simpleName} er ikke en annullert periode!"
            }
            return periode
        }
        ...
        fun SpeilGenerasjonDTO.uberegnetPeriode(index: Int): UberegnetPeriode {
            val periode = this.perioder[index]
            require(periode is UberegnetPeriode) {
                "Perioden ${periode::class.simpleName} er ikke en uberegnet periode!"
            }
            return periode
        }
        ...
        infix fun <T : SpeilTidslinjeperiode> T.harTidslinje(
            dager: Pair<Periode, SykdomstidslinjedagType>
        ): T {
        ...
        fun BeregnetPeriode.vilkårsgrunnlag(): no.nav.helse.spleis.speil.dto.Vilkårsgrunnlag {
            return requireNotNull(vilkårsgrunnlag[this.vilkårsgrunnlagId]) {
        ...
        infix fun <T : SpeilTidslinjeperiode> T.medPeriodetype(
            tidslinjeperiodetype: Tidslinjeperiodetype
        ): T {
