...
internal class UtbetalingslinjeForskjellTest {
    ...
    @Test
    fun hendelsemap() {
        (1.januar to 5.januar dagsats 500 satstype Satstype.Engang)
            .asUtbetalingslinje()
            .behovdetaljer()
            .also { map ->
    ...
    fun `teller stønadsdager i et oppdrags om kjøres frem igjen`() {
        ...
        assertEquals(
            7,
            Oppdrag.stønadsdager(
                arbeidsgiverOppdrag,
                personoppdragKjørtFremIgjen - opphørtPersonoppdrag,
            ),
        )
    }
    ...
    fun `fullstendig overskriv`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 9.februar endringskode NY pekerPå original.last()),
            actual,
        )
        assertEquals(original.fagsystemId, actual.fagsystemId)
    ...
    fun `slå sammen til én linje`() {
        ...
        assertEquals(ENDR, actual.endringskode)
        assertUtbetalinger(
            linjer(1.januar to 5.januar endringskode NY pekerPå original.last()),
            actual,
        )
    }
    ...
    fun `slå sammen til én linje - og trekke tilbake`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 4.januar endringskode NY pekerPå original.last()),
            actual,
        )
    }
    ...
    fun `slå sammen til én linje - og trekke tilbake 2`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 1.januar endringskode NY pekerPå original.last()),
            actual,
        )
    }
    ...
    fun `trekke tilbake siste linje`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 2.januar endringskode NY pekerPå original.last()),
            actual,
        )
    }
    ...
    fun `bygg videre på opphørt`() {
        ...
        assertUtbetalinger(
            linjer(2.januar to 5.januar endringskode NY pekerPå original.last()),
            actual,
        )
    }
    ...
    fun `opphøre oppdrag som bygget videre på opphør`() {
        ...
        val actual = revised - deleted
        assertUtbetalinger(
            linjer(8.januar to 10.januar endrer actual.last() opphører 8.januar),
            actual,
        )
    }
    ...
    fun `endrer fom på siste linje når forrige oppdrag har endret linje med opphør`() {
        ...
        val oppdrag2EndretSåUtvidet =
            linjer(1.januar to 18.januar, 24.januar to 29.januar, 30.januar to 3.februar)
        val oppdrag3 = oppdrag2EndretSåUtvidet - oppdrag2

        val oppdrag3EndretSisteFom =
            linjer(1.januar to 18.januar, 24.januar to 29.januar, 1.februar to 3.februar)
    ...
    fun `trekke periode tilbake med opphold`() {
        ...
        assertUtbetalinger(
            linjer(1.januar to 5.januar endringskode NY pekerPå actual.last()),
            revised,
        )
    }
    ...
    fun `trekke siste periode tilbake`() {
        val original = linjer(1.januar to 5.januar, 8.januar to 13.januar, 15.januar to 25.januar)
        val recalculated = linjer(1.januar to 5.januar, 8.januar to 13.januar)
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(
    ...
    fun `trekke siste periode tilbake, så frem igjen`() {
        ...
        val revised = recalculated - original
        val fremtrukket =
            linjer(1.januar to 5.januar, 8.januar to 13.januar, 15.januar to 25.januar)
    ...
    fun `trekke siste periode tilbake, så forlenge siste periode`() {
        ...
        val recalculated = linjer(1.januar to 5.januar, 8.januar to 13.januar)
        val revised = recalculated - original
        val extended = linjer(1.januar to 5.januar, 8.januar to 25.januar)
    ...
    fun `trekke periode tilbake potpourri 1`() {
        ...
        val recalculated =
            linjer(1.januar to 5.januar, 8.januar to 20.januar, 28.januar to 5.februar)
    ...
    fun `trekke periode tilbake potpourri 3`() {
        ...
        val recalculated =
            linjer(1.januar to 5.januar, 8.januar to 13.januar, 23.januar to 5.februar)
        val actual = recalculated - extended
    ...
    fun `Tre perioder hvor grad endres i siste periode`() {
        ...
        val new2 = linjer(17.juni(2020) to 31.juli(2020), 1.august(2020) to 31.august(2020) grad 50)
    ...
    fun `fom endres`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 10.januar endringskode NY pekerPå original.last()),
            actual,
        )
        assertEquals(original.fagsystemId, actual.fagsystemId)
        assertEquals(ENDR, actual.endringskode)
    ...
    fun `ingen overlapp og ulik fagsystemId`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(1.januar to 3.januar endringskode NY pekerPå original.last()),
            actual,
        )
        assertEquals(original.fagsystemId, actual.fagsystemId)
        assertEquals(ENDR, actual.endringskode)
    ...
    fun `potpourri 3`() {
        val original =
            linjer(1.januar to 5.januar, 6.januar to 12.januar grad 50, 13.januar to 19.januar)
        val new =
            linjer(
                1.januar to 5.januar,
    ...
    fun `ny er tom`() {
        ...
        val actual = recalculated - original
        assertUtbetalinger(
            linjer(4.januar to 12.januar grad 50 endrer original.last() opphører 1.januar),
            actual,
        )
        assertEquals(original.fagsystemId, actual.fagsystemId)
        assertFalse(aktivitetslogg.harVarslerEllerVerre())
    ...
    fun `Sletting med UEND`() {
        val original = linjer(1.januar to 5.januar, 8.januar to 12.januar)
        val recalculated = linjer(1.januar to 5.januar, 8.januar to 10.januar)
        val actual = recalculated - original
    ...
    fun `deletion potpourri`() {
        ...
        val new = linjer(6.januar to 19.januar grad 50, 20.januar to 26.januar)
        val actual = new - original
        assertUtbetalinger(
            linjer(
    ...
    private val Oppdrag.endringskode
        get() = this.get<Endringskode>("endringskode")

    private val Utbetalingslinje.endringskode
        get() = this.get<Endringskode>("endringskode")

    private val Utbetalingslinje.id
        get() = this.get<Int>("delytelseId")

    private val Utbetalingslinje.refId
        get() = this.get<Int?>("refDelytelseId")

    private val Oppdrag.fagsystemId
        get() = this.get<String>("fagsystemId")

    private val Utbetalingslinje.datoStatusFom
        get() = this.get<LocalDate?>("datoStatusFom")
    ...
    private fun assertUtbetalinger(expected: Oppdrag, actual: Oppdrag) {
        ...
        (expected zip actual).forEach { (a, b) ->
            ...
            assertEquals(a.endringskode, b.endringskode) {
                "endringskode ${b.endringskode} matcher ikke forventet ${a.endringskode}"
            }
            assertEquals(a.id, b.id) {
                "delytelseid ${b.id} matcher ikke forventet ${a.id} for ${a.fom} - ${a.tom}"
            }
            assertEquals(a.refId, b.refId) {
                "refdelytelseid ${b.refId} matcher ikke forventet ${a.refId}"
            }
        }
    }
    ...
    private fun linjer(vararg linjer: TestUtbetalingslinje, other: Oppdrag? = null): Oppdrag {
        val fagsystemId =
            other?.inspektør?.fagsystemId() ?: genererUtbetalingsreferanse(UUID.randomUUID())
    ...
    private fun List<TestUtbetalingslinje>.tilUtbetalingslinjerDto(
        fagsystemId: String
    ): List<UtbetalingslinjeInnDto> {
        return (take(1).map { it.asUtbetalingslinje() } +
                drop(1).map { it.asUtbetalingslinje(fagsystemId) })
            .map { it.dto() }
            .map {
