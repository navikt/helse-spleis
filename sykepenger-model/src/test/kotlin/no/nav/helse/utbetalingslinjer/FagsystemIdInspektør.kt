...
internal class FagsystemIdInspektør(fagsystemIder: List<FagsystemId>) : FagsystemIdVisitor {
    ...
    override fun preVisitFagsystemId(fagsystemId: FagsystemId, id: String, fagområde: Fagområde, tilstand: String, utbetalingstidslinje: Utbetalingstidslinje) {
    ...
    override fun postVisitFagsystemId(fagsystemId: FagsystemId, id: String, fagområde: Fagområde, tilstand: String, utbetalingstidslinje: Utbetalingstidslinje) {
        fagsystemIdTeller += 1
    }
}
