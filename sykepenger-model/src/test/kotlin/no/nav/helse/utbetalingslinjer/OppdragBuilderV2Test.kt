...
internal class OppdragBuilderV2Test {

    @Test
    fun `kan starte oppdrag på helg`() {
        val builder = OppdragBuilderV2(sisteArbeidsgiverdag = 19.januar, mottaker = "ornr", fagområde = Fagområde.SykepengerRefusjon)
        builder.betalingshelgedag(20.januar, 100)
        builder.betalingshelgedag(21.januar, 100)
        builder.betalingsdag(beløpskilde(500, 0), 22.januar, 100, 500)
    ...
    fun `kan slutte linje på helg`() {
        ...
        builder.betalingshelgedag(21.januar, 100)
        builder.betalingsdag(beløpskilde(500, 0), 22.januar, 100, 500)
        builder.betalingsdag(beløpskilde(500, 0), 23.januar, 100, 500)
        builder.betalingsdag(beløpskilde(500, 0), 24.januar, 100, 500)
        builder.betalingsdag(beløpskilde(500, 0), 25.januar, 100, 500)
        builder.betalingsdag(beløpskilde(500, 0), 26.januar, 100, 500)
        builder.betalingshelgedag(27.januar, 100)
        builder.betalingshelgedag(28.januar, 100)
        builder.ikkeBetalingsdag()
        builder.betalingsdag(beløpskilde(500, 0), 30.januar, 100, 500)
        val result = builder.build()
