...
internal class BegrunnelseForReduksjonEllerIkkeUtbetaltTest : AbstractDslTest() {
    ...
    fun `Vedtaksperiode blir strukket med UkjentDag`() {
        a1 {
            ...
            assertEquals(
                25.januar,
                inspektør.vedtaksperioder(2.vedtaksperiode).inspektør.behandlinger.last().endringer.last().sykdomstidslinje.inspektør.førsteIkkeUkjenteDag
            )
            ...
            assertForventetFeil(
                ...
                nå = {
                    (17.januar til 31.januar).let { periode ->
                        ...
                        assertEquals(
                            periode,
                            inspektør.vedtaksperioder(2.vedtaksperiode).inspektør.behandlinger.last().endringer.last().sykdomstidslinje.periode()
                        )
