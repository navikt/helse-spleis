...
internal class SkjæringstidspunktE2ETest : AbstractDslTest() {
    ...
    fun `oppdaterer skjæringstidspunkt på senere auu ved overstyring av tidligere auu`() {
        a1 {
            ...
            assertSkjæringstidspunktOgVenteperiode(1.vedtaksperiode, 2.januar, listOf(2.januar til 16.januar))
            assertSkjæringstidspunktOgVenteperiode(2.vedtaksperiode, 2.januar, listOf(2.januar til 16.januar))
        }
    }
    ...
    fun `periode med bare ferie - tidligere sykdom`() {
        a1 {
            ...
            assertTilstander(1.vedtaksperiode, START, AVVENTER_INNTEKTSMELDING, AVVENTER_AVSLUTTET_UTEN_UTBETALING, AVSLUTTET_UTEN_UTBETALING)
        }
    }
