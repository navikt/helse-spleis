...
internal class MinimumSykdomsgradVurdertFlereAGTest : AbstractEndToEndTest() {
    ...
    fun `Saksbehandler vurderer arbeidstid og avslår under 20 prosent på begge arbeidsgivere`() {
        ...
        assertTrue(
            inspektør(a1).utbetalinger(1.vedtaksperiode).last().inspektør.utbetalingstidslinje.inspektør.navdager.all {
                it.økonomi.inspektør.grad ==
                    15.prosent
            },
        )
        assertTrue(
        ...
        assertTrue(
            inspektør(a2).utbetalinger(1.vedtaksperiode).last().inspektør.utbetalingstidslinje.inspektør.navdager.all {
                it.økonomi.inspektør.grad ==
                    20.prosent
            },
        )
