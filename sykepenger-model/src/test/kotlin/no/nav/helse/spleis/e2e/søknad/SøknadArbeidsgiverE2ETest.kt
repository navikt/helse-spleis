...
internal class SøknadArbeidsgiverE2ETest : AbstractEndToEndTest() {
    ...
    fun `korrigerer førstegangsbehandling med ferie i arbeidsgiverperioden - søknad mottatt i avventer vilkårsprøving`() {
        ...
        (10.januar til 12.januar).forEach { dato ->
            assertEquals(Dag.Arbeidsdag::class, inspektør.sykdomstidslinje[dato]::class) {
                "$dato er av annen dagtype"
            }
        }
        (13.januar til 15.januar).forEach { dato ->
            assertEquals(Dag.Feriedag::class, inspektør.sykdomstidslinje[dato]::class) {
                "$dato er av annen dagtype"
            }
        }
        assertTilstander(
    ...
    fun `avslutter uferdig forlengelseperiode som bare strekkes inn i helg`() {
        ...
        håndterInntektsmelding(
            listOf(
                ...
                6.januar til
                    9
                        .januar, // lager et tredagers opphold (10. januar - 12. januar) som
                                 // forskyver agp
                13.januar til
                    19
                        .januar, // til å slutte 19. januar. Periode nr 3. forlenger derfor kun helg,
                                // og skal også avsluttes uten utbetaling
            ),
    ...
    fun `avslutter korte perioder med gap`() {
        ...
        håndterInntektsmelding(
            listOf(1.januar til 5.januar, 9.januar til 12.januar, 16.januar til 22.januar),
