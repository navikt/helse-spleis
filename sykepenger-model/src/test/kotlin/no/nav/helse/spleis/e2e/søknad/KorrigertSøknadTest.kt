...
internal class KorrigertSøknadTest : AbstractEndToEndTest() {
    ...
    fun `korrigerer med arbeid gjenopptatt etter utbetalt`() {
        ...
        assertEquals(
            "AAAAARR AAAAARR AAAAARR AAAAARR AAA",
    ...
    fun `Korrigerer grad`() {
        ...
        assertEquals(
            50,
            inspektør.utbetalingstidslinjer(1.vedtaksperiode).inspektør.grad(17.januar),
        )
    }
    ...
    fun `Korrigerer feriedag til sykedag i forlengelse`() {
        ...
        inspektør.sykdomstidslinje.inspektør.also { assertTrue(it[28.februar] is Sykedag) }
    ...
    fun `Blir værende i nåværende tilstand dersom søknad kommer inn i AVVENTER_INNTEKTSMELDING_UFERDIG_GAP`() {
        ...
        inspektør.sykdomstidslinje.inspektør.also { assertTrue(it[28.februar] is Feriedag) }
        assertTilstander(
            1.vedtaksperiode,
            START,
            AVVENTER_INFOTRYGDHISTORIKK,
    ...
    fun `Blir værende i nåværende tilstand dersom søknad kommer inn i AVENTER_TIDLIGERE_ELLER_OVERLAPPENDE`() {
        ...
        inspektør.sykdomstidslinje.inspektør.also { assertTrue(it[31.januar] is Feriedag) }
        assertTilstander(
            1.vedtaksperiode,
            START,
            AVVENTER_INFOTRYGDHISTORIKK,
    ...
    fun `avslutter periode med 100 % ferie og ingen utbetaling -- avventer vilkårsprøving`() {
        ...
        inspektør.sykdomstidslinje.inspektør.also { inspektør ->
            (17.januar til 31.januar).forEach { assertTrue(inspektør[it] is Feriedag) }
        }
        assertTilstander(
            1.vedtaksperiode,
            START,
    ...
    fun `Går tilbake til AVVENTER_HISTORIKK når søknaden kommer inn i AVVENTER_SIMULERING`() {
        ...
        inspektør.sykdomstidslinje.inspektør.also { assertTrue(it[31.januar] is Sykedag) }
        assertTilstander(
            1.vedtaksperiode,
            START,
            AVVENTER_INFOTRYGDHISTORIKK,
    ...
    fun `Korrigerende søknad appender egenmeldingsperioder til vedtaksperioden`() {
        håndterSøknad(
            Sykdom(3.januar, 31.januar, 100.prosent),
        ...
        håndterSøknad(
            Sykdom(7.januar, 31.januar, 100.prosent),
            egenmeldinger = listOf(5.januar til 6.januar),
        )
        assertEquals(
        ...
        håndterSøknad(
            Sykdom(6.januar, 31.januar, 100.prosent),
            egenmeldinger = listOf(2.januar til 5.januar),
        )
        assertEquals(
        ...
        håndterSøknad(
            Sykdom(7.januar, 31.januar, 100.prosent),
            egenmeldinger = listOf(1.januar til 6.januar),
        )
        assertEquals(
            listOf(1.januar til 6.januar),
            inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.egenmeldingsperioder,
    ...
    fun `Korrigerende søknad som fører til revurdering appender egenmeldingsperioder til vedtaksperioden`() {
        ...
        håndterSøknad(
            Sykdom(1.januar, 31.januar, 100.prosent),
            egenmeldinger = listOf(1.januar til 5.januar, 8.januar til 10.januar),
        )
        assertEquals(
