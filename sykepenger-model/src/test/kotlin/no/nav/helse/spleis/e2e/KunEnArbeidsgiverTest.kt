...
internal class KunEnArbeidsgiverTest : AbstractDslTest() {
    ...
    fun `ingen historie med to søknader til arbeidsgiver før inntektsmelding`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(arbeidsgiverperioder = listOf(3.januar til 18.januar), INNTEKT)
    ...
    fun `ingen historie med to søknader (med gap mellom) til arbeidsgiver først`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(listOf(3.januar til 4.januar, 8.januar til 21.januar), INNTEKT)
    ...
    fun `inntektsmeldingen padder ikke senere vedtaksperioder med arbeidsdager`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(listOf(4.januar til 19.januar), INNTEKT)
            håndterVilkårsgrunnlag(1.vedtaksperiode)
            håndterYtelser(1.vedtaksperiode)
            håndterSimulering(1.vedtaksperiode)
    ...
    fun `forlengelseperioden avsluttes ikke automatisk hvis warnings`() {
        a1 {
            ...
            håndterYtelser(2.vedtaksperiode, arbeidsavklaringspengerV2 = listOf(3.januar.minusDays(60) til 5.januar.minusDays(60)))
