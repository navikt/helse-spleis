...
internal class FlereArbeidsgivereArbeidsforholdTest : AbstractEndToEndTest() {
    ...
    fun `Syk for a1, slutter i a1, syk for a2, a1 finnes ikke i Aa-reg lenger - ingen warning for manglende arbeidsforhold`() {
        ...
        assertEquals(
            ...
            inspektør(
                a2,
            ).vedtaksperioder(1.vedtaksperiode).inspektør.utbetalingstidslinje[19.mars].økonomi.inspektør.arbeidsgiverbeløp?.daglig,
        )
    ...
    fun `opphold i arbeidsforhold skal ikke behandles som ghost`() {
        ...
        assertEquals(
            100,
            inspektør(a2).vedtaksperioder(1.vedtaksperiode).inspektør.utbetalingstidslinje[20.februar].økonomi.brukTotalGrad { totalGrad ->
                totalGrad
            },
        )
        assertEquals(
