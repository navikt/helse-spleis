...
internal class SkjønnsmessigFastsettelseTest : AbstractDslTest() {
        ...
        a1 {
            val sykepengegrunnlag =
                inspektør
                    ...
                    ?.inspektør
                    ?.inntektsgrunnlag
                    ?.inspektør ?: fail { "forventer vilkårsgrunnlag" }
    ...
    fun `saksbehandler-inntekt overstyres av en skjønnsmessig med samme beløp`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(orgnummer = a1, inntekt = INNTEKT * 2, forklaring = "forklaring")),
        )
    ...
    fun `Overstyre refusjon etter skjønnsmessig fastsatt -- etter utbetalt`() {
        ...
        a1 {
            ...
            assertLikeRefusjonsopplysninger(
                listOf(Refusjonsopplysning(inntektsmeldingId, 1.januar, null, inntektsmeldingInntekt, ARBEIDSGIVER)),
            ...
            håndterSkjønnsmessigFastsettelse(
                1.januar,
                listOf(OverstyrtArbeidsgiveropplysning(orgnummer = a1, inntekt = skjønnsfastsattInntekt)),
            )
            assertEquals(2, inspektør.vilkårsgrunnlagHistorikkInnslag().size)
            assertTrue(inspektør.inntektsopplysningISykepengegrunnlaget(1.januar) is SkjønnsmessigFastsatt)
            assertLikeRefusjonsopplysninger(
            ...
            håndterOverstyrArbeidsgiveropplysninger(
                ...
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        forklaring = "forklaring",
                        refusjonsopplysninger = listOf(Triple(1.januar, null, skjønnsfastsattInntekt)),
                    ),
                ),
            ...
            assertTrue(inspektør.inntektsopplysningISykepengegrunnlaget(1.januar) is SkjønnsmessigFastsatt)
            assertLikeRefusjonsopplysninger(
                listOf(Refusjonsopplysning(overstyrInntektOgRefusjonId, 1.januar, null, skjønnsfastsattInntekt, SAKSBEHANDLER)),
                inspektør.refusjonsopplysningerFraVilkårsgrunnlag(),
            )
        }
    }
