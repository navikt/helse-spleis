...
internal class SkjønnsmessigFastsettelseTest : AbstractDslTest() {
    ...
    fun `Når inntekt skjønnsfastsettes til 0 og det finnes andre arbeidsgivere i økonomi-lista`() {
        ...
        "a6" {
            ...
            håndterSkjønnsmessigFastsettelse(
                1.mars,
                listOf(OverstyrtArbeidsgiveropplysning("a6", INGEN)),
            )
    ...
    fun `blir syk fra ghost etter skjønnsfastsettelse - skal ikke medføre ny skjønnsfastsettelse`() {
        ...
        a1 {
            val sykepengegrunnlag =
                inspektør.vilkårsgrunnlag(1.januar)?.inspektør?.inntektsgrunnlag?.inspektør
                    ?: fail { "forventer vilkårsgrunnlag" }

            sykepengegrunnlag.arbeidsgiverInntektsopplysningerPerArbeidsgiver
                .getValue(a1)
                .inspektør
                .also { arbeidsgiverInntektsopplysning ->
                    assertInstanceOf(
                        SkjønnsmessigFastsatt::class.java,
                        arbeidsgiverInntektsopplysning.inntektsopplysning,
                    )
                }
            sykepengegrunnlag.arbeidsgiverInntektsopplysningerPerArbeidsgiver
                .getValue(a2)
            ...
            håndterVilkårsgrunnlag(
                ...
                inntektsvurderingForSykepengegrunnlag =
                    lagStandardSykepengegrunnlag(
                        listOf(a1 to INNTEKT, a2 to inntektVedSkjønnsvurdering),
                        1.januar,
                    ),
                arbeidsforhold =
                    listOf(
    ...
    fun `korrigere inntekten på noe som allerede har blitt skjønnsmessig fastsatt`() {
        ...
        håndterSkjønnsmessigFastsettelse(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(orgnummer = a1, inntekt = INNTEKT * 3)),
        )
        inspektør.inntektsopplysningISykepengegrunnlaget(1.januar).let {
            assertTrue(it is SkjønnsmessigFastsatt)
    ...
    fun `saksbehandler-inntekt overstyres av en skjønnsmessig med samme beløp`() {
        ...
        assertTrue(
            inspektør.inntektsopplysningISykepengegrunnlaget(1.januar) is SkjønnsmessigFastsatt
        )
    }
    ...
    fun `skjønnsmessig fastsettelse overstyres av en inntektmelding med samme beløp`() {
        a1 {
            ...
            håndterSkjønnsmessigFastsettelse(
                1.januar,
                listOf(OverstyrtArbeidsgiveropplysning(orgnummer = a1, inntekt = inntekt)),
            )
            assertEquals(2, inspektør.vilkårsgrunnlagHistorikkInnslag().size)
    ...
    fun `korrigert IM etter skjønnsfastsettelse på flere AG`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            ...
            listOf(
                OverstyrtArbeidsgiveropplysning(
                    orgnummer = a3,
                    inntekt = INNTEKT * 3,
                    forklaring = "ogga bogga",
                )
            ),
        )
        a3 {
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a3) is Saksbehandler
            )
        }
        håndterSkjønnsmessigFastsettelse(
            1.januar,
        ...
        a1 {
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a1)
                    is SkjønnsmessigFastsatt
            )
        }
        a2 {
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a2)
                    is SkjønnsmessigFastsatt
            )
        }
        a3 {
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a3)
                    is SkjønnsmessigFastsatt
            )
        }
        ...
        a2 {
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a2) is Inntektsmelding
            )
        }
        a3 {
            assertTrue(
    ...
    fun `Overstyre refusjon etter skjønnsmessig fastsatt -- etter utbetalt`() {
        ...
        a1 {
            ...
            val inntektsmeldingId =
                håndterInntektsmelding(
                    listOf(1.januar til 16.januar),
                    beregnetInntekt = inntektsmeldingInntekt,
                    refusjon = Refusjon(inntektsmeldingInntekt, null, emptyList()),
                )
            håndterVilkårsgrunnlag(1.vedtaksperiode)
            håndterYtelser(1.vedtaksperiode)
            håndterSimulering(1.vedtaksperiode)
            ...
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar) is Inntektsmelding
            )
            assertLikeRefusjonsopplysninger(
                ...
                inspektør.refusjonsopplysningerFraVilkårsgrunnlag(),
            )
            ...
            håndterSkjønnsmessigFastsettelse(
                ...
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        orgnummer = a1,
                        inntekt = skjønnsfastsattInntekt,
                    )
                ),
            )
            assertEquals(2, inspektør.vilkårsgrunnlagHistorikkInnslag().size)
                ...
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        refusjonsopplysninger =
                            listOf(Triple(1.januar, null, skjønnsfastsattInntekt)),
                    )
                ),
                hendelseId = overstyrInntektOgRefusjonId,
            )
            assertEquals(3, inspektør.vilkårsgrunnlagHistorikkInnslag().size)
            assertTrue(
                inspektør.inntektsopplysningISykepengegrunnlaget(1.januar) is SkjønnsmessigFastsatt
            ...
            assertLikeRefusjonsopplysninger(
                listOf(
                    Refusjonsopplysning(
                        overstyrInntektOgRefusjonId,
                        1.januar,
                        null,
                        skjønnsfastsattInntekt,
                        SAKSBEHANDLER,
                    )
                ),
                inspektør.refusjonsopplysningerFraVilkårsgrunnlag(),
