...
internal class OvergangNyArbeidsgiverTest : AbstractDslTest() {
    ...
    fun `overgang til ny arbeidsgiver - innenfor agp - reduksjon oppgitt`() {
        ...
        a2 {
            ...
            assertTilstander(1.vedtaksperiode, START, AVVENTER_INNTEKTSMELDING, AVSLUTTET_UTEN_UTBETALING, AVVENTER_INNTEKTSMELDING, AVVENTER_BLOKKERENDE_PERIODE, AVVENTER_HISTORIKK)
        }
    }
            ...
            inspektør.utbetaling(0).inspektør.also { utbetalingInspektør ->
                utbetalingInspektør.utbetalingstidslinje.also { utbetalingstidslinje ->
                    utbetalingstidslinje[1.februar].also { dagen ->
                        ...
                        assertEquals(1385.0.daglig, dagen.økonomi.inspektør.arbeidsgiverbeløp) // TODO Stemmer dette ?
                        assertEquals(776.0.daglig, dagen.økonomi.inspektør.personbeløp) // ?
                    }
                }
            }
            assertTilstander(
