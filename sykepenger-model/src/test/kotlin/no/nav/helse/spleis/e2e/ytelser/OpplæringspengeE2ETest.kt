...
internal class OpplæringspengeE2ETest : AbstractEndToEndTest() {
    ...
    fun `Opplæringspenger starter mindre enn 4 uker før sykefraværstilfellet`() {
        ...
        håndterYtelser(
            1.vedtaksperiode,
            opplæringspenger = listOf(GradertPeriode(3.februar til 20.februar, 100))
        )
    ...
    fun `Opplæringspenger starter mer enn 4 uker før sykefraværstilfellet`() {
        ...
        håndterYtelser(
            1.vedtaksperiode,
            opplæringspenger = listOf(GradertPeriode(3.januar til 20.januar, 100))
        )
    ...
    fun `Periode som overlapper med opplæringspengerytelse i starten av perioden får varsel`() {
        ...
        håndterYtelser(
            1.vedtaksperiode,
            opplæringspenger = listOf(GradertPeriode(1.desember(2017) til 1.januar, 100))
        )
        assertVarsel(Varselkode.RV_AY_8)
        assertTilstander(
            1.vedtaksperiode,
    ...
    fun `Periode som overlapper med opplæringspengerytelse i slutten av perioden får varsel`() {
        ...
        håndterYtelser(
            1.vedtaksperiode,
            opplæringspenger = listOf(GradertPeriode(31.januar til 14.februar, 100))
        )
        assertVarsel(Varselkode.RV_AY_8)
        assertTilstander(
            1.vedtaksperiode,
