...
internal class FlereArbeidsgivereUlikFomTest : AbstractEndToEndTest() {
    ...
    fun `Gjenbruk av tidsnære opplysninger slår ikke til ved skatteinntekt i inntektsgrunnlaget`() {
        ...
        inspektør
            ...
            .let { arbeidsgiverInntektsopplysninger ->
                assertTrue(
                    arbeidsgiverInntektsopplysninger.single { it.gjelder(a1) }.inntektsopplysning
                        is Inntektsmelding
                )
                assertTrue(
                    arbeidsgiverInntektsopplysninger.single { it.gjelder(a2) }.inntektsopplysning
        ...
        håndterOverstyrTidslinje(
            listOf(ManuellOverskrivingDag(1.februar, Dagtype.Arbeidsdag)),
            orgnummer = a2,
        )
        ...
        assertForventetFeil(
            forklaring =
                "Ettersom a2 har skatt i inntektsgrunnlaget slår ikke gjenbruk av opplysninger til.",
            nå = {
    ...
    fun `ag2 forkaster utbetaling tildelt av ag1 om det har skjedd endringer i mellomtiden`() {
        ...
        håndterSimulering(1.vedtaksperiode, orgnummer = a1)
        håndterOverstyrTidslinje(
            listOf(ManuellOverskrivingDag(20.januar, Dagtype.Feriedag)),
            orgnummer = a1,
        )
        håndterYtelser(1.vedtaksperiode, orgnummer = a1)
        håndterSimulering(1.vedtaksperiode, orgnummer = a1)
        ...
        val inntekter =
            listOf(
                ...
                grunnlag(
                    a2,
                    finnSkjæringstidspunkt(a1, 1.vedtaksperiode),
                    20000.månedlig.repeat(2) + 23000.månedlig,
                ),
            )
        håndterVilkårsgrunnlag(
            1.vedtaksperiode,
    ...
    fun `mursteinspølser og manglende inntektsmelding på a2`() {
        ...
        nullstillTilstandsendringer()
        // Perioden som står i AvventerGodkjenningRevurdering får ikke noe signal om overstyring
        // igangsatt ettersom disse periodene er _etter_ 1.vedtaksperiode
        // Allikevel kan den ikke beregnes på nytt, fordi mursteinssituasjonen som nå har oppstått
        // gjør at vi mangler refusjonsopplysninger på 22.januar
        ...
        // Om f.eks. saksbehandler overstyrer perioden som står i AvventerGodkjenningRevurdering
        // blir den sittende fast i AvventerRevurdering
        ...
        val venterPå =
            observatør.vedtaksperiodeVenter
                .last { it.vedtaksperiodeId == 1.vedtaksperiode.id(a1) }
                .venterPå
        assertEquals("INNTEKTSMELDING", venterPå.venteårsak.hva)
        ...
        val inntekter =
            listOf(
                grunnlag(
                    a1,
                    finnSkjæringstidspunkt(a1, 1.vedtaksperiode),
                    31500.månedlig.repeat(3),
                ),
                grunnlag(
                    a2,
                    finnSkjæringstidspunkt(a1, 1.vedtaksperiode),
                    32500.månedlig.repeat(3),
                ),
                grunnlag(
                    a3,
                    finnSkjæringstidspunkt(a1, 1.vedtaksperiode),
                    33500.månedlig.repeat(3),
                ),
    ...
    fun `Fire arbeidsgivere - overlappende perioder med ulik fom men lik slutt, nå med gradert sykmelding!`() {
        ...
        // Siden maksbeløpet blir større når vi får inn flere arbeidsgivere vil vi få en ekstra
        // krone som blir med i kronerulleringen(avrunning), det fører
    ...
    fun `skjæringstidspunkt i samme måned betyr at begge arbeidsgivere bruker inntekt fra inntektsmelding`() {
        ...
        håndterVilkårsgrunnlag(
            1.vedtaksperiode,
            inntektsvurderingForSykepengegrunnlag =
                InntektForSykepengegrunnlag(inntekter = inntekterFraSkatt),
            orgnummer = a1,
        )
    ...
    fun `To arbeidsgivere med ulik fom i samme måned - med en tidligere periode i samme måned - andre vedtaksperiode velger IM for egen første fraværsdag`() {
        ...
        val vilkårsgrunnlag =
            inspektør(a1).vilkårsgrunnlag(2.vedtaksperiode)?.inspektør
                ?: fail { "finner ikke vilkårsgrunnlag" }
        val sykepengegrunnlagInspektør = vilkårsgrunnlag.inntektsgrunnlag.inspektør
    ...
    fun `skjæringstidspunktet er i måneden før ag1`() {
        ...
        håndterInntektsmelding(listOf(februar), orgnummer = a1, avsendersystem = ALTINN)
        håndterVilkårsgrunnlag(
            1.vedtaksperiode,
            inntektsvurderingForSykepengegrunnlag =
                InntektForSykepengegrunnlag(
        ...
        val vilkårsgrunnlag =
            inspektør(a1).vilkårsgrunnlag(1.vedtaksperiode) ?: fail { "forventer vilkårsgrunnlag" }
        vilkårsgrunnlag.inspektør.inntektsgrunnlag.inspektør
            ...
            .also { inntekter ->
                ...
                assertEquals(
                    SkattSykepengegrunnlag::class,
                    inntekter.getValue(a1).inspektør.inntektsopplysning::class,
                )
                assertEquals(
                    SkattSykepengegrunnlag::class,
                    inntekter.getValue(a2).inspektør.inntektsopplysning::class,
                )
            }
    ...
    fun `skjæringstidspunktet er i måneden før ag1 og ag2 - nyoppstartet arbeidsforhold ag2 - bare inntekt 3 mnd før`() {
        ...
        håndterVilkårsgrunnlag(
            ...
            inntektsvurderingForSykepengegrunnlag =
                InntektForSykepengegrunnlag(
                    inntektperioderForSykepengegrunnlag {
                        1.oktober(2017) til 1.desember(2017) inntekter { a1 inntekt INNTEKT }
                    }
                ),
            arbeidsforhold =
                listOf(
        ...
        val vilkårsgrunnlag =
            inspektør(a2).vilkårsgrunnlag(1.vedtaksperiode) ?: fail { "forventer vilkårsgrunnlag" }
        vilkårsgrunnlag.inspektør.inntektsgrunnlag.inspektør
            .arbeidsgiverInntektsopplysningerPerArbeidsgiver
            .also { inntekter ->
                assertEquals(2, inntekter.size)
    ...
    fun `ghost blir syk, vi har ikke mottatt IM enda, men kan beregne tidligere periode`() {
        ...
        håndterVilkårsgrunnlag(
            ...
            inntektsvurderingForSykepengegrunnlag =
                lagStandardSykepengegrunnlag(
                    listOf(Pair(a1, INNTEKT), Pair(a2, 1000.månedlig)),
                    1.januar,
                ),
            arbeidsforhold =
                listOf(
    ...
    fun `avviser dag med totalgrad under 20 prosent`() {
        ...
        håndterVilkårsgrunnlag(
            ...
            inntektsvurderingForSykepengegrunnlag =
                lagStandardSykepengegrunnlag(
                    listOf(Pair(a1, inntektA1), Pair(a2, inntektA2)),
                    1.mai(2023),
                ),
            arbeidsforhold =
                listOf(
        ...
        assertNotNull(
            utbetalingstidslinje[31.mai(2023)].erAvvistMed(Begrunnelse.MinimumSykdomsgrad)
        )
