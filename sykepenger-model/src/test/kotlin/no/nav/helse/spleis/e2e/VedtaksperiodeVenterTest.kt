...
internal class VedtaksperiodeVenterTest : AbstractDslTest() {
    ...
    private fun assertVenterPå(expected: List<Pair<UUID, Hva>>) {
        val actual =
            observatør.vedtaksperiodeVenter.map {
                it.vedtaksperiodeId to it.venterPå.venteårsak.hva
            }
    ...
    internal companion object {
        internal fun TestObservatør.assertVenter(
            ...
            vedtaksperiodeVenter
                .last { it.vedtaksperiodeId == venterVedtaksperiodeId }
                .venterPå
                .assertVenterPå(venterPåVedtaksperiodeId, venterPåOrgnr, venterPåHva, fordi)
            if (venterVedtaksperiodeId == venterPåVedtaksperiodeId) return
            // Om periode A venter på en annen periode B så burde også B vente på B (vente på seg
            // selv)
            vedtaksperiodeVenter
                .last { it.vedtaksperiodeId == venterPåVedtaksperiodeId }
                .venterPå
                .assertVenterPå(venterPåVedtaksperiodeId, venterPåOrgnr, venterPåHva, fordi)
        }
