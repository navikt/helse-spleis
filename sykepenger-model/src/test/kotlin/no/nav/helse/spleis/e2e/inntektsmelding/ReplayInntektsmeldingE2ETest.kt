...
internal class ReplayInntektsmeldingE2ETest : AbstractEndToEndTest() {
    ...
    fun `Avhengig av replay av inntektsmelding for inntekt også i ikke-ghost-situasjon - første fraværsdag kant-i-kant`() {
        ...
        assertEquals(
            ...
            inspektør.inntektInspektør.inntektsdatoer,
        ) // Replayer IM. Nå som personen er syk 21.januar lagres den både på 21.januar og
          // alternativ inntektsdato (1.januar)
    ...
    fun `replay av IM medfører ikke at allerede revurdert skjæringstidspunkt revurderes på nytt`() {
        ...
        ) // fra førstegangsbehandling, korrigert IM, skjønnsmessig fastsatt & periode out-of-order
          // på nytt skjæringstidspunkt
    }
}
