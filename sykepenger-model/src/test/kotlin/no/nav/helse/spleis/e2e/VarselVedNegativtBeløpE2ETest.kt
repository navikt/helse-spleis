...
internal class VarselVedNegativtBeløpE2ETest : AbstractDslTest() {
    ...
    fun `skal få varsel når utbetaling flyttes fra arbeidsgiver til person`() {
        a1 {
            ...
            håndterOverstyrArbeidsgiveropplysninger(
                ...
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        ".",
                        null,
                        listOf(Triple(1.januar, null, Inntekt.INGEN)),
                    )
                ),
            )
            ...
            assertEquals(
                -15741,
                inspektør.sisteUtbetaling().arbeidsgiverOppdrag.inspektør.nettoBeløp,
            )
    ...
    fun `skal få varsel når utbetaling reduseres pga lavere inntekt`() {
        a1 {
            ...
            håndterOverstyrArbeidsgiveropplysninger(
                1.januar,
                listOf(OverstyrtArbeidsgiveropplysning(a1, INNTEKT * 0.8, ".", null, emptyList())),
            )
            håndterYtelser(1.vedtaksperiode)
            assertEquals(
                -3146,
