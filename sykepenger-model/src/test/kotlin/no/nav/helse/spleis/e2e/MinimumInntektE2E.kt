    ...
    fun `avslår dager tom 67 år`() {
        ...
        a1 {
            ...
            inspektør.utbetalingstidslinjer(1.vedtaksperiode).inspektør.also { utbetalingstidslinjeInspektør ->
                ...
                assertEquals(
                    (17.januar til 31.januar).filterNot { it.erHelg() },
                    utbetalingstidslinjeInspektør.avvistedatoer
                )
                assertTrue(utbetalingstidslinjeInspektør.avvistedatoer.all {
                    utbetalingstidslinjeInspektør.begrunnelse(
                        it
                    ).single() == Begrunnelse.MinimumInntekt
                })
            }
    ...
    fun `avslår dager etter fylte 67 år selv om skjæringstidspunktet var før fylte 67 år`() {
        ...
        a1 {
            ...
            inspektør.utbetalingstidslinjer(1.vedtaksperiode).inspektør.also { utbetalingstidslinjeInspektør ->
                ...
                assertEquals(
                    (7.februar til 28.februar).filterNot { it.erHelg() },
                    utbetalingstidslinjeInspektør.avvistedatoer
                )
                assertTrue(utbetalingstidslinjeInspektør.avvistedatoer.all {
                    utbetalingstidslinjeInspektør.begrunnelse(
                        it
                    ).single() == Begrunnelse.MinimumInntektOver67
                })
            }
    ...
    fun `avslår dager etter fylte 67 år`() {
        ...
        a1 {
            ...
            inspektør.utbetalingstidslinjer(1.vedtaksperiode).inspektør.also { utbetalingstidslinjeInspektør ->
                ...
                assertEquals(
                    (17.februar til 28.februar).filterNot { it.erHelg() },
                    utbetalingstidslinjeInspektør.avvistedatoer
                )
                assertTrue(utbetalingstidslinjeInspektør.avvistedatoer.all {
                    utbetalingstidslinjeInspektør.begrunnelse(
    ...
    fun `avslår perioden med ny begrunnelse etter fylte 67 år`() {
        ...
        a1 {
            ...
            inspektør.utbetalingstidslinjer(1.vedtaksperiode).inspektør.also { utbetalingstidslinjeInspektør ->
                ...
                assertEquals(
                    (31.januar til 28.februar).filterNot { it.erHelg() },
                    utbetalingstidslinjeInspektør.avvistedatoer
                )
                assertEquals(
                    Begrunnelse.MinimumInntekt,
                    utbetalingstidslinjeInspektør.begrunnelse(31.januar).single()
                )
                assertTrue((februar).filterNot { it.erHelg() }.all {
                    utbetalingstidslinjeInspektør.begrunnelse(it)
                        .single() == Begrunnelse.MinimumInntektOver67
                })
            }
            assertSisteTilstand(1.vedtaksperiode, TilstandType.AVVENTER_GODKJENNING)
