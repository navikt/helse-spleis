...
internal class AvvisningFørFylte18ÅrTest : AbstractEndToEndTest() {
    ...
    fun `avviser sykmeldinger for person under 18 år ved søknadstidspunkt`() {
        ...
        håndterSøknad(SendtSøknad.Søknadsperiode.Sykdom(1.oktober, 31.oktober, 100.prosent), sendtTilNav = 1.november, fnr = FYLLER_18_ÅR_2_NOVEMBER)
    ...
    fun `avviser ikke sykmeldinger for person som er 18 år ved søknadstidspunkt`() {
        ...
        håndterSøknad(SendtSøknad.Søknadsperiode.Sykdom(1.oktober, 31.oktober, 100.prosent), sendtTilNav = 2.november, fnr = FYLLER_18_ÅR_2_NOVEMBER)
