...
internal class RefusjonsopplysningerPåBehandlingE2ETest : AbstractDslTest() {
    ...
    fun `Refusjonsopplysningene strekker seg sammen med strekking av vedtaksperioden`() {
        a1 {
            ...
            håndterOverstyrTidslinje((1.januar til 9.januar).map {
    ...
    fun `korrigerte refusjonsopplysninger i AvventerVilkårsprøving`() {
        ...
        val imNy = håndterInntektsmelding(
            listOf(1.januar til 16.januar),
            INNTEKT,
        ...
        val forventetTidslinje =
            Beløpstidslinje.fra(1.januar til 27.januar, 500.daglig, kildeNy) + Beløpstidslinje.fra(
                28.januar til 31.januar,
                INGEN,
                kildeNy
            )
        assertEquals(
    ...
    fun `korrigerte refusjonsopplysninger i TilUtbetaling`() {
        ...
        val imGammel = håndterInntektsmelding(
            listOf(1.januar til 16.januar),
            INNTEKT,
        ...
        inspektør.behandlinger[1].also {
            val forventetTidslinje = Beløpstidslinje.fra(
                1.januar til 27.januar,
                500.daglig,
                kildeNy
    ...
    fun `korrigerte refusjonsopplysninger i AvventerRevurdering`() {
        ...
        inspektør.behandlinger[1].also {
            val forventetTidslinje =
                Beløpstidslinje.fra(1.mars til 27.mars, 500.daglig, kildeNy) + Beløpstidslinje.fra(
                    28.mars til 31.mars,
                    INGEN,
                    kildeNy
                )
    ...
    fun `Forlengelser bruker refusjonsopplysninger fra perioden før`() {
        a1 {
            ...
            val refusjonstidslinjeVedtaksperiode1 =
                inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.behandlinger.single().endringer.last().refusjonstidslinje
            val refusjonstidslinjeVedtaksperiode2 =
                inspektør.vedtaksperioder(2.vedtaksperiode).inspektør.behandlinger.single().endringer.last().refusjonstidslinje
    ...
    fun `Saksbehandler overstyrer refusjon`() {
        a1 {
            ...
            val refusjonstidslinje2 =
                inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.behandlinger.last().endringer.last().refusjonstidslinje
            val kildeSaksbehandler = Kilde(
    ...
    fun `Saksbehandler overstyrer refusjon på tidligere skjæringstidspunkt`() {
        a1 {
            ...
            val refusjonstidslinje1 =
                inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.behandlinger.last().endringer.last().refusjonstidslinje
            val refusjonstidslinje2 =
                inspektør.vedtaksperioder(2.vedtaksperiode).inspektør.behandlinger.last().endringer.last().refusjonstidslinje
            assertEquals(
                Beløpstidslinje.fra(januar, INGEN, kildeSaksbehandler),
                refusjonstidslinje1
            )
    ...
    fun `saksbehandler overstyrer litt ulik refusjon inn i en enkelt vedtaksperiode`() {
        a1 {
            ...
            val refusjonstidslinjeJanuar =
                inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.behandlinger.last().endringer.last().refusjonstidslinje
            val expected = Beløpstidslinje.fra(
    ...
    private fun gjenopprettBeløpstislinjeFor(dato: LocalDate) =
        dto().tilPersonData().arbeidsgivere.single().ubrukteRefusjonsopplysninger[dato]?.tilDto()
