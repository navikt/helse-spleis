...
internal class ForlengelseFraInfotrygdTest : AbstractEndToEndTest() {
    ...
    fun `forlenger ikke vedtaksperiode som har gått til infotrygd, der utbetaling ikke er gjort`() {
        ...
        håndterYtelser(
            2.vedtaksperiode, *arrayOf(historikk),
    ...
    fun `avdekker tilstøtende periode i Infotrygd uten at vi har Inntektsopplysninger`() {
        ...
        assertForkastetPeriodeTilstander(0, START, MOTTATT_SYKMELDING_FERDIG_GAP, AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK_FERDIG_GAP, AVVENTER_HISTORIKK, TIL_INFOTRYGD)
    }
    ...
    fun `setter forlengelse-flagget likt som forrige periode - forlengelse fra infotrygd`() {
        ...
        håndterYtelser(
            3.vedtaksperiode, *arrayOf(historikk),
            inntektshistorikk = listOf(
                Inntektsopplysning(
                    3.januar(2018),
                    INNTEKT,
    ...
    fun `Kort gap mot Infotrygd`() {
        ...
        håndterVilkårsgrunnlag(1.vedtaksperiode, INNTEKT)
        håndterYtelser(
            1.vedtaksperiode, *arrayOf(RefusjonTilArbeidsgiver(17.januar, 31.januar, 1000.daglig, 100.prosent, ORGNUMMER)),
            inntektshistorikk = listOf(
                Inntektsopplysning(
                    17.januar(2018),
                    1000.daglig,
    ...
    fun `ping-pong hvor infotrygd perioden slutter på maksdato skal ikke føre til en automatisk annullering`() {
        ...
        assertTilstander(2.vedtaksperiode, START, MOTTATT_SYKMELDING_FERDIG_GAP, AVVENTER_INNTEKTSMELDING_ELLER_HISTORIKK_FERDIG_GAP, AVVENTER_HISTORIKK, AVVENTER_GODKJENNING, AVSLUTTET)
