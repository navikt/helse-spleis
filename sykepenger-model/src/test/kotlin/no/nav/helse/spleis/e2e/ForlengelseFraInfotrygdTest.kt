...
internal class ForlengelseFraInfotrygdTest : AbstractEndToEndTest() {
    ...
    fun `forlengelsesperiode der refusjon opphører`() {
        ...
        håndterYtelser(
            ...
            inntektshistorikk = listOf(
                Utbetalingshistorikk.Inntektsopplysning(13.mars(2020), INNTEKT, ORGNUMMER, true, 31.mars(2020))
            )
        )
        assertForkastetPeriodeTilstander(0, START, MOTTATT_SYKMELDING_FERDIG_GAP, TIL_INFOTRYGD)
    ...
    fun `lager ikke ny arbeidsgiverperiode når det er tilstøtende historikk`() {
        ...
        håndterYtelser(0,
            ...
            inntektshistorikk = listOf(
                Utbetalingshistorikk.Inntektsopplysning(5.mars(2020), INNTEKT, ORGNUMMER, true)
            )
        )
        håndterVilkårsgrunnlag(0, INNTEKT)
        håndterYtelser(0,
        ...
        assertForkastetPeriodeTilstander(0, START, MOTTATT_SYKMELDING_FERDIG_GAP, AVSLUTTET_UTEN_UTBETALING, AVVENTER_VILKÅRSPRØVING_ARBEIDSGIVERSØKNAD, AVSLUTTET_UTEN_UTBETALING_MED_INNTEKTSMELDING)
