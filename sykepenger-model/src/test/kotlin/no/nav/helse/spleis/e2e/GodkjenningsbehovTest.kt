...
internal class GodkjenningsbehovTest : AbstractEndToEndTest() {
    private fun omregnedeÅrsinntedekter(
    ...
    fun `revurdering kan ikke avvises`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(a1, INNTEKT * 1.05, "forklaring", null, emptyList())),
        )
        håndterYtelser(1.vedtaksperiode)
        håndterSimulering(1.vedtaksperiode)
    ...
    private fun omregnedeÅrsinntekter(
        vedtaksperiode: IdInnhenter,
        orgnummer: String = a1,
    ) = hendelselogg
        .etterspurtBehov<List<Map<String, Any>>>(
