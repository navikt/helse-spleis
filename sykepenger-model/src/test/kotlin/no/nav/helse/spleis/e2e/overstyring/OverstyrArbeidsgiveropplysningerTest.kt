...
internal class OverstyrArbeidsgiveropplysningerTest : AbstractEndToEndTest() {
    ...
    fun `overstyrer inntekt og refusjon`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            ...
            listOf(
                OverstyrtArbeidsgiveropplysning(
                    ...
                    null,
                    listOf(Triple(1.januar, null, nyInntekt)),
                )
            ),
        ...
        inspektør.vilkårsgrunnlag(1.vedtaksperiode)?.inspektør?.also { vilkårsgrunnlag ->
            vilkårsgrunnlag.inntektsgrunnlag.inspektør.arbeidsgiverInntektsopplysninger.let {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            ...
            listOf(
                OverstyrtArbeidsgiveropplysning(
                    ...
                    "Det var jo alt for lite!",
                    null,
                    listOf(Triple(1.januar, null, nySaksbehandlerInntekt)),
                )
            ),
            meldingsreferanseId = overstyringId,
        )
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            ...
            listOf(
                OverstyrtArbeidsgiveropplysning(
                    ...
                    null,
                    listOf(Triple(1.mars, null, INNTEKT / 2)),
                )
            ),
            meldingsreferanseId = overstyringId,
        )
    ...
    fun `overstyrer refusjon på Infotrygdvilkårsgrunnlag`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            ...
            listOf(
                OverstyrtArbeidsgiveropplysning(
                    ...
                    null,
                    listOf(Triple(1.januar, null, gammelInntekt / 2)),
                )
            ),
            meldingsreferanseId = overstyringId,
        )
        ...
        assertLikeRefusjonsopplysninger(
            listOf(
                Refusjonsopplysning(overstyringId, 1.januar, null, gammelInntekt / 2, SAKSBEHANDLER)
            ),
            inspektør.refusjonsopplysningerISykepengegrunnlaget(1.januar),
        )
                ...
                arbeidsgiveropplysninger =
                    listOf(
                        OverstyrtArbeidsgiveropplysning(
                            ...
                            "noe",
                            null,
                            refusjonsopplysninger = listOf(Triple(1.januar, null, INNTEKT / 2)),
                        )
                    ),
            )
            håndterYtelser(1.vedtaksperiode)
    ...
    fun `overstyrer arbeidsgiveropplysninger på flere arbeidsgivere`() {
        ...
        val vilkårsgrunnlagHistorikkInnslagFørOverstyring =
            inspektør.vilkårsgrunnlagHistorikkInnslag().size
        val overstyringId = UUID.randomUUID()
        val a3RefusjonsopplysningerFørOverstyring =
            inspektør.refusjonsopplysningerISykepengegrunnlaget(1.januar, a3)
            ...
            arbeidsgiveropplysninger =
                listOf(
                    ...
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        subsumsjon = null,
                        refusjonsopplysninger =
                            listOf(Triple(1.januar, null, inntektPerArbeidsgiver * 1.25)),
                    ),
                    OverstyrtArbeidsgiveropplysning(
                        orgnummer = a3,
                        ...
                        subsumsjon = null,
                        refusjonsopplysninger =
                            listOf(Triple(1.januar, null, inntektPerArbeidsgiver)),
                    ),
                ),
        )
        ...
        assertEquals(
            vilkårsgrunnlagHistorikkInnslagFørOverstyring + 1,
            inspektør.vilkårsgrunnlagHistorikkInnslag().size,
        )
        ...
        // a2
        assertEquals(
            inntektPerArbeidsgiver * 1.25,
            inspektør.inntektISykepengegrunnlaget(1.januar, a2),
        )
        assertLikeRefusjonsopplysninger(
            listOf(
                Refusjonsopplysning(
        ...
        // a3
        assertEquals(
            inntektPerArbeidsgiver * 1.5,
            inspektør.inntektISykepengegrunnlaget(1.januar, a3),
        )
        assertEquals(
            a3RefusjonsopplysningerFørOverstyring,
            inspektør.refusjonsopplysningerISykepengegrunnlaget(1.januar, a3),
        )
    }
    ...
    fun `to arbeidsgivere uten endring`() {
        ...
        val a1ArbeidsgiverinntektsopplysningerFørOverstyring =
            inspektør.arbeidsgiverInntektsopplysningISykepengegrunnlaget(1.januar, a1)
        val a2ArbeidsgiverinntektsopplysningerFørOverstyring =
            inspektør.arbeidsgiverInntektsopplysningISykepengegrunnlaget(1.januar, a2)
        ...
        assertEquals(
            a1ArbeidsgiverinntektsopplysningerFørOverstyring,
            inspektør.arbeidsgiverInntektsopplysningISykepengegrunnlaget(1.januar, a1),
        )
        assertEquals(
            a2ArbeidsgiverinntektsopplysningerFørOverstyring,
            inspektør.arbeidsgiverInntektsopplysningISykepengegrunnlaget(1.januar, a2),
        )
    }
    ...
    fun `to arbeidsgivere kun refusjonsendring på den ene og endring av inntekt på andre`() {
        ...
        val refusjonsopplysningerFørOverstyringA1 =
            inspektør.refusjonsopplysningerISykepengegrunnlaget(1.januar, a1)
        val overstyringId = UUID.randomUUID()
        håndterOverstyrArbeidsgiveropplysninger(
            skjæringstidspunkt = 1.januar,
        ...
        assertEquals(
            inntektPerArbeidsgiver * 1.5,
            inspektør.inntektISykepengegrunnlaget(1.januar, a1),
        )
        assertEquals(inntektPerArbeidsgiver, inspektør.inntektISykepengegrunnlaget(1.januar, a2))
        assertEquals(
            refusjonsopplysningerFørOverstyringA1,
            inspektør.refusjonsopplysningerISykepengegrunnlaget(1.januar, a1),
        )
        assertLikeRefusjonsopplysninger(
            listOf(
    ...
    fun `flere arbeidsgivere får rett utbetaling etter nye opplysninger på begge arbeidsgivere`() {
        ...
        assertEquals(
            inspektør(a1).utbetaling(0).korrelasjonsId,
            inspektør(a1).sisteUtbetaling().korrelasjonsId,
        )
        assertEquals(
            inspektør(a2).utbetaling(0).korrelasjonsId,
            inspektør(a2).sisteUtbetaling().korrelasjonsId,
        )
            ...
            arbeidsgiveropplysninger =
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        subsumsjon = null,
                        refusjonsopplysninger = listOf(Triple(1.januar, null, nyInntekt)),
                    ),
                    OverstyrtArbeidsgiveropplysning(
                        orgnummer = a2,
                        inntekt = nyInntekt,
    ...
    fun `g`() {
        ...
        assertTrue(
            inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a1) is Inntektsmelding
        )
        assertTrue(inspektør.inntektsopplysningISykepengegrunnlaget(1.januar, a2) is Saksbehandler)
    }
            ...
            arbeidsgiveropplysninger =
                listOf(
                    OverstyrtArbeidsgiveropplysning(
                        ...
                        "endre refusjon",
                        null,
                        listOf(Triple(5.februar, null, INNTEKT)),
                    )
                ),
        )
        håndterYtelser(2.vedtaksperiode)
