...
internal class SøknadMedDagerUtenforPeriodeE2ETest : AbstractEndToEndTest() {
    ...
    fun `eldgammel ferieperiode før sykdomsperioden klippes bort`() {
        ...
        håndterSøknad(Sykdom(1.mars, 28.mars, 100.prosent), Ferie(1.juli(2015), 10.juli(2015)))
        assertEquals(
            null,
            inspektør
                .vedtaksperiodeSykdomstidslinje(1.vedtaksperiode)
                .inspektør
                .dagteller[Feriedag::class],
        )
    }
    ...
    fun `feriedager som vi allerede vet om fra forrige periode, trimme bort ferie, ingen warning`() {
        ...
        assertEquals(
            null,
            inspektør
                .vedtaksperiodeSykdomstidslinje(2.vedtaksperiode)
                .inspektør
                .dagteller[Feriedag::class],
        )
    }
