...
internal class RevurderingV2E2ETest : AbstractEndToEndTest() {
    ...
    fun `revurdere første to perioder`() {
        ...
        assertTilstander(1.vedtaksperiode, AVSLUTTET, AVVENTER_GJENNOMFØRT_REVURDERING, AVSLUTTET)
        assertTilstander(2.vedtaksperiode, AVSLUTTET, AVVENTER_GJENNOMFØRT_REVURDERING, AVVENTER_GJENNOMFØRT_REVURDERING, AVSLUTTET)
    ...
    fun `revurdere eldre skjæringstidspunkt mens nyere revurdert skjæringstidspunkt utbetales`() {
        ...
        assertTilstander(3.vedtaksperiode, AVVENTER_GJENNOMFØRT_REVURDERING, AVSLUTTET, AVVENTER_REVURDERING)
    ...
    @Test
    fun `avslår revurdering uten utbetaling`() {
        tilGodkjenning(1.januar, 31.januar, ORGNUMMER)
        håndterSøknad(Søknad.Søknadsperiode.Sykdom(17.januar, 31.januar, 100.prosent), Søknad.Søknadsperiode.Ferie(17.januar, 31.januar))
        håndterYtelser(1.vedtaksperiode)
        håndterUtbetalingsgodkjenning(1.vedtaksperiode)
