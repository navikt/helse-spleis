...
internal class RevurderingV2E2ETest : AbstractEndToEndTest() {
    ...
    fun `revurdere eldre skjæringstidspunkt mens nyere revurdert skjæringstidspunkt utbetales`() {
        ...
        inspektør.utbetaling(4).inspektør.also { revurdering ->
            ...
            assertEquals(16.januar til 20.januar, januar1utbetaling.periode)
            assertEquals(16.januar til 31.januar, januar2utbetaling.periode)
            assertEquals(16.januar til 28.februar, februarutbetaling.periode)
            assertEquals(16.januar til 31.mars, marsutbetaling.periode)
            assertEquals(16.januar til 31.mars, revurdering.periode)
            assertEquals(0, revurdering.personOppdrag.size)
