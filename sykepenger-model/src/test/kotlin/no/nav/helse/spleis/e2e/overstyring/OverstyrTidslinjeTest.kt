...
internal class OverstyrTidslinjeTest : AbstractEndToEndTest() {
    ...
    fun `Sendes ut overstyring i gangsatt når det er en periode som står i avventer inntektsmelding ved endring fra saksbehandler`() {
        ...
        håndterOverstyrTidslinje((1.februar til 14.februar).map {
    ...
    fun `overstyring av tidslinje i avventer inntektsmelding`() {
        ...
        håndterOverstyrTidslinje((20.februar til 24.februar).map {
            ManuellOverskrivingDag(
                it,
                Dagtype.Sykedag,
                100
        ...
        håndterOverstyrTidslinje((18.februar til 19.februar).map {
            ManuellOverskrivingDag(
                it,
                Dagtype.Sykedag,
                100
    ...
    fun `overstyre ferie til sykdom`() {
        ...
        val arbeidsgiverInntektsopplysning =
            sykepengegrunnlagInspektør.arbeidsgiverInntektsopplysningerPerArbeidsgiver.getValue(
                ORGNUMMER
            ).inspektør
    ...
    fun `overstyrt til fridager i midten av en periode blir ikke utbetalt`() {
        ...
        håndterOverstyrTidslinje(
            listOf(
                manuellFeriedag(22.januar),
                manuellPermisjonsdag(23.januar)
            )
        )
    ...
    fun `overstyring av egenmeldingsdager til arbeidsdager`() {
        ...
        håndterOverstyrTidslinje((20..26).map {
            ManuellOverskrivingDag(
                it.februar,
                Dagtype.Arbeidsdag
            )
