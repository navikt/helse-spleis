...
internal class InntektsmeldingE2ETest : AbstractDslTest() {
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding for perioder med arbeid`() {
        a1 {
            ...
            assertSkjæringstidspunktOgVenteperiode(1.vedtaksperiode, 1.januar, emptyList<Periode>())
            assertSkjæringstidspunktOgVenteperiode(2.vedtaksperiode, 17.januar, emptyList<Periode>())
    ...
    fun `periode i auu med egenmeldingsdager får inntektsmelding etter at vi har brukt skatteopplysninger`() {
        a1 {
            ...
            håndterPåminnelse(2.vedtaksperiode, tilstand = AVVENTER_INNTEKTSMELDING, flagg = setOf("ønskerInntektFraAOrdningen"))
            håndterVilkårsgrunnlag(2.vedtaksperiode)
    ...
    fun `periode i avsluttet med egenmeldingsdager får inntektsmelding etter at vi har brukt skatteopplysninger`() {
        a1 {
            ...
            håndterPåminnelse(1.vedtaksperiode, tilstand = AVVENTER_INNTEKTSMELDING, flagg = setOf("ønskerInntektFraAOrdningen"))
    ...
    fun `Bruker feil refusjonsopplysninger når arbeidsgiver fyller små hull & opplyser om opphør frem i tid`() {
        a1 {
            ...
            val im = håndterSelvbestemtArbeidsgiveropplysninger(listOf(12.mars(2025) til 27.mars(2025)), refusjon = Refusjon(INNTEKT, 13.april(2025)))
            val imKilde = Kilde(MeldingsreferanseId(im), ARBEIDSGIVER, MIN)
            håndterVilkårsgrunnlag(2.vedtaksperiode)
            håndterYtelser(2.vedtaksperiode)
            håndterSimulering(2.vedtaksperiode)
    ...
    fun `AI fjerner gammel IM - En beregnet omgjøring som treffes av tom bit fra inntektsmeldingen må reberegnes`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(listOf(21.november til 6.desember))
            håndterVilkårsgrunnlag(2.vedtaksperiode)
            håndterYtelser(2.vedtaksperiode)
            håndterSimulering(2.vedtaksperiode)
            håndterUtbetalingsgodkjenning(2.vedtaksperiode)
            ...
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(2.desember.somPeriode(), 4.desember til 18.desember), begrunnelseForReduksjonEllerIkkeUtbetalt = "TidligereVirksomhet")
    ...
    fun `En portalinntektsmelding uten inntekt (-1) bevarer inntekten som var`()  {
        ...
        a2 {
            forespurtIm = håndterArbeidsgiveropplysninger(emptyList(), beregnetInntekt = (-1).månedlig, refusjon = Refusjon(100.daglig, null), vedtaksperiodeId = 2.vedtaksperiode)
        ...
        a2 { assertTilstander(1.vedtaksperiode, AVSLUTTET) }
        a1 {
            håndterYtelser(2.vedtaksperiode)
            håndterSimulering(2.vedtaksperiode)
            håndterUtbetalingsgodkjenning(2.vedtaksperiode)
        ...
        a2 {
            ...
            håndterUtbetalingsgodkjenning(2.vedtaksperiode)
            håndterUtbetalt()
            assertTrue(observatør.inntektsmeldingHåndtert.contains(forespurtIm!! to 2.vedtaksperiode))
        }
    ...
    fun `portalinntektsmelding på forlengelse til en periode utenfor arbeidsgiverperioden, men bare i helg`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(listOf(4.januar til 19.januar), vedtaksperiodeId = 1.vedtaksperiode)
    ...
    @Test
    fun `AI fjerner gammel IM - altinn-inntektsmelding oppgir opphør av refusjon tilbake i tid i forhold til første fraværsdag`() {
        a1 {
    ...
    @Test
    fun `AI fjerner gammel IM - ingen søknad for halen av arbeidsgiverperiode`() {
        a1 {
    ...
    @Test
    fun `AI fjerner gammel IM - tom arbeidsgiverperiode og første fraværsdag dagen efter`() {
        a1 {
    ...
    fun `AI fjerner gammel IM - når arbeidsgiver feilaktig tror det er ny arbeidsgiverperiode må alle periodene få varsel`()  {
        a1 {
            ...
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(25.januar til 9.februar), vedtaksperiodeId = 2.vedtaksperiode)
            assertSisteTilstand(2.vedtaksperiode, AVVENTER_VILKÅRSPRØVING)
            assertSisteTilstand(3.vedtaksperiode, AVVENTER_BLOKKERENDE_PERIODE)
    ...
    fun `Håndterer ikke inntektsmelding fra portal`() {
        ...
        a2 {
            ...
            håndterArbeidsgiveropplysninger(listOf(1.januar til 16.januar), opphørAvNaturalytelser = listOf(Inntektsmelding.OpphørAvNaturalytelse(1000.månedlig, 1.januar, "BIL")), vedtaksperiodeId = 1.vedtaksperiode)
            assertSisteForkastetTilstand(1.vedtaksperiode, TIL_INFOTRYGD)
        }
        a1 { assertSisteTilstand(1.vedtaksperiode, AVSLUTTET) }
    }
    ...
    fun `Arbeidsgiver opplyser om feilaktig ny arbeidsgiverperiode som dekker hele perioden som skal utbetales`()  {
        a1 {
            ...
            håndterSelvbestemtArbeidsgiveropplysninger(arbeidsgiverperioder = listOf(25.januar til 9.februar), vedtaksperiodeId = 2.vedtaksperiode)
            assertSkjæringstidspunktOgVenteperiode(2.vedtaksperiode, 25.januar, listOf(1.januar til 16.januar))
            assertVarsler(2.vedtaksperiode, RV_IM_3, RV_AO_3)
        }
    }

    @Test
    fun `AI fjerner gammel IM - bestridelse av sykdom`() {
        a1 {
            håndterSøknad(Sykdom(1.januar, 10.januar, 100.prosent))
    ...
    fun `ulik arbeidsgiverperiode - flere arbeidsgivere`() {
        ...
        a2 { håndterSøknad(Sykdom(22.januar, 15.februar, 100.prosent)) }
        a1 {
            håndterArbeidsgiveropplysninger(
        ...
        a1 { assertEquals("UUGR AAAAAGG SSSSSHH SSSSSHH SSSSSHH SSSS", inspektør.sykdomshistorikk.sykdomstidslinje().toShortString()) }
        a2 { assertEquals("AAAAARR AAAAARR AAAAARR AAAA", inspektør.sykdomshistorikk.sykdomstidslinje().toShortString()) }
        ...
        a2 {
            ...
            håndterSykmelding(Sykmeldingsperiode(16.februar, 10.mars))
            håndterSøknad(Sykdom(16.februar, 10.mars, 100.prosent))
            håndterArbeidsgiveropplysninger(listOf(16.februar til 3.mars), beregnetInntekt = INNTEKT)
            assertEquals("AAAAARR AAAAARR AAAAARR AAAASHH SSSSSHH SSSSSHH SSSSSH", inspektør.sykdomshistorikk.sykdomstidslinje().toShortString())
        }
        a1 { assertSisteTilstand(1.vedtaksperiode, AVVENTER_VILKÅRSPRØVING) }
        a2 {
            assertSisteTilstand(1.vedtaksperiode, AVVENTER_AVSLUTTET_UTEN_UTBETALING)
        ...
        a2 { håndterPåminnelse(1.vedtaksperiode, AVVENTER_INNTEKTSMELDING) }
        a1 { assertSisteTilstand(1.vedtaksperiode, AVSLUTTET) }
        a2 {
            assertSisteTilstand(1.vedtaksperiode, AVSLUTTET_UTEN_UTBETALING)
    ...
    fun `dersom spleis regner arbeidsgiverperioden ulik fra arbeidsgiver lages warning - im først`() {
        a1 {
            håndterSykmelding(januar)
            håndterSøknad(januar)
            håndterArbeidsgiveropplysninger(listOf(Periode(1.januar, 15.januar)))
        }
    }

    @Test
    fun `AI fjerner gammel IM - dersom spleis regner arbeidsgiverperioden ulik fra arbeidsgiver lages warning - søknad først`() {
        a1 {
            håndterSykmelding(januar)
            håndterSøknad(januar)
            håndterArbeidsgiveropplysninger(listOf(Periode(2.januar, 15.januar)))
        }
    }
    ...
    @Test
    fun `AI fjerner gammel IM - Opphør i refusjon som ikke overlapper med senere periode fører ikke til at perioden forkastes`() {
        a1 {
            håndterSykmelding(Sykmeldingsperiode(1.november(2020), 20.november(2020)))
            håndterSøknad(Sykdom(1.november(2020), 20.november(2020), 100.prosent))
            håndterArbeidsgiveropplysninger(
            ...
            håndterArbeidsgiveropplysninger(
                emptyList(), //listOf(Periode(1.november(2020), 16.november(2020))),
                refusjon = Refusjon(INNTEKT, 6.desember(2020), emptyList())
            )
    ...
    @Test
    fun `AI fjerner gammel IM - En periode som opprinnelig var en forlengelse oppdager at den er en gap periode uten utbetaling ved inntektsmelding`() {
        a1 {
    ...
    @Test
    fun `AI fjerner gammel IM - korrigerer agp langt tilbake i tid`() {
        a1 {
            nyPeriode(5.januar til 16.januar)
            nyttVedtak(17.januar til 31.januar, arbeidsgiverperiode = listOf(5.januar til 20.januar))
            forlengVedtak(februar)
            forlengVedtak(mars)
            nyPeriode(10.april til 30.april)
            håndterSelvbestemtArbeidsgiveropplysninger(
                listOf(1.januar til 16.januar) // men hvis korrigert på #2, så bare varsel, ingen reberegning automatisk
            )
            assertNull(inspektør.vilkårsgrunnlag(5.januar))
            assertNull(inspektør.vilkårsgrunnlag(1.januar))
            håndterVilkårsgrunnlag(2.vedtaksperiode)
            assertNotNull(inspektør.vilkårsgrunnlag(1.januar))
            assertVarsler(5.vedtaksperiode, RV_AO_3)
            assertVarsler(2.vedtaksperiode, RV_IV_7)
        }
    }

    @Test
    fun `AI fjerner gammel IM - En periode som opprinnelig var en forlengelse oppdager at den er fortsatt en en forlengelse uten utbetaling ved inntektsmelding`() {
        a1 {
            håndterSykmelding(Sykmeldingsperiode(25.november(2020), 30.november(2020)))
            håndterSøknad(Sykdom(25.november(2020), 30.november(2020), 100.prosent))
    ...
    @Test
    fun `AI fjerner gammel IM - Inntektsmelding med error som treffer flere perioder`() {
        a1 {
    ...
    @Test
    fun `AI fjerner gammel IM - Inntektsmelding med error som treffer flere perioder uten gap`() {
        a1 {
            håndterSøknad(Sykdom(29.mars(2021), 31.mars(2021), 100.prosent))
    ...
    fun `Unngår aggresiv håndtering av arbeidsdager før opplyst AGP ved pågående revurdering`() {
        a1 {
            ...
            forlengVedtak(februar)
            forlengVedtak(mars)
            håndterOverstyrInntekt(skjæringstidspunkt = 1.januar, inntekt = INNTEKT + 500.månedlig)
            håndterYtelser(2.vedtaksperiode)
            ...
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(1.mars til 16.mars), vedtaksperiodeId = 1.vedtaksperiode)
    ...
    fun `Unngår aggressiv håndtering av arbeidsdager før opplyst AGP ved senere utbetalt periode på annen arbeidsgiver`() {
        a1 { nyPeriode(1.februar til 16.februar) }
        a2 { nyttVedtak(april) }
        nullstillTilstandsendringer()
        a1 {
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(16.januar til 31.januar), beregnetInntekt = INNTEKT)
            assertVarsel(RV_AO_3, 1.vedtaksperiode.filter())
    ...
    fun `inntektsmelding oppgir arbeidsgiverperiode senere`() {
        a1 {
            ...
            håndterArbeidsgiveropplysninger(listOf(8.januar til 23.januar), vedtaksperiodeId = 2.vedtaksperiode)
    ...
    @Test
    fun `AI fjerner gammel IM - Inntektsmelding kommer i feil rekkefølge - riktig inntektsmelding skal bli valgt i vilkårgrunnlaget`() {
        a1 {
            håndterSykmelding(januar)
            håndterSøknad(januar)
    ...
    @Test
    fun `AI fjerner gammel IM - Inntektsmelding treffer periode som dekker hele arbeidsgiverperioden`() {
        a1 {
            håndterSykmelding(Sykmeldingsperiode(28.oktober, 8.november))
            håndterSøknad(Sykdom(28.oktober, 8.november, 100.prosent))
            håndterSykmelding(Sykmeldingsperiode(9.november, 22.november))
    ...
    fun `vilkårsvurdering med flere arbeidsgivere skal ikke medføre at vi går til avventer historikk fra mottatt sykmelding ferdig forlengelse uten IM`() {
        ...
        a1 { assertTilstander(1.vedtaksperiode, AVVENTER_SIMULERING, AVVENTER_REFUSJONSOPPLYSNINGER_ANNEN_PERIODE) }
        a2 {
            assertTilstander(1.vedtaksperiode, AVSLUTTET_UTEN_UTBETALING)
    ...
    fun `inntektsmelding uten relevant inntekt (fordi perioden er i agp) flytter perioden til ferdig-tilstand`() {
        a1 {
            ...
            håndterSøknad(Sykdom(9.januar, 10.januar, 100.prosent))
    ...
    @Test
    fun `AI fjerner gammel IM - Ny inntektsmelding som treffer AvventerGodkjenning - hensyntar nye refusjonsopplysninger`() {
        a1 {
            håndterSykmelding(januar)
            håndterSøknad(januar)
            håndterArbeidsgiveropplysninger(
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding med oppgitt første fraværsdag treffer midt i en periode`() {
        a1 {
            håndterSykmelding(Sykmeldingsperiode(1.januar, 16.januar))
            håndterSøknad(Sykdom(1.januar, 16.januar, 100.prosent))
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding oppgir første fraværsdag i en periode med ferie etter sykdom med kort periode først`() {
        a1 {
            håndterSøknad(Sykdom(1.januar, 16.januar, 100.prosent))
            håndterSøknad(Sykdom(17.januar, 31.januar, 100.prosent))
            håndterArbeidsgiveropplysninger(listOf(1.januar til 16.januar))
    ...
    fun `Går videre fra AVVENTER_UFERDIG hvis en gammel periode er i AVSLUTTET_UTEN_UTBETALING`() {
        a1 {
            ...
            håndterSykmelding(Sykmeldingsperiode(1.mars, 31.mars))
            håndterSøknad(mars)
            håndterArbeidsgiveropplysninger(listOf(Periode(20.februar, 7.mars)))
    ...
    @Test
    fun `AI fjerner gammel IM - Inntektsmelding opplyser om endret arbeidsgiverperiode`() {
        a1 {
            ...
            // må sende selvbestemt .... ev . korrigerende men da blir det bare varsel, ikke faktisk endring.....

            assertEquals(1.januar, inspektør.skjæringstidspunkt(1.vedtaksperiode))
            Assertions.assertNull(inspektør.vilkårsgrunnlag(1.vedtaksperiode))
            håndterVilkårsgrunnlag(2.vedtaksperiode)
            Assertions.assertNull(inspektør.vilkårsgrunnlag(2.vedtaksperiode))
            håndterYtelser(2.vedtaksperiode)
    ...
    fun `Korrigerende inntektsmelding før søknad`() {
        a1 {
            nyPeriode(1.januar til 16.januar)
            assertSisteTilstand(1.vedtaksperiode, AVSLUTTET_UTEN_UTBETALING)
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(2.januar til 17.januar))
            håndterSelvbestemtArbeidsgiveropplysninger(listOf(1.januar til 16.januar))
    ...
    @Test
    fun `AI fjerner gammel IM - padding med arbeidsdager før arbeidsgiverperioden`() {
        a1 {
            ...
            assertVarsel(RV_IM_3, 1.vedtaksperiode.filter())
            assertSkjæringstidspunktOgVenteperiode(1.vedtaksperiode, 28.januar, listOf(28.januar til 12.februar))
            assertSkjæringstidspunktOgVenteperiode(2.vedtaksperiode, 28.februar, listOf(28.januar til 12.februar))
            assertSisteTilstand(1.vedtaksperiode, AVVENTER_VILKÅRSPRØVING)
            assertSisteTilstand(2.vedtaksperiode, AVVENTER_INNTEKTSMELDING)
            assertSisteTilstand(3.vedtaksperiode, AVVENTER_INNTEKTSMELDING)
    ...
    fun `arbeidsgiveperiode i forkant av vedtaksperiode med en dags gap`() {
        a1 {
            ...
            assertEquals(1, inspektør.inntektInspektør.size)
            assertIngenInfo("Inntektsmelding ikke håndtert", AktivitetsloggFilter.Alle)
        }
    }
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding korrigerer periode til godkjenning`() {
        a1 {
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding korrigerer periode til godkjenning - starter før perioden`() {
        a1 {
            tilGodkjenning(2.januar til 31.januar, beregnetInntekt = INNTEKT)
            nullstillTilstandsendringer()
            håndterKorrigerteArbeidsgiveropplysninger(
                listOf(
    ...
    @Test
    fun `AI fjerner gammel IM - inntektsmelding korrigerer periode til godkjenning revurdering`() {
        a1 {
    ...
    fun `Skal lagre inntekt fra inntektsmelding på datoen som er oppgitt av inntektsdato-feltet`() {
        a1 { nyPeriode(25.januar til 25.februar) }
        a2 { nyPeriode(1.februar til 25.februar) }
        a1 {
            håndterArbeidsgiveropplysninger(
        ...
        a2 {
            håndterArbeidsgiveropplysninger(
                listOf(1.februar til 16.februar),
                beregnetInntekt = INNTEKT, //(-1).månedlig, //INNTEKT, /// revert ?
                vedtaksperiodeId = 1.vedtaksperiode
            )
        }
        a1 {
