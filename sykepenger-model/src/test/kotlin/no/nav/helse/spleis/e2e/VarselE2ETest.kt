...
internal class VarselE2ETest : AbstractEndToEndTest() {
    ...
    fun `varsel - skjæringstidspunkt endres som følge av historikk fra IT`() {
        ...
        håndterUtbetalingshistorikkEtterInfotrygdendring(
            ArbeidsgiverUtbetalingsperiode(ORGNUMMER, 1.januar, 9.januar, 100.prosent, INNTEKT), inntektshistorikk = listOf(
    ...
    fun `varsel - skjæringstidspunkt endres som følge av historikk fra IT - forlengelse`() {
        ...
        håndterSøknad(mars)
        håndterUtbetalingshistorikkEtterInfotrygdendring(
            ArbeidsgiverUtbetalingsperiode(ORGNUMMER, 5.februar, 11.februar, 100.prosent, INNTEKT), inntektshistorikk = listOf(
