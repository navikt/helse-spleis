...
internal class FeriepengeE2ETest : AbstractEndToEndTest() {
    ...
    fun `Utbetaling av feriepenger sender behov til oppdrag`() {
        ...
        val linje =
            (
                person.personLogg.behov
                    .last()
                    .detaljer()["linjer"] as ArrayList<LinkedHashMap<String, String>>
            ).first()
    ...
    fun `reberegning av feriepenger med endringer`() {
        ...
        håndterUtbetalingshistorikkForFeriepenger(
            ...
            feriepengehistorikk =
                listOf(
                    UtbetalingshistorikkForFeriepenger.Feriepenger(ORGNUMMER, (10 * 690 * 0.102).roundToInt(), 1.mai, 31.mai),
                ),
            opptjeningsår = Year.of(2020),
        )
    ...
    private fun engangsutbetalinger() =
        person.personLogg.behov
            ...
            .filter { utbetaling ->
                utbetaling.detaljer()["linjer"].castAsList<Map<String, Any>>().any { linje -> linje["satstype"] == "ENG" }
            }
