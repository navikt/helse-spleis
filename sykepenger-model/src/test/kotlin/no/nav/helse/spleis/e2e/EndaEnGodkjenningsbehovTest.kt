...
internal class EndaEnGodkjenningsbehovTest : AbstractEndToEndTest() {
    private fun IdInnhenter.sisteBehandlingId(orgnr: String) =
        inspektør(orgnr).vedtaksperioder(this).inspektør.behandlinger.last().id
        ...
        assertGodkjenningsbehov(
            ...
            perioderMedSammeSkjæringstidspunkt =
                listOf(
                    mapOf(
                        ...
                        "behandlingId" to 1.vedtaksperiode.sisteBehandlingId(a1).toString(),
                        "fom" to 1.januar.toString(),
                        "tom" to 31.januar.toString(),
                    ),
                    mapOf(
                        "vedtaksperiodeId" to 1.vedtaksperiode.id(a2).toString(),
                        "behandlingId" to 1.vedtaksperiode.sisteBehandlingId(a2).toString(),
                        "fom" to 1.januar.toString(),
                        "tom" to 31.januar.toString(),
                    ),
                    mapOf(
                        ...
                        "fom" to 1.februar.toString(),
                        "tom" to 10.februar.toString(),
                    ),
                    mapOf(
                        "vedtaksperiodeId" to 2.vedtaksperiode.id(a2).toString(),
                        "behandlingId" to 2.vedtaksperiode.sisteBehandlingId(a2).toString(),
                        "fom" to 1.februar.toString(),
                        "tom" to 10.februar.toString(),
                    ),
                ),
            sykepengegrunnlagsfakta =
                mapOf(
                    ...
                    "arbeidsgivere" to
                        listOf(
                            mapOf("arbeidsgiver" to a1, "omregnetÅrsinntekt" to 240000.0),
                            mapOf("arbeidsgiver" to a2, "omregnetÅrsinntekt" to 240000.0),
                        ),
                ),
        )
    }
    ...
    fun arbeidsgiverutbetaling() {
        ...
        assertGodkjenningsbehov(
            tags = setOf("Arbeidsgiverutbetaling"),
            omregnedeÅrsinntekter =
                listOf(mapOf("organisasjonsnummer" to a1, "beløp" to 240_000.0)),
            sykepengegrunnlagsfakta =
                mapOf(
                    ...
                    "fastsatt" to "EtterHovedregel",
                    "arbeidsgivere" to
                        listOf(mapOf("arbeidsgiver" to a1, "omregnetÅrsinntekt" to 240_000.0)),
                ),
        )
    }
    ...
    fun ferie() {
        håndterSøknad(
            ...
            Søknad.Søknadsperiode.Ferie(31.januar, 31.januar),
        )
    ...
    fun `6G-begrenset`() {
        ...
        assertGodkjenningsbehov(
            ...
            omregnedeÅrsinntekter =
                listOf(mapOf("organisasjonsnummer" to a1, "beløp" to 1_200_000.0)),
            sykepengegrunnlagsfakta =
                mapOf(
                    ...
                    "fastsatt" to "EtterHovedregel",
                    "arbeidsgivere" to
                        listOf(mapOf("arbeidsgiver" to a1, "omregnetÅrsinntekt" to 1200000.0)),
                ),
        )
    }
    ...
    fun `ingen ny arbeidsgiverperiode og sykepengegrunnlag under 2g`() {
        ...
        assertGodkjenningsbehov(
            ...
            vedtaksperiodeId = 2.vedtaksperiode.id(a1),
            omregnedeÅrsinntekter =
                listOf(mapOf("organisasjonsnummer" to a1, "beløp" to 10000.månedlig.årlig)),
            behandlingId =
                inspektør.vedtaksperioder(2.vedtaksperiode).inspektør.behandlinger.last().id,
            ...
            sykepengegrunnlagsfakta =
                mapOf(
                    ...
                    "fastsatt" to "EtterHovedregel",
                    "arbeidsgivere" to
                        listOf(mapOf("arbeidsgiver" to a1, "omregnetÅrsinntekt" to 120000.0)),
                ),
        )
    }
    ...
    fun `Sender med tag IngenNyArbeidsgiverperiode når det ikke er ny AGP pga AIG-dager`() {
        ...
        håndterOverstyrTidslinje(
            (juli).map { ManuellOverskrivingDag(it, Dagtype.ArbeidIkkeGjenopptattDag) }
        )
        håndterYtelser(2.vedtaksperiode)
        håndterSimulering(2.vedtaksperiode)
    ...
    fun `Sender med tag IngenNyArbeidsgiverperiode når det ikke er ny AGP pga mindre enn 16 dagers gap selv om AGP er betalt av nav`() {
        ...
        assertEquals(
            "NNNNNHH NNNNNHH NNSSSHH SSSSSHH SSS???? ??????? ????SHH SSSSSHH SSS",
    ...
    fun `Sender ikke med tag IngenNyArbeidsgiverperiode når det ikke er ny AGP pga Infotrygforlengelse`() {
        ...
        assertSykepengegrunnlagsfakta(
            sykepengegrunnlagsfakta =
                mapOf("omregnetÅrsinntektTotalt" to INNTEKT.årlig, "fastsatt" to "IInfotrygd"),
            vedtaksperiodeId = 2.vedtaksperiode.id(a1),
        )
    }
        ...
        assertGodkjenningsbehov(
            ...
            sykepengegrunnlagsfakta =
                mapOf(
                    ...
                    "fastsatt" to "EtterHovedregel",
                    "arbeidsgivere" to
                        listOf(mapOf("arbeidsgiver" to a1, "omregnetÅrsinntekt" to INNTEKT.årlig)),
                ),
        )
    }
    ...
    fun `trekker tilbake penger fra arbeidsgiver og flytter til bruker`() {
        ...
        håndterSimulering(1.vedtaksperiode)
        assertGodkjenningsbehov(
            tags = setOf("NegativArbeidsgiverutbetaling", "Personutbetaling"),
            kanAvvises = false,
    ...
    fun `trekker tilbake penger fra person og flytter til arbeidsgiver`() {
        ...
        håndterSimulering(1.vedtaksperiode)
        assertGodkjenningsbehov(
            tags = setOf("NegativPersonutbetaling", "Arbeidsgiverutbetaling"),
            kanAvvises = false,
            utbetalingstype = "REVURDERING",
        )
    }
    ...
    fun `Periode med minst én navdag får Innvilget-tag`() {
        ...
        assertGodkjenningsbehov(
            tags = setOf("Innvilget", "Arbeidsgiverutbetaling", "EnArbeidsgiver")
        )
    }
    ...
    fun `Periode uten noen navdager får Avslag-tag`() {
        ...
        assertForventetFeil(
            ...
            nå = { assertTilstand(1.vedtaksperiode, TilstandType.AVSLUTTET_UTEN_UTBETALING) },
        )
    }
    ...
    fun `Periode med minst én navdag og minst én avslagsdag får DelvisInnvilget-tag`() {
        ...
        tilGodkjenning(januar, a1, beregnetInntekt = INNTEKT)
        assertGodkjenningsbehov(
            tags = setOf("DelvisInnvilget", "Arbeidsgiverutbetaling", "EnArbeidsgiver")
        )
    }
    ...
    fun `Periode uten navdager og avslagsdager får Avslag-tag`() {
        ...
        assertGodkjenningsbehov(
            ...
            perioderMedSammeSkjæringstidspunkt =
                listOf(
                    mapOf(
                        "vedtaksperiodeId" to 1.vedtaksperiode.id(ORGNUMMER).toString(),
                        "behandlingId" to 1.vedtaksperiode.sisteBehandlingId(ORGNUMMER).toString(),
                        "fom" to 1.januar.toString(),
                        "tom" to 31.januar.toString(),
                    ),
                    mapOf(
                        "vedtaksperiodeId" to 2.vedtaksperiode.id(ORGNUMMER).toString(),
                        "behandlingId" to 2.vedtaksperiode.sisteBehandlingId(ORGNUMMER).toString(),
                        "fom" to 1.februar.toString(),
                        "tom" to 28.februar.toString(),
                    ),
                ),
    ...
    fun `legger til førstegangsbehandling eller forlengelse som tag`() {
        tilGodkjenning(januar, a1, beregnetInntekt = INNTEKT)
        assertGodkjenningsbehov(tags = setOf("Førstegangsbehandling"))
        håndterUtbetalingsgodkjenning(1.vedtaksperiode)
        håndterUtbetalt()
        forlengTilGodkjenning(februar)
        assertGodkjenningsbehov(
    ...
    private fun assertTags(tags: Set<String>, vedtaksperiodeId: UUID = 1.vedtaksperiode.id(a1)) {
        val actualtags =
            hentFelt<Set<String>>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "tags")
                ?: emptySet()
    ...
    private fun assertSykepengegrunnlagsfakta(
        ...
        val actualSykepengegrunnlagsfakta =
            hentFelt<Any>(
                ...
                feltNavn = "sykepengegrunnlagsfakta",
            )!!
    ...
    private fun assertHendelser(hendelser: Set<UUID>, vedtaksperiodeId: UUID) {
        val actualHendelser =
            hentFelt<Set<UUID>>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "hendelser")!!
    ...
    private fun assertGodkjenningsbehov(
        ...
        omregnedeÅrsinntekter: List<Map<String, Any>> =
            listOf(mapOf("organisasjonsnummer" to a1, "beløp" to INNTEKT.årlig)),
        behandlingId: UUID =
            inspektør.vedtaksperioder(1.vedtaksperiode).inspektør.behandlinger.last().id,
        perioderMedSammeSkjæringstidspunkt: List<Map<String, String>> =
            listOf(
                mapOf(
                    "vedtaksperiodeId" to 1.vedtaksperiode.id(a1).toString(),
                    "behandlingId" to 1.vedtaksperiode.sisteBehandlingId(a1).toString(),
        ...
        val actualtags =
            hentFelt<Set<String>>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "tags")
                ?: emptySet()
        val actualSkjæringstidspunkt =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "skjæringstidspunkt")!!
        val actualInntektskilde =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "inntektskilde")!!
        val actualPeriodetype =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "periodetype")!!
        val actualPeriodeFom =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "periodeFom")!!
        val actualPeriodeTom =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "periodeTom")!!
        val actualFørstegangsbehandling =
            hentFelt<Boolean>(
                vedtaksperiodeId = vedtaksperiodeId,
                feltNavn = "førstegangsbehandling",
            )!!
        val actualUtbetalingtype =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "utbetalingtype")!!
        val actualOrgnummereMedRelevanteArbeidsforhold =
            hentFelt<Set<String>>(
                vedtaksperiodeId = vedtaksperiodeId,
                feltNavn = "orgnummereMedRelevanteArbeidsforhold",
            )!!
        val actualKanAvises =
            hentFelt<Boolean>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "kanAvvises")!!
        val actualOmregnedeÅrsinntekter =
            hentFelt<List<Map<String, String>>>(
                vedtaksperiodeId = vedtaksperiodeId,
                feltNavn = "omregnedeÅrsinntekter",
            )!!
        val actualBehandlingId =
            hentFelt<String>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "behandlingId")!!
        val actualPerioderMedSammeSkjæringstidspunkt =
            hentFelt<Any>(
                vedtaksperiodeId = vedtaksperiodeId,
                feltNavn = "perioderMedSammeSkjæringstidspunkt",
            )!!
    ...
    private inline fun <reified T> hentFelt(
        vedtaksperiodeId: UUID = 1.vedtaksperiode.id(a1),
        feltNavn: String,
    ) =
