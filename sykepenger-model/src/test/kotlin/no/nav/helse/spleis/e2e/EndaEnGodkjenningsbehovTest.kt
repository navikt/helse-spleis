...
internal class EndaEnGodkjenningsbehovTest : AbstractEndToEndTest() {
    ...
    fun `Sender med tag IngenNyArbeidsgiverperiode når det ikke er ny AGP pga AIG-dager`() {
        ...
        håndterOverstyrTidslinje((juli).map {
    ...
    private fun assertSykepengegrunnlagsfakta(
        ...
        val actualSykepengegrunnlagsfakta = hentFelt<Any>(
    ...
    private fun assertGodkjenningsbehov(
        ...
        omregnedeÅrsinntekter: List<Map<String, Any>> = listOf(
            mapOf(
                "organisasjonsnummer" to a1,
                "beløp" to INNTEKT.årlig
            )
        ),
        ...
        val actualFørstegangsbehandling = hentFelt<Boolean>(
            vedtaksperiodeId = vedtaksperiodeId,
        ...
        val actualOrgnummereMedRelevanteArbeidsforhold = hentFelt<Set<String>>(
            vedtaksperiodeId = vedtaksperiodeId,
            feltNavn = "orgnummereMedRelevanteArbeidsforhold"
        )!!
        val actualKanAvises =
            hentFelt<Boolean>(vedtaksperiodeId = vedtaksperiodeId, feltNavn = "kanAvvises")!!
        val actualOmregnedeÅrsinntekter = hentFelt<List<Map<String, String>>>(
            vedtaksperiodeId = vedtaksperiodeId,
        ...
        val actualPerioderMedSammeSkjæringstidspunkt = hentFelt<Any>(
            vedtaksperiodeId = vedtaksperiodeId,
