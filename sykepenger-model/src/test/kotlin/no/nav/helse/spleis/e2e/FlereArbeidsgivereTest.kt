...
internal class FlereArbeidsgivereTest : AbstractDslTest() {
    ...
    fun `Sammenligningsgrunnlag for flere arbeidsgivere`() {
        ...
        a1 { assertEquals(318500.årlig, inspektør.vilkårsgrunnlag(1.vedtaksperiode)?.inspektør?.sammenligningsgrunnlag) }
    }
    ...
    fun `Sammenligningsgrunnlag for flere arbeidsgivere med flere sykeperioder`() {
        a1 {
            ...
            assertEquals(282500.årlig, inspektør.vilkårsgrunnlag(1.vedtaksperiode)?.inspektør?.sammenligningsgrunnlag)
        }
    }
    ...
    fun `Burde ikke kunne opprette vedtaksperiode før utbetalt periode ved flere AG`() {
        ...
        assertForventetFeil(
            ...
            nå = {
                assertFalse(a1.inspektør.periodeErForkastet(1.vedtaksperiode(a1)))
            },
            ønsket = {
