...
internal class OverstyrInntektTest : AbstractEndToEndTest() {
    ...
    fun `skal kunne overstyre en inntekt i et enkelt case`() {
        // Hva gjør vi egentlig med overstyring? Skal man kunne sette opp inntekten uten å ha
        // mottatt en ny inntektsmelding med nye refusjonsopplysninger?
    ...
    fun `overstyre ghostinntekt`() {
        ...
        val a2Opplysninger =
            sykepengegrunnlagInspektør
                ?.arbeidsgiverInntektsopplysningerPerArbeidsgiver
                ?.get(a2)
                ?.inspektør ?: fail { "må ha inntekt for a2" }
        ...
        val overstyrtInntekt =
            a2Opplysninger.inntektsopplysning.inspektør.forrigeInntekt
