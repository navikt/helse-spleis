...
internal class RevurderingInntektV2E2ETest : AbstractDslTest() {
    ...
    fun `revurdere enslig periode`() {
        a1 {
            ...
            håndterOverstyrInntekt(skjæringstidspunkt = 1.januar, inntekt = overstyrtInntekt)
    ...
    fun `Ved overstyring av revurdering av inntekt til under krav til minste sykepengegrunnlag skal vi opphøre den opprinnelige utbetalingen`() {
        a1 {
            ...
            håndterOverstyrInntekt(skjæringstidspunkt = 1.januar, inntekt = 46000.årlig)
            håndterYtelser(1.vedtaksperiode)
            håndterSimulering(1.vedtaksperiode)
    ...
    fun `revurder inntekt tidligere skjæringstidspunkt - med samme AGP`() {
        a1 {
            nyttVedtak(januar, 100.prosent)
            nyttVedtak(2.februar til 28.februar, 100.prosent, arbeidsgiverperiode = emptyList())
            nullstillTilstandsendringer()
    ...
    fun `revurder inntekt til under krav til minste sykepengegrunnlag slik at utbetaling opphører, og så revurder igjen til over krav til minste sykepengegrunnlag`() {
        a1 {
            ...
            nullstillTilstandsendringer()
            håndterOverstyrInntekt(inntekt = 3000.månedlig, skjæringstidspunkt = 1.januar)
            håndterSkjønnsmessigFastsettelse(skjæringstidspunkt = 1.januar, arbeidsgiveropplysninger = listOf(OverstyrtArbeidsgiveropplysning(a1, 3000.månedlig)))
            håndterYtelser(1.vedtaksperiode)
            håndterSimulering(1.vedtaksperiode)
            ...
            håndterOverstyrInntekt(skjæringstidspunkt = 1.januar, inntekt = 5000.månedlig)
            håndterYtelser(1.vedtaksperiode)
    ...
    fun `revurdere mens en periode er til utbetaling`() {
        a1 {
            ...
            assertNull(observatør.avsluttetMedVedtakEvent[2.vedtaksperiode])
            håndterUtbetalt()
