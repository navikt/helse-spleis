...
internal class SubsumsjonE2ETest : AbstractEndToEndTest() {
    ...
    fun `subsummerer ikke inntektsspesfikke subsumsjoner ved overstyring som ikke fører til endrede inntekter i sykpengegrunnlaget`() {
        ...
        assertEquals(
            1,
            SubsumsjonInspektør(jurist)
                .antallSubsumsjoner(paragraf = PARAGRAF_8_29, versjon = 1.januar(2019)),
        )
    ...
    fun `§ 8-3 ledd 1 punktum 2 - fyller 70`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertOppfylt(
                ...
                output = mapOf("avvisteDager" to emptyList<Periode>()),
            )
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeOppfylt(
                ...
                output = mapOf("avvisteDager" to listOf(20.januar til 31.januar)),
            )
    }
    ...
    fun `§ 8-3 ledd 1 punktum 2 - er alltid 70`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeOppfylt(
                ...
                output = mapOf("avvisteDager" to listOf(17.januar til 31.januar)),
            )
    }
    ...
    fun `§ 8-3 ledd 1 punktum 2 - er alltid 70 uten NAVdager`() {
        ...
        assertForventetFeil(
            forklaring =
                "Perioden avsluttes automatisk -- usikker på hva vi ønsker av etterlevelse da",
            nå = {
    ...
    fun `§ 8-9 ledd 1 - ikke vurdert dersom det ikke er oppgitt utenlandsopphold`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeVurdert(paragraf = PARAGRAF_8_9, versjon = 1.juni(2021), ledd = LEDD_1)
    }
            ...
            .assertIkkeOppfylt(
                ...
                input =
                    mapOf(
                        "soknadsPerioder" to
                            listOf(
                                mapOf("fom" to 1.januar, "tom" to 31.januar, "type" to "sykdom"),
                                mapOf(
                                    "fom" to 20.januar,
                                    "tom" to 31.januar,
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 20.januar, "tom" to 31.januar))),
            )
    }
            ...
            .assertIkkeOppfylt(
                ...
                output =
                    mapOf(
                        "perioder" to
                            listOf(
                                mapOf("fom" to 15.januar, "tom" to 17.januar),
                                mapOf("fom" to 20.januar, "tom" to 31.januar),
                            )
                    ),
            )
    }
                    ...
                    mapOf(
                        "soknadsPerioder" to
                            listOf(
                                ...
                                mapOf("fom" to 20.januar, "tom" to 31.januar, "type" to "ferie"),
                            )
                    ),
                output = mapOf("perioder" to listOf(mapOf("fom" to 20.januar, "tom" to 31.januar))),
            )
    ...
    fun `§ 8-10 ledd 2 punktum 1 - inntekt overstiger ikke maksimum sykepengegrunnlag`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                output = mapOf("erBegrenset" to false),
            )
    }
    ...
    fun `§ 8-10 ledd 2 punktum 1 - inntekt overstiger maksimum sykepengegrunnlag`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                output = mapOf("erBegrenset" to true),
            )
    }
    ...
    fun `§ 8-11 ledd 1 - yter ikke sykepenger i helgedager`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeOppfylt(
                ...
                input = mapOf("periode" to mapOf("fom" to 1.januar, "tom" to 31.januar)),
                output =
                    mapOf(
                        "perioder" to
                            listOf(
    ...
    fun `§ 8-13 ledd 1 - Sykmeldte har 20 prosent uføregrad`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertOppfylt(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 1.januar, "tom" to 31.januar))),
            )
    }
    ...
    fun `§ 8-13 ledd 1 - Sykmeldte har under 20 prosent uføregrad`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeOppfylt(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 17.januar, "tom" to 31.januar))),
            )
    }
    ...
    fun `§ 8-13 ledd 2 - Sykmeldte har 20 prosent uføregrad`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                output =
                    mapOf(
                        "perioder" to listOf(mapOf("fom" to 1.januar, "tom" to 31.januar)),
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                output =
                    mapOf(
                        "perioder" to listOf(mapOf("fom" to 1.januar, "tom" to 31.januar)),
                        "dagerUnderGrensen" to listOf(mapOf("fom" to 1.januar, "tom" to 31.januar)),
                    ),
            )
    }
    ...
    fun `§ 8-16 ledd 1 - dekningsgrad`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                ledd = 1.ledd,
                versjon = FOLKETRYGDLOVENS_OPPRINNELSESDATO,
                input = mapOf("dekningsgrad" to 1.0, "inntekt" to 372000.0),
                output =
                    mapOf(
    ...
    fun `§ 8-17 ledd 1 bokstav a - trygden yter sykepenger ved utløp av arbeidsgiverperioden`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertPaaIndeks(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 17.januar, "tom" to 17.januar))),
                utfall = VILKAR_OPPFYLT,
            )
        SubsumsjonInspektør(jurist)
            .assertPaaIndeks(
    ...
    fun `§ 8-17 ledd 1 bokstav a - trygden yter sykepenger dersom arbeidsgiverperioden avslutter på en fredag`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertPaaIndeks(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 22.januar, "tom" to 22.januar))),
                utfall = VILKAR_OPPFYLT,
            )
        SubsumsjonInspektør(jurist)
            .assertPaaIndeks(
    ...
    fun `§ 8-17 ledd 1 bokstav a - trygden yter ikke sykepenger dersom arbeidsgiverperioden ikke er påstartet`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertFlereIkkeOppfylt(
                ...
                bokstav = BOKSTAV_A,
                versjon = 1.januar(2018),
                input = mapOf("sykdomstidslinje" to emptyList<Any>()),
    ...
    fun `§ 8-17 ledd 2 - trygden yter ikke sykepenger for feriedager og permisjonsdager`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertIkkeOppfylt(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 30.januar, "tom" to 31.januar))),
            )
    }
    ...
    fun `§ 8-19 første ledd - arbeidsgiverperioden varer i 16 dager`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertPaaIndeks(
                ...
                output = mapOf("sisteDagIArbeidsgiverperioden" to 19.januar),
    ...
    fun `§ 8-19 fjerde ledd - ny agp etter tilstrekkelig opphold`() {
        ...
        SubsumsjonInspektør(jurist).apply {
            assertPaaIndeks(
                ...
                output = mapOf("perioder" to listOf(mapOf("fom" to 2.februar, "tom" to 2.februar))),
                vedtaksperiodeId = 1.vedtaksperiode,
                utfall = Utfall.VILKAR_BEREGNET,
            )
            assertPaaIndeks(
                ...
                input =
                    mapOf(
                        ...
                        "overstyrtInntektFraSaksbehandler" to
                            mapOf("dato" to 1.januar, "beløp" to 1500.0),
    ...
    fun `§ 8-29 - filter for inntekter som skal medregnes ved beregning av sykepengegrunnlaget for arbeidsforhold hvor sykdom ikke starter på skjæringstidspunktet`() {
        ...
        SubsumsjonInspektør(jurist)
            .assertBeregnet(
                ...
                output = mapOf("grunnlagForSykepengegrunnlag" to 384000.0),
            )
    }
    ...
    fun `§ 8-51 ledd 2 - avslag subsummeres når person blir 67 år underveis i sykefraværstilfellet og tjener mindre enn 2G`() {
        ...
        val inntekt =
            100_000
                .årlig // mellom 0.5G og 2G - slik at kravet er oppfyllt før personen fyllte 67, men
                       // ikke etter
            ...
            .assertIkkeOppfylt(
                ...
                output =
                    mapOf(
                        "perioder" to
                            listOf(
                                mapOf("fom" to 15.januar, "tom" to 19.januar),
                                mapOf("fom" to 22.januar, "tom" to 26.januar),
                                mapOf("fom" to 29.januar, "tom" to 31.januar),
                            )
                    ),
                vedtaksperiodeId = 1.vedtaksperiode,
            )
