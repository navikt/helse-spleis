...
internal class SubsumsjonE2ETest : AbstractEndToEndTest() {
    ...
    fun `subsummerer ikke inntektsspesfikke subsumsjoner ved overstyring som ikke fører til endrede inntekter i sykpengegrunnlaget`() {
        ...
        assertEquals(
            ...
            SubsumsjonInspektør(
                jurist,
            ).antallSubsumsjoner(paragraf = PARAGRAF_8_28, ledd = LEDD_3, bokstav = BOKSTAV_A, versjon = 1.januar(2019)),
        )
        ...
        assertEquals(
            ...
            SubsumsjonInspektør(
                jurist,
            ).antallSubsumsjoner(paragraf = PARAGRAF_8_28, ledd = LEDD_3, bokstav = BOKSTAV_B, versjon = 1.januar(2019)),
        )
