...
internal class DobbelbehandlingIInfotrygdTest : AbstractEndToEndTest() {
    ...
    fun `avdekker overlapp dobbelbehandlinger i Infotrygd`() {
        ...
        val historie1 = Utbetalingsperiode(ORGNUMMER, 3.januar,  26.januar, 100.prosent, 1000.daglig)
        ...
        val historie2 = Utbetalingsperiode(ORGNUMMER, 26.februar,  26.mars, 100.prosent, 1000.daglig)
        ...
        val historie3 = Utbetalingsperiode(ORGNUMMER, 1.april,  1.mai, 100.prosent, 1000.daglig)
    ...
    fun `utbetalt i Infotrygd`() {
        ...
        håndterUtbetalingshistorikk(1.vedtaksperiode,
            Utbetalingsperiode(ORGNUMMER, 5.desember(2020),  23.desember(2020), 100.prosent, 1000.daglig),
            Utbetalingsperiode(ORGNUMMER, 1.januar(2021),  3.januar(2021), 100.prosent, 1000.daglig),
            Friperiode(24.desember(2020),  31.desember(2020)),
            Utbetalingsperiode("456789123", 29.oktober(2020),  4.desember(2020), 100.prosent, 1000.daglig),
    ...
    fun `utbetalt i infotrygd mens vi venter på inntektsmelding - oppdaget i AVVENTER_HISTORIKK`() {
        ...
        val historikk = arrayOf(Utbetalingsperiode("456789123", 1.desember(2020),   4.desember(2020), 100.prosent, 1000.daglig))
    ...
    fun `utbetalt i infotrygd mens vi venter på inntektsmelding - oppdaget ved påminnelse`() {
        ...
        håndterUtbetalingshistorikk(1.vedtaksperiode,
            Utbetalingsperiode("456789123", 1.desember(2020),   4.desember(2020), 100.prosent, 1000.daglig),
            inntektshistorikk = listOf(
                Inntektsopplysning("456789123", 1.desember(2020), 1000.daglig, true)
            )
        )
