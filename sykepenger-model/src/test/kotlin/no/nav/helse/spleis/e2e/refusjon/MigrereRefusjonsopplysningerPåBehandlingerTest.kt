...
internal class MigrereRefusjonsopplysningerPåBehandlingerTest : AbstractDslTest() {
    ...
    @Test
    @Order(1)
    fun `Vedtaksperiode med én beregnet endring - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup1og2()
    ...
    @Test
    @Order(2)
    fun `Vedtaksperiode med én beregnet endring - uten toggle`() =
        LagreRefusjonsopplysningerPåBehandling.disable {
            a1 {
                setup1og2()
                        ...
                        listOf(
                            OverstyrtArbeidsgiveropplysning(
                                ...
                                refusjonsopplysninger =
                                    listOf(Triple(1.januar, null, INNTEKT * 1.25)),
                            )
                        ),
    ...
    private val TestArbeidsgiverInspektør.refusjonstidslinjeFraFørsteBeregnedeEndring:
        Beløpstidslinje
        get() {
            val endringer =
                vedtaksperioder(1.vedtaksperiode).behandlinger.behandlinger.last().endringer
    ...
    @Test
    @Order(3)
    fun `Vedtaksperiode med flere beregnede endringer - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup3og4()
    ...
    @Test
    @Order(4)
    fun `Vedtaksperiode med flere beregnede endringer - uten toggle`() =
        LagreRefusjonsopplysningerPåBehandling.disable {
            a1 {
                setup3og4()
                migrerRefusjonsopplysningerPåBehandlinger()
                assertEquals(
                    forrigeRefusjonstidslinje,
                    inspektør.refusjonstidslinjeFraFørsteBeregnedeEndring,
                )
            }
        }
    ...
    @Test
    @Order(5)
    fun `Siste vedtaksperiode har fått IM, men er ikke beregnet - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup5og6()
                forrigeRefusjonstidslinje =
    ...
    @Test
    @Order(6)
    fun `Siste vedtaksperiode har fått IM, men er ikke beregnet - uten toggle`() =
        setOf(LagreRefusjonsopplysningerPåBehandling, LagreUbrukteRefusjonsopplysninger).disable {
            a1 {
                setup5og6()
    ...
    @Test
    @Order(7)
    fun `Siste vedtaksperiode har fått IM og forlengelsessøknad - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup7og8()
                forrigeRefusjonstidslinje =
    ...
    @Test
    @Order(8)
    fun `Siste vedtaksperiode har fått IM og forlengelsessøknad - uten toggle`() =
        setOf(LagreRefusjonsopplysningerPåBehandling, LagreUbrukteRefusjonsopplysninger).disable {
            a1 {
                setup7og8()
                migrerUbrukteRefusjonsopplysninger()
    ...
    @Test
    @Order(9)
    fun `uberegnet forlengelse når det mottas informasjon om opphør - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup9og10()
                forrigeRefusjonstidslinje =
    ...
    @Test
    @Order(10)
    fun `uberegnet forlengelse når det mottas informasjon om opphør - uten toggle`() =
        LagreRefusjonsopplysningerPåBehandling.disable {
            a1 {
                setup9og10()
                migrerRefusjonsopplysningerPåBehandlinger()
                forrigeRefusjonstidslinje.assertBeløpstidslinje(
                    1.februar til 10.februar to INNTEKT,
                    11.februar til 28.februar to INGEN,
                )
                inspektør
    ...
    @Test
    @Order(11)
    fun `uberegnet forlengelse i revurdering når det mottas informasjon om opphør - med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup11og12()
                forrigeRefusjonstidslinje =
    ...
    @Test
    @Order(12)
    fun `uberegnet forlengelse i revurdering når det mottas informasjon om opphør - uten toggle`() =
        LagreRefusjonsopplysningerPåBehandling.disable {
            a1 {
                setup11og12()
                migrerRefusjonsopplysningerPåBehandlinger()
                forrigeRefusjonstidslinje.assertBeløpstidslinje(
                    1.januar til 31.januar to INNTEKT * 1.25
                )
                forrigeRefusjonstidslinje.assertBeløpstidslinje(
                    1.februar til 28.februar to INNTEKT * 1.5
                )
                forrigeRefusjonstidslinje.assertBeløpstidslinje(
                    1.mars til 31.mars to INNTEKT * 1.75
                )
                val faktiskRefusjonstidslinje =
                    inspektør.vedtaksperioder(1.vedtaksperiode).refusjonstidslinje +
                        inspektør.vedtaksperioder(2.vedtaksperiode).refusjonstidslinje +
                        inspektør.vedtaksperioder(3.vedtaksperiode).refusjonstidslinje
                faktiskRefusjonstidslinje.assertBeløpstidslinje(
                    1.januar til 31.januar to INNTEKT * 1.25
                )
                faktiskRefusjonstidslinje.assertBeløpstidslinje(
                    1.februar til 28.februar to INNTEKT * 1.5
    ...
    @Test
    @Order(13)
    fun `flere arbeidsgivere med bare en inntektsmelding- med toggle`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup13og14()
                forrigeRefusjonstidslinje =
    ...
    @Test
    @Order(14)
    fun `flere arbeidsgivere med bare en inntektsmelding- uten toggle`() =
        LagreRefusjonsopplysningerPåBehandling.disable {
            a1 {
                setup13og14()
                migrerRefusjonsopplysningerPåBehandlinger()
                val faktiskBeløpstidslinje =
                    inspektør.vedtaksperioder(1.vedtaksperiode).refusjonstidslinje +
                        inspektør.vedtaksperioder(2.vedtaksperiode).refusjonstidslinje
    ...
    @Test
    @Order(15)
    fun `flere arbeidsgivere med bare en inntektsmelding - med toggle alltid på`() =
        LagreRefusjonsopplysningerPåBehandling.enable {
            a1 {
                setup13og14()
                forrigeRefusjonstidslinje =
    ...
    private fun Beløpstidslinje.assertBeløpstidslinje(
        vararg forventetBeløp: Pair<Periode, Inntekt>
    ) {
        forventetBeløp.forEach { (periode, inntekt) ->
            val subset = subset(periode)
            assertEquals(periode, subset.perioderMedBeløp.singleOrNull()) {
                "Vi har ikke beløp i hele $periode"
            }
            assertTrue(subset.all { it.beløp == inntekt }) {
                "Vi forventet at inntekten skulle være ${inntekt.dagligInt} i $periode, men var: ${subset.map { it.beløp.dagligInt }}"
            }
        }
    }
}
