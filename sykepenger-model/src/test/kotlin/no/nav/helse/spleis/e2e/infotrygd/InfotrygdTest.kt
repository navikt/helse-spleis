...
internal class InfotrygdTest : AbstractEndToEndTest() {
    ...
    fun `Kan endre refusjonsopplysninger på Infotrygd-sykepengegrunnlag, men inntekten ignoreres`() {
        ...
        håndterOverstyrArbeidsgiveropplysninger(
            1.januar,
            listOf(OverstyrtArbeidsgiveropplysning(a1, 15000.månedlig, "foo", null, listOf(Triple(1.januar, null, 15000.månedlig)))),
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(meldingsreferanse, 1.januar, null, 15000.månedlig, SAKSBEHANDLER)),
