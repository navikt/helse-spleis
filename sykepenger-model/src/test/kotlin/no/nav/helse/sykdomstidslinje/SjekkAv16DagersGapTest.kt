...
internal class SjekkAv16DagersGapTest {
    ...
    fun `Tidslinje uten gap`() {
        ...
        assertFalse(tidslinje.harNyArbeidsgiverperiodeEtter(NormalArbeidstaker, 2.januar))
    }
    ...
    fun `Tidslinje med 16 dagers gap`() {
        ...
        assertTrue(tidslinje.harNyArbeidsgiverperiodeEtter(NormalArbeidstaker, 2.januar))
    }
