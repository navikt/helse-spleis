...
import no.nav.helse.person.aktivitetslogg.Varselkode.RV_SØ_14
...
internal class VarselkodeTest {
    ...
    fun `alle varselkoder testes eksplisitt`() {
        ...
        val varselkoderSomKjentManglerTest = listOf(
            ...
            RV_ST_1, RV_SØ_11, RV_SØ_12, RV_SØ_13, RV_SØ_14,
            RV_SØ_15, RV_UT_5, RV_SØ_17, RV_SØ_22,
            ...
            RV_IV_3, RV_RV_2, RV_UT_21, RV_IM_22, RV_RE_1
        )
