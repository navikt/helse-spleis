...
internal class ØkonomiTest {
    ...
    @Test fun `kan ikke sette dagsats mer enn en gang`() {
        assertThrows<IllegalStateException>{ 25.prosent.sykdomsgrad.dekningsgrunnlag(1200).dekningsgrunnlag(800) }
    }
    ...
    @Test fun singelsykegrad() {
        assertEquals(
            75.prosent,
            listOf(
                75.prosent.sykdomsgrad.dekningsgrunnlag(1200)
            ).sykdomsgrad()
        )
    }
    ...
    @Test fun `to arbeidsgivere`() {
        assertEquals(
            38.prosent,
            listOf(
                50.prosent.sykdomsgrad.dekningsgrunnlag(1200),
                20.prosent.sykdomsgrad.dekningsgrunnlag(800)
            ).sykdomsgrad().also {
    ...
    @Test fun `flere arbeidsgivere`() {
        assertEquals(
            ...
            listOf(
                50.prosent.sykdomsgrad.dekningsgrunnlag(1200),
                20.prosent.sykdomsgrad.dekningsgrunnlag(800),
                60.prosent.sykdomsgrad.dekningsgrunnlag(2000)
            ).sykdomsgrad()
        )
    }
    ...
    @Test fun `låst økonomi fungerer som arbeidsdag`() {
        assertEquals(
            ...
            listOf(
                50.prosent.sykdomsgrad.dekningsgrunnlag(1200),
                20.prosent.sykdomsgrad.dekningsgrunnlag(800),
                60.prosent.sykdomsgrad.dekningsgrunnlag(2000).lås()
            ).sykdomsgrad().also {
    ...
    @Test fun `kan ikke låses etter betaling`() {
        50.prosent.sykdomsgrad.dekningsgrunnlag(1200).also { økonomi ->
    ...
    @Test fun `opplåsing tillater betaling`() {
        50.prosent.sykdomsgrad.dekningsgrunnlag(1200).lås().låsOpp().also { økonomi ->
            listOf(økonomi).betal(1.januar)
            assertUtbetaling(økonomi, 600, 0)
        }
    }
    ...
    @Test fun `betal 0 hvis låst`() {
        50.prosent.sykdomsgrad.dekningsgrunnlag(1200).lås().also { økonomi ->
            listOf(økonomi).betal(1.januar)
    ...
    @Test fun `kan beregne betaling bare en gang`() {
        assertThrows<IllegalStateException> {
            listOf(80.prosent.sykdomsgrad.dekningsgrunnlag(1200)).betal(1.januar).betal(1.januar)
        }
    }

    @Test fun `Beregn utbetaling når mindre enn 6G`() {
        80.prosent.sykdomsgrad.dekningsgrunnlag(1200).also {
    ...
    @Test fun `arbeidsgiver og person splittes tilsvarer totalt`() {
        Økonomi.sykdomsgrad(100.prosent, 50.prosent).dekningsgrunnlag(999).also {
            listOf(it).betal(1.januar)
            it.toMap().apply {
    ...
    @Test fun `tre arbeidsgivere uten grenser`() {
        val a =  Økonomi.sykdomsgrad(50.prosent, 50.prosent).dekningsgrunnlag(600)
        val b =  Økonomi.sykdomsgrad(20.prosent, 100.prosent).dekningsgrunnlag(400)
        val c =  Økonomi.sykdomsgrad(60.prosent, 0.prosent).dekningsgrunnlag(1000)
    ...
    @Test fun `tre arbeidsgivere med persongrense`() {
        val a =  Økonomi.sykdomsgrad(50.prosent, 50.prosent).dekningsgrunnlag(1200)
        val b =  Økonomi.sykdomsgrad(20.prosent, 100.prosent).dekningsgrunnlag(800)
        val c =  Økonomi.sykdomsgrad(60.prosent, 0.prosent).dekningsgrunnlag(2000)
        listOf(a, b, c).betal(1.januar).also {
            assertEquals(49.prosent, it.sykdomsgrad())
            // grense = 1059
        }
    ...
    @Test fun `tre arbeidsgivere med arbeidsgivere`() {
        val a =  Økonomi.sykdomsgrad(50.prosent, 50.prosent).dekningsgrunnlag(4800)
        val b =  Økonomi.sykdomsgrad(20.prosent, 100.prosent).dekningsgrunnlag(3200)
        val c =  Økonomi.sykdomsgrad(60.prosent, 0.prosent).dekningsgrunnlag(8000)
        listOf(a, b, c).betal(1.januar).also {
            assertEquals(49.prosent, it.sykdomsgrad())
            // grense = 1059
        }
    ...
    @Test fun `tre arbeidsgivere med arbeidsgivere2`() {  // Alternate algorithm
        val a =  Økonomi.sykdomsgrad(50.prosent, 100.prosent).dekningsgrunnlag(969.23)
        val b =  Økonomi.sykdomsgrad(80.prosent, 90.prosent).dekningsgrunnlag(461.53)
        val c =  Økonomi.sykdomsgrad(20.prosent, 25.prosent).dekningsgrunnlag(1430.76)
