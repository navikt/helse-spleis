...
internal fun Inntekt.inntektsgrunnlag(skjæringstidspunkt: LocalDate) = inntektsgrunnlag(AbstractPersonTest.UNG_PERSON_FØDSELSDATO.alder, AbstractPersonTest.ORGNUMMER, skjæringstidspunkt)
