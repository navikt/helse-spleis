...
internal class InntektshistorikkInspektør(inntektshistorikk: InntektshistorikkView) {
    ...
    internal val size
        get() = inntektsopplysninger.size

    internal val inntektsdatoer
        get() = inntektsopplysninger.map { it.dato }

    class Opplysning(val dato: LocalDate, val sykepengegrunnlag: Inntekt)
