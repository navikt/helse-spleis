...
internal class VedtaksperiodeInspektør(
    view: VedtaksperiodeView
) {
    ...
    internal val utbetalingstidslinje: Utbetalingstidslinje get() =
        behandlinger
            .last()
            .endringer
            .last()
    ...
    internal val arbeidsgiverperiode get() =
        behandlinger
            .last()
            .endringer
            .last()
    ...
    internal val sykdomstidslinje get() =
        behandlinger
            .last()
            .endringer
            .last()
