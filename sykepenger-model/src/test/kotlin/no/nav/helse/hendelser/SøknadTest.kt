...
internal class SøknadTest {
    ...
    fun `søknad med ferie`() {
        ...
        assertFalse(søknad.valider(aktivitetslogg, null, Beløpstidslinje(), subsumsjonslogg, 1.januar).harVarslerEllerVerre())
        assertEquals(10, søknad.sykdomstidslinje.count())
    }
    ...
    fun `søknad med utlandsopphold`() {
        ...
        assertTrue(søknad.valider(aktivitetslogg, null, Beløpstidslinje(), subsumsjonslogg, 1.januar).harVarslerEllerVerre())
        assertEquals(10, søknad.sykdomstidslinje.count())
    }
    ...
    fun `ikke jobbet siste 14 dager i annet arbeidsforhold`() {
        ...
        søknad.valider(aktivitetslogg, null, Beløpstidslinje(), EmptyLog, 1.januar)
