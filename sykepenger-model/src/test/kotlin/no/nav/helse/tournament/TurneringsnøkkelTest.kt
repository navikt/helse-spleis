...
internal class TurneringsnøkkelTest {
    ...
    internal fun turneringsnøkkel() {
        ...
        assertEquals(Arbeidsgiverdag_SØ, fraDag(Egenmeldingsdag.Søknad(enDag)))
        assertEquals(Arbeidsgiverdag_IM, fraDag(Egenmeldingsdag.Inntektsmelding(enDag)))
        assertEquals(Feriedag_SØ, fraDag(Feriedag.Søknad(enDag)))
        assertEquals(Feriedag_IM, fraDag(Feriedag.Inntektsmelding(enDag)))
        assertEquals(UkjentDag, fraDag(ImplisittDag(enDag)))
