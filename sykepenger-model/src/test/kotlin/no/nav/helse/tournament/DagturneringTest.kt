...
internal class DagturneringTest {
    ...
    fun `arbeidsdag fra inntektsmelding vinner over egenmelding fra søknad`() {
        val søknadArbeidsgiverdag =
            Sykdomstidslinje.arbeidsgiverdager(1.mandag, 1.mandag, 100.prosent, søknad)
        val inntektsmeldingArbeidsdag =
            Sykdomstidslinje.arbeidsdager(1.mandag, 1.mandag, inntektsmelding)

        val tidslinje =
            søknadArbeidsgiverdag.merge(inntektsmeldingArbeidsdag, Dagturnering.TURNERING::beste)
    ...
    fun `arbeidsdag fra inntektsmelding vinner over sykedag fra søknad`() {
        ...
        val tidslinje =
            søknadSykedag.merge(inntektsmeldingArbeidsdag, Dagturnering.TURNERING::beste)
    ...
    fun `arbeidsgiverdag fra inntektsmelding vinner over arbeidsgiverdag fra søknad`() {
        val søknadArbeidsgiverdag =
            Sykdomstidslinje.arbeidsgiverdager(1.mandag, 1.mandag, 100.prosent, søknad)
        val inntektsmeldingArbeidsgiverdag =
            Sykdomstidslinje.arbeidsgiverdager(1.mandag, 1.mandag, 100.prosent, inntektsmelding)

        val tidslinje = søknadArbeidsgiverdag.merge(
            inntektsmeldingArbeidsgiverdag,
    ...
    fun `arbeidsgiverdag fra søknad taper for arbeidsgiverdag fra inntektsmelding`() {
        ...
        val tidslinje = inntektsmeldingArbeidsgiverdag.merge(
            søknadArbeidsgiverdag,
            Dagturnering.TURNERING::beste
        )
    ...
    fun `arbeidsgiverdag_helgedag fra inntektsmelding vinner over arbeidsgiverdag fra søknad`() {
        val søknadArbeidsgiverdag =
            Sykdomstidslinje.arbeidsgiverdager(1.lørdag, 1.lørdag, 100.prosent, søknad)
        val inntektsmeldingArbeidsgiverHelgedag =
            Sykdomstidslinje.arbeidsgiverdager(1.lørdag, 1.lørdag, 100.prosent, inntektsmelding)

        val tidslinje = søknadArbeidsgiverdag.merge(
            inntektsmeldingArbeidsgiverHelgedag,
            Dagturnering.TURNERING::beste
        )
    ...
    fun `arbeidsgiverdag_helgedag fra søknad taper for arbeidsgiverdag_helgedag fra inntektsmelding`() {
        val søknadArbeidsgiverHelgedag =
            Sykdomstidslinje.arbeidsgiverdager(1.lørdag, 1.lørdag, 100.prosent, søknad)
        val inntektsmeldingArbeidsgiverHelgedag =
            Sykdomstidslinje.arbeidsgiverdager(1.lørdag, 1.lørdag, 100.prosent, inntektsmelding)

        val tidslinje = inntektsmeldingArbeidsgiverHelgedag.merge(
            søknadArbeidsgiverHelgedag,
            Dagturnering.TURNERING::beste
        )
    ...
    fun `arbeidsgiverdag fra søknad taper over arbeidsgiverdag fra inntektsmelding selvom søknad kom sist`() {
        ...
        val tidslinje1 = inntektsmeldingArbeidsgiverdag.merge(
            søknadArbeidsgiverdag,
            Dagturnering.TURNERING::beste
        )
