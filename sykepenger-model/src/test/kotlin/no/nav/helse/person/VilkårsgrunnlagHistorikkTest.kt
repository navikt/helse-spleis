    ...
    fun `setter inntekt på økonomi`() {
        ...
        val økonomi: Økonomi =
            grunnlag
                ...
                .medInntektHvisFinnes(1.januar, Økonomi.ikkeBetalt(), NormalArbeidstaker, Beløpstidslinje())
    ...
    fun `feiler dersom inntekt ikke finnes for orgnr`() {
        ...
        val resultat =
            grunnlag
                ...
                .forArbeidsgiver(
                    ORGNR,
                )?.medInntektHvisFinnes(31.desember(2017), Økonomi.ikkeBetalt(), NormalArbeidstaker, Beløpstidslinje())
        assertNull(resultat)
    }
