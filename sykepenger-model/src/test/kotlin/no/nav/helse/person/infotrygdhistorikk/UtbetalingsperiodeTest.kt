...
internal class UtbetalingsperiodeTest {
    ...
    fun `arbeidsgiverutbetaling er ikke lik brukerutbetaling`() {
        ...
        val inntekt1 = Utbetalingsperiode.inntekt(100.daglig, prosent)
        val orgnr = "orgnr"
        val fom = 1.januar
        val tom = 2.januar
    ...
    fun `like perioder`() {
        ...
        val utbetalingAG1 = ArbeidsgiverUtbetalingsperiode(
            "ag1",
            1.februar,
            28.februar,
            100.prosent,
        ...
        val utbetalingAG2 = ArbeidsgiverUtbetalingsperiode(
            "ag2",
            1.februar,
            28.februar,
            100.prosent,
