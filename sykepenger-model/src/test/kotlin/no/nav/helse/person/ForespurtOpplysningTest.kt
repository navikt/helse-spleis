...
class ForespurtOpplysningTest {
    ...
    private fun forespurteOpplysningerMedFastsattInntektMap() =
        listOf(
            mapOf("opplysningstype" to "FastsattInntekt", "fastsattInntekt" to 30000.0),
            mapOf("opplysningstype" to "Arbeidsgiverperiode"),
            mapOf(
    ...
    private fun forespurteOpplysningerMap() =
        listOf(
            mapOf(
                    ...
                    mapOf(
                        "forrigeInntekt" to
                            mapOf(
                                ...
                                "kilde" to
                                    PersonObserver.Inntektsopplysningstype.INNTEKTSMELDING.name,
                                "beløp" to 31000.0,
                            )
                    ),
            ),
            mapOf("opplysningstype" to "Arbeidsgiverperiode"),
            mapOf("opplysningstype" to "Refusjon", "forslag" to emptyList<Refusjonsopplysning>()),
        )
}
