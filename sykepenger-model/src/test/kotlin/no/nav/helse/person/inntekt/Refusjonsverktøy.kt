...
internal fun assertLikeRefusjonsopplysninger(expected: List<Refusjonsopplysning>, actual: List<Refusjonsopplysning>) {
...
internal fun assertLikRefusjonsopplysning(expected: Refusjonsopplysning, actual: Refusjonsopplysning) {
