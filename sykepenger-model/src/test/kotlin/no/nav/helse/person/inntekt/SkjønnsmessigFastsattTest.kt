...
internal class SkjønnsmessigFastsattTest {
    ...
    fun `inntektsmelding blir overskrevet av skjønnsmessig fastsettelse`() {
        ...
        val skjønnsmessigFastsatt = original.overstyresAv(
            SkjønnsmessigFastsatt(
                1.januar,
                UUID.randomUUID(),
                skjønnsmessigFastsattBeløp,
                LocalDateTime.now()
            )
        )
    ...
    fun `saksbehandlerinntekt blir overskrevet av skjønnsmessig fastsettelse`() {
        ...
        val original = Inntektsmelding(1.januar, UUID.randomUUID(), originalBeløp)
        val saksbehandler = original.overstyresAv(
            Saksbehandler(
                1.januar,
                UUID.randomUUID(),
                saksbehandlerbeløp,
        ...
        val skjønnsmessigFastsatt = saksbehandler.overstyresAv(
            SkjønnsmessigFastsatt(
                1.januar,
                UUID.randomUUID(),
                skjønnsmessigFastsattBeløp,
        ...
        assertEquals(
            saksbehandlerbeløp,
            skjønnsmessigFastsatt.omregnetÅrsinntekt().fastsattÅrsinntekt()
        )
    }
    ...
    fun `skjønnsmessig fastsettelse blir overskrevet av skjønnsmessig fastsettelse`() {
        ...
        val originalBeløp = 2500.daglig
        val original = Inntektsmelding(1.januar, UUID.randomUUID(), originalBeløp)
        val skjønnsmessigFastsatt1 = original.overstyresAv(
            SkjønnsmessigFastsatt(
                1.januar,
                UUID.randomUUID(),
                skjønnsmessigFastsattBeløp1,
                LocalDateTime.now()
            )
        )
        val skjønnsmessigFastsatt2 = skjønnsmessigFastsatt1.overstyresAv(
            SkjønnsmessigFastsatt(
                1.januar,
                UUID.randomUUID(),
                skjønnsmessigFastsattBeløp2,
                LocalDateTime.now()
            )
        )
        ...
        assertEquals(
            originalBeløp,
            skjønnsmessigFastsatt2.omregnetÅrsinntekt().fastsattÅrsinntekt()
        )
    }
}
