...
internal class RefusjonshistorikkTilRefusjonsopplysningerTest {
    ...
    fun `bruker endringer i refusjon oppgitt før siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 30.januar, 100.daglig, id) +
                Beløpstidslinje.fra(31.januar til 1.februar, 200.daglig, id) +
    ...
    fun `bruker endringer i refusjon oppgitt lik siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 31.januar, 100.daglig, id) +
                Beløpstidslinje.fra(1.februar til 1.februar, 200.daglig, id) +
                Beløpstidslinje.fra(2.februar til 28.februar, INGEN, id)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }
    ...
    fun `ignorer endringer i refusjon etter siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 1.februar, 100.daglig, id) +
                Beløpstidslinje.fra(2.februar til 28.februar, INGEN, id)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }
    ...
    fun `første fraværsdag etter opphør av refusjon`() {
        ...
        val refusjonsopplysninger =
            refusjonshistorikk.refusjonsopplysninger(5.august).inspektør.refusjonsopplysninger
        assertLikeRefusjonsopplysninger(
            listOf(
                Refusjonsopplysning(
                    kilde1.meldingsreferanseId,
    ...
    fun `opphører ikke refusjon allikevel`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.mars til 20.mars, 1000.daglig, kilde1) +
                Beløpstidslinje.fra(21.mars til 31.mars, 1000.daglig, kilde2)
    ...
    fun `siste refusjonsdag satt på inntektsmeldingen`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 31.januar, 1000.daglig, kilde1) +
                Beløpstidslinje.fra(1.februar til 28.februar, INGEN, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }
    ...
    fun `To inntektsmeldinger på ulike skjæringstidspunkt uten sisteRefusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 28.februar, 1000.daglig, kilde1) +
                Beløpstidslinje.fra(1.mars til 31.mars, 2000.daglig, kilde2)
    ...
    fun `IM flere endringer i refusjon - og med siste refusjonsdag satt`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 19.januar, 1000.daglig, kilde1) +
                Beløpstidslinje.fra(20.januar til 31.januar, INGEN, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 31.januar))
    }
        ...
        assertLikeRefusjonsopplysninger(
            listOf(
                Refusjonsopplysning(
                    ...
                    1000.daglig,
                    ARBEIDSGIVER,
                ), // Gråsonen, legges på en refusjonsopplysning strukket tilbake til
    ...
    fun `første fraværsdag satt til etter første dag i siste del av agp`() {
        ...
        val forventet = Beløpstidslinje.fra(11.februar til 28.februar, 1000.daglig, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.februar til 28.februar))
    }
    ...
    fun `første fraværsdag satt til etter agp`() {
        ...
        val forventet = Beløpstidslinje.fra(20.februar til 28.februar, 1000.daglig, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.februar til 28.februar))
    }
    ...
    fun `Første fraværsdag dagen før søkevindu`() {
        ...
        assertEquals(
            ...
            refusjonshistorikk.refusjonsopplysninger(2.mars).inspektør.refusjonsopplysninger,
        )
        assertEquals(Beløpstidslinje(), refusjonshistorikk.beløpstidslinje(2.mars til 31.mars))
    }

    private fun endringIRefusjonFraOgMed(
        dag: LocalDate
    ): Triple<Kilde, List<Refusjonsopplysning>, Refusjonshistorikk> {
        val refusjonshistorikk = Refusjonshistorikk()
        val refusjonsopplysninger =
            refusjonshistorikk
                .apply {
