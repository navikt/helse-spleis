...
internal class RefusjonshistorikkTilRefusjonsopplysningerTest {
    ...
    fun `bruker endringer i refusjon oppgitt før siste refusjonsdag`() {
        ...
        val forventet = Beløpstidslinje.fra(
    ...
    fun `To inntektsmeldinger på ulike skjæringstidspunkt uten sisteRefusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 28.februar, 1000.daglig, kilde1) + Beløpstidslinje.fra(
                1.mars til 31.mars,
                2000.daglig,
                kilde2
            )
    ...
    fun `IM med en endring i refusjon`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 19.januar, 1000.daglig, kilde1) + Beløpstidslinje.fra(
        ...
        assertLikeRefusjonsopplysninger(
            listOf(
                Refusjonsopplysning(
                    ...
                    1000.daglig,
                    ARBEIDSGIVER
                ), // Gråsonen, legges på en refusjonsopplysning strukket tilbake til skjæringstidspunktet
                Refusjonsopplysning(
                    kilde1.meldingsreferanseId,
                    10.februar,
                    null,
