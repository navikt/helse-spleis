...
internal class RefusjonshistorikkTilRefusjonsopplysningerTest {
    ...
    fun `bruker endringer i refusjon oppgitt før siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 30.januar, 100.daglig, id) + Beløpstidslinje.fra(31.januar til 1.februar, 200.daglig, id) +
                Beløpstidslinje.fra(2.februar til 28.februar, INGEN, id)
    ...
    fun `bruker endringer i refusjon oppgitt lik siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 31.januar, 100.daglig, id) + Beløpstidslinje.fra(1.februar til 1.februar, 200.daglig, id) +
                Beløpstidslinje.fra(2.februar til 28.februar, INGEN, id)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }
    ...
    fun `ignorer endringer i refusjon etter siste refusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 1.februar, 100.daglig, id) + Beløpstidslinje.fra(2.februar til 28.februar, INGEN, id)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }

    @Test
    fun `siste refusjonsdag er satt til før første fraværsdag`() {
        val refusjonshistorikk =
            Refusjonshistorikk().apply {
                leggTilRefusjon(
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(kilde1.meldingsreferanseId, 20.januar, null, 0.daglig, ARBEIDSGIVER)),
            refusjonshistorikk.refusjonsopplysninger(20.januar).inspektør.refusjonsopplysninger,
        )
    ...
    fun `første fraværsdag etter opphør av refusjon`() {
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(kilde1.meldingsreferanseId, 5.august, null, 0.daglig, ARBEIDSGIVER)),
            refusjonsopplysninger,
        )
    ...
    fun `siste refusjonsdag er satt til før starten på siste del av arbeidsgiverperioden`() {
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(kilde1.meldingsreferanseId, 10.januar, null, 0.daglig, ARBEIDSGIVER)),
            refusjonshistorikk.refusjonsopplysninger(10.januar).inspektør.refusjonsopplysninger,
        )
    ...
    fun `opphører ikke refusjon allikevel`() {
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(kilde2.meldingsreferanseId, 1.mars, null, 1000.daglig, ARBEIDSGIVER)),
            refusjonshistorikk.refusjonsopplysninger(1.mars).inspektør.refusjonsopplysninger,
        )

        val forventet =
            Beløpstidslinje.fra(1.mars til 20.mars, 1000.daglig, kilde1) + Beløpstidslinje.fra(21.mars til 31.mars, 1000.daglig, kilde2)
    ...
    fun `happy case`() {
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(kilde1.meldingsreferanseId, 1.januar, null, 1000.daglig, ARBEIDSGIVER)),
    ...
    fun `siste refusjonsdag satt på inntektsmeldingen`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 31.januar, 1000.daglig, kilde1) + Beløpstidslinje.fra(1.februar til 28.februar, INGEN, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 28.februar))
    }
    ...
    fun `To inntektsmeldinger på ulike skjæringstidspunkt uten sisteRefusjonsdag`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 28.februar, 1000.daglig, kilde1) + Beløpstidslinje.fra(1.mars til 31.mars, 2000.daglig, kilde2)
    ...
    fun `IM med en endring i refusjon`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 19.januar, 1000.daglig, kilde1) +
                Beløpstidslinje.fra(20.januar til 31.januar, 500.daglig, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 31.januar))
    }
    ...
    fun `IM flere endringer i refusjon - og med siste refusjonsdag satt`() {
        ...
        val forventet =
            Beløpstidslinje.fra(1.januar til 19.januar, 1000.daglig, kilde1) + Beløpstidslinje.fra(20.januar til 31.januar, INGEN, kilde1)
        assertEquals(forventet, refusjonshistorikk.beløpstidslinje(1.januar til 31.januar))
    }
