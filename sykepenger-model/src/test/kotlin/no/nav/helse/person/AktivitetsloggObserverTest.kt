...
internal class AktivitetsloggObserverTest {
    ...
    fun `fanger opp nye aktiviteter`() {
        ...
        testObserver.assertAktivitet('W', melding = "Søknaden inneholder permittering. Vurder om permittering har konsekvens for rett til sykepenger", kode = RV_SØ_1, kontekster = listOf(personkontekst, arbeidsgiverkontekst, vedtaksperiodekontekst))
