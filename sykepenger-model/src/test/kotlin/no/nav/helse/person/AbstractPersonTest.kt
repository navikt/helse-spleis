...
internal abstract class AbstractPersonTest {
    ...
    fun Int.vedtaksperiode(orgnummer: String): IdInnhenter =
        IdInnhenter { this@vedtaksperiode.vedtaksperiodeId(orgnummer) }
    ...
    protected fun createOvergangFraInfotrygdPerson() =
        createTestPerson { jurist -> overgangFraInfotrygdPerson(jurist) }
