...
internal class RefusjonsopplysningerTest {
    ...
    fun `ny opplysning før med overlapp`() {
        ...
        assertEquals(
            listOf(
                ny,
                Refusjonsopplysning(meldingsreferanseId1, 2.mars, 31.mars, 2000.daglig)
    ...
    fun `håndterer å ta inn refusjonsopplysninger hulter til bulter`() {
        ...
        val eksisterendeFørst =
            RefusjonsopplysningerBuilder().leggTil(eksisterende, eksisterendeTidspunkt)
                .leggTil(ny, nyttTidspunkt).build()
        val nyFørst = RefusjonsopplysningerBuilder().leggTil(ny, nyttTidspunkt)
            .leggTil(eksisterende, eksisterendeTidspunkt).build()
    ...
    fun `refusjonsopplysninger med samme tidspunkt sorteres på fom`() {
        ...
        val marsFørst =
            RefusjonsopplysningerBuilder().leggTil(mars, tidspunkt).leggTil(januar, tidspunkt)
                .build()
        val januarFørst =
            RefusjonsopplysningerBuilder().leggTil(januar, tidspunkt).leggTil(mars, tidspunkt)
                .build()
    ...
    fun `Har ikke nødvendig refusjonsopplysninger etter oppholdsdager`() {
        ...
        val refusjonsopplysninger = Refusjonsopplysning(
            meldingsreferanseId1,
            1.januar,
            null,
            20000.månedlig
    ...
    fun `Har nødvendige refusjonsopplysninger når vi får nye refusjonsopplysninger for perioden etter oppholdet`() {
        ...
        val refusjonsopplysningerJanuar = Refusjonsopplysning(
            meldingsreferanseId1,
            1.januar,
            null,
            20000.månedlig
        ...
        val refusjonsopplysningerFebruar = Refusjonsopplysning(
            meldingsreferanseId2,
            1.februar,
            null,
            25000.månedlig
    ...
    fun `saksbehandler forkorter refusjonsopplysningens snute`() {
        val inntektsmeldingId = meldingsreferanseId1
        val eksisterendeRefusjonsopplysninger = Refusjonsopplysning(
            inntektsmeldingId,
            1.januar,
            null,
            1000.daglig
    ...
    fun `saksbehandler forkorter refusjonsopplysningens hale`() {
        ...
        val overstyringId = meldingsreferanseId2
        val ønskedeRefusjonsopplysninger = Refusjonsopplysning(
            overstyringId,
            1.januar,
            20.januar,
            1000.daglig
