...
internal class RefusjonsopplysningerTest {
    ...
    fun `ny refusjonsopplysning erstatter gamle`() {
        val refusjonsopplysninger =
            listOf(
                Refusjonsopplysning(meldingsreferanseId1, 2.januar, 30.januar, 2000.daglig),
            ).refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(
                Refusjonsopplysning(meldingsreferanseId2, 1.januar, 31.januar, 1000.daglig),
            ).refusjonsopplysninger()
    ...
    fun `ny refusjonsopplysning uten tom erstatter gammel uten tom`() {
        ...
        val nyeRefusjonsopplysninger =
            listOf(
                Refusjonsopplysning(meldingsreferanseId2, 1.januar, null, 1000.daglig),
            ).refusjonsopplysninger()
    ...
    fun `perfekt overlapp - bruker nye opplysninger`() {
        ...
        val nyeRefusjonsopplysninger =
            listOf(
                Refusjonsopplysning(meldingsreferanseId2, 1.januar, 1.mars, 1000.daglig),
            ).refusjonsopplysninger()
    ...
    fun `senere periode uten tom`() {
        ...
        assertEquals(
            refusjonsopplysninger,
            Refusjonsopplysninger(refusjonsopplysninger, LocalDateTime.now()).inspektør.refusjonsopplysninger,
        )
    }
    ...
    fun `ny opplysning før oss`() {
        ...
        assertEquals(
            ...
            Refusjonsopplysninger(listOf(eksisterende, ny), LocalDateTime.now()).inspektør.refusjonsopplysninger,
        )
    }
    ...
    fun `Har nødvendige refusjonsopplysninger når vi får nye refusjonsopplysninger for perioden etter oppholdet`() {
        ...
        assertTrue(
            harNødvendigeRefusjonsopplysninger(1.januar, 1.januar til 31.januar, oppdaterteRefusjonsopplysninger, arbeidsgiverperiode),
        )
