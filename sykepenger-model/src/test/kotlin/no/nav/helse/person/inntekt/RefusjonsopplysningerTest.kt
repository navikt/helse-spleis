...
internal class RefusjonsopplysningerTest {
    ...
    fun `refusjonsopplysninger som beløpstidslinje`() {
        ...
        val forventet =
            Beløpstidslinje.fra(
                1.januar til 9.januar,
                500.daglig,
                Kilde(meldingsreferanseId1, ARBEIDSGIVER, LocalDateTime.MIN),
            ) +
                Beløpstidslinje.fra(
                    10.januar til 28.februar,
                    INGEN,
                    Kilde(meldingsreferanseId2, SAKSBEHANDLER, LocalDate.EPOCH.atStartOfDay()),
                ) +
                Beløpstidslinje.fra(
                    1.mars til 1.mars,
                    250.daglig,
                    Kilde(meldingsreferanseId3, SYSTEM, LocalDateTime.MAX),
                )
    ...
    fun `ny refusjonsopplysning i midten av eksisterende`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, 31.januar, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 15.januar, 20.januar, 1000.daglig))
                .refusjonsopplysninger()

        assertEquals(
            15.januar,
            nyeRefusjonsopplysninger.finnFørsteDatoForEndring(refusjonsopplysninger),
        )
        assertEquals(
            listOf(
    ...
    fun `ny refusjonsopplysning uten tom`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, 31.januar, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 15.januar, null, 1000.daglig))
                .refusjonsopplysninger()
    ...
    fun `ny refusjonsopplysning erstatter gamle`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 2.januar, 30.januar, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.januar, 31.januar, 1000.daglig))
                .refusjonsopplysninger()

        val forventet =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 2.januar, 31.januar, 1000.daglig))
                .refusjonsopplysninger()
    ...
    fun `ny refusjonsopplysning uten tom erstatter gammel uten tom`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.januar, null, 1000.daglig))
                .refusjonsopplysninger()
    ...
    fun `ny refusjonsopplysning uten tom legges på eksisterende uten tom`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.mars, null, 1000.daglig))
                .refusjonsopplysninger()
        ...
        assertEquals(
            listOf(
                ...
                Refusjonsopplysning(meldingsreferanseId2, 1.mars, null, 1000.daglig),
            ),
            refusjonsopplysninger.merge(nyeRefusjonsopplysninger).inspektør.refusjonsopplysninger,
        )
    }
    ...
    fun `ny refusjonsopplysning uten tom som starter tidligere enn forrige`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.mars, null, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.januar, null, 1000.daglig))
                .refusjonsopplysninger()
    ...
    fun `perfekt overlapp - bruker nye opplysninger`() {
        val refusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, 1.mars, 2000.daglig))
                .refusjonsopplysninger()
        val nyeRefusjonsopplysninger =
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.januar, 1.mars, 1000.daglig))
                .refusjonsopplysninger()
    ...
    fun `perioder kant i kant hvor siste periode har tom null`() {
        ...
        assertEquals(
            ...
            Refusjonsopplysninger(originaleRefusjonsopplysninger, LocalDateTime.now())
                .inspektør
                .refusjonsopplysninger,
        )
    }
    ...
    fun `senere periode uten tom`() {
        ...
        assertEquals(
            refusjonsopplysninger,
            Refusjonsopplysninger(refusjonsopplysninger, LocalDateTime.now())
                .inspektør
                .refusjonsopplysninger,
        )
    }
    ...
    fun `ny opplysning før oss`() {
        ...
        assertEquals(
            listOf(ny, eksisterende),
            Refusjonsopplysninger(listOf(eksisterende, ny), LocalDateTime.now())
                .inspektør
                .refusjonsopplysninger,
        )
    }
    ...
    fun `ny opplysning før med overlapp`() {
        ...
        assertEquals(
            1.mars,
            refusjonsopplysning.finnFørsteDatoForEndring(
                RefusjonsopplysningerBuilder().leggTil(eksisterende).build()
            ),
        )
        assertEquals(
            listOf(ny, Refusjonsopplysning(meldingsreferanseId1, 2.mars, 31.mars, 2000.daglig)),
            refusjonsopplysning.inspektør.refusjonsopplysninger,
        )
    }
    ...
    fun `refusjonsopplysninger med samme tidspunkt sorteres på fom`() {
        ...
        val marsFørst =
            RefusjonsopplysningerBuilder()
                .leggTil(mars, tidspunkt)
                .leggTil(januar, tidspunkt)
                .build()
        val januarFørst =
            RefusjonsopplysningerBuilder()
                .leggTil(januar, tidspunkt)
    ...
    fun `har refusjonsopplysninger for forventede dager`() {
        ...
        assertFalse(
            refusjonsopplysninger.harNødvendigRefusjonsopplysninger(
                skjæringstidspunkt,
                listOf(skjæringstidspunkt.forrigeDag),
            )
        )
        assertTrue(
            refusjonsopplysninger.harNødvendigRefusjonsopplysninger(
        ...
        assertFalse(
            refusjonsopplysninger.harNødvendigRefusjonsopplysninger(
                skjæringstidspunkt,
                2.januar til 1.februar,
            )
        )
        assertFalse(
            refusjonsopplysninger.harNødvendigRefusjonsopplysninger(
                skjæringstidspunkt,
                31.januar til 28.februar,
            )
        )
    }
    ...
    fun `kan gjenopprette refusjonsopplysninger som ikke overlapper`() {
        ...
        assertGjenopprettetRefusjonsopplysninger(
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, 31.januar, 1000.daglig))
        )
        assertGjenopprettetRefusjonsopplysninger(
            listOf(Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 1000.daglig))
        )
        assertGjenopprettetRefusjonsopplysninger(
            listOf(
    ...
    fun `Har ikke nødvendig refusjonsopplysninger etter oppholdsdager`() {
        ...
        val refusjonsopplysninger =
            Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 20000.månedlig)
                .refusjonsopplysninger
        assertTrue(
    ...
    fun `Har nødvendige refusjonsopplysninger når vi får nye refusjonsopplysninger for perioden etter oppholdet`() {
        ...
        val refusjonsopplysningerJanuar =
            Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 20000.månedlig)
                .refusjonsopplysninger
        assertTrue(
            harNødvendigeRefusjonsopplysninger(
        ...
        val refusjonsopplysningerFebruar =
            Refusjonsopplysning(meldingsreferanseId2, 1.februar, null, 25000.månedlig)
                .refusjonsopplysninger

        val oppdaterteRefusjonsopplysninger =
            refusjonsopplysningerJanuar.merge(refusjonsopplysningerFebruar)
        assertTrue(
            harNødvendigeRefusjonsopplysninger(
                1.januar,
                1.januar til 31.januar,
                oppdaterteRefusjonsopplysninger,
                arbeidsgiverperiode,
            )
        )
        assertTrue(
    ...
    fun `finner riktige beløp`() {
        ...
        val refusjonsopplysninger =
            RefusjonsopplysningerBuilder()
                ...
                .leggTil(
                    Refusjonsopplysning(meldingsreferanseId2, 1.februar, null, 1500.daglig),
                    LocalDateTime.now(),
                )
                .build()
    ...
    fun `Spør om refusjonsopplysninger utelukkende i gråsonen`() {
        ...
        val refusjonsopplysninger =
            Refusjonsopplysning(
                    meldingsreferanseId1,
                    førsteDagMedRefusjonsopplysning,
                    null,
                    1000.daglig,
                )
                .refusjonsopplysninger
    ...
    fun `hashCode skal fungere også for en åpen periode`() {
        val refusjonsopplysning =
            Refusjonsopplysning(meldingsreferanseId1, 1.januar, null, 1000.daglig)
    ...
    fun `Merger nye refusjonsopplysninger`() {
        ...
        assertEquals(
            ...
            eksisterendeRefusjonsopplysninger
                .merge(ønskedeRefusjonsopplysninger)
                .inspektør
                .refusjonsopplysninger,
        )
    }
    ...
    fun `saksbehandler forkorter refusjonsopplysningens snute`() {
        val inntektsmeldingId = meldingsreferanseId1
        val eksisterendeRefusjonsopplysninger =
            Refusjonsopplysning(inntektsmeldingId, 1.januar, null, 1000.daglig)
                .refusjonsopplysninger

        val overstyringId = meldingsreferanseId2
        val ønskedeRefusjonsopplysninger =
            Refusjonsopplysning(overstyringId, 10.januar, null, 1000.daglig).refusjonsopplysninger
    ...
    fun `saksbehandler forkorter refusjonsopplysningens hale`() {
        val inntektsmeldingId = meldingsreferanseId1
        val eksisterendeRefusjonsopplysninger =
            Refusjonsopplysning(inntektsmeldingId, 1.januar, 31.januar, 1000.daglig)
                .refusjonsopplysninger
    ...
    fun `saksbehandler legger til ny opplysning midt i en eksisterende`() {
        val inntektsmeldingId = meldingsreferanseId1
        val eksisterendeRefusjonsopplysninger =
            Refusjonsopplysning(inntektsmeldingId, 1.januar, null, 1200.daglig)
                .refusjonsopplysninger
    ...
    fun `saksbehandler rydder opp i rotete refusjonsopplysninger`() {
        ...
        val ønskedeRefusjonsopplysninger =
            Refusjonsopplysning(meldingsreferanseId2, 1.januar, null, beløp).refusjonsopplysninger

        assertEquals(
            ønskedeRefusjonsopplysninger,
            eksisterendeRefusjonsopplysninger.merge(ønskedeRefusjonsopplysninger),
        )
    }
    ...
    fun `bruker ikke refusjonsopplysning som er før førstefraværsdag ved lagring av tidsnære opplysninger`() {
        ...
        assertLikeRefusjonsopplysninger(
            listOf(Refusjonsopplysning(meldingsreferanseId2, 1.juli, null, INGEN, ARBEIDSGIVER)),
            resultat.inspektør.refusjonsopplysninger,
        )
    }
    ...
    internal companion object {
        ...
        private fun assertGjenopprettetRefusjonsopplysninger(
            refusjonsopplysninger: List<Refusjonsopplysning>
        ) {
            assertEquals(
                refusjonsopplysninger,
                refusjonsopplysninger.gjennopprett().inspektør.refusjonsopplysninger,
            )
        }
        ...
        private fun Refusjonsopplysninger.harNødvendigRefusjonsopplysninger(
            ...
            harNødvendigRefusjonsopplysninger(
                skjæringstidspunkt,
                periode.toList(),
                null,
                Aktivitetslogg(),
        ...
        private fun List<Refusjonsopplysning>.refusjonsopplysninger() =
            Refusjonsopplysninger(this, LocalDateTime.now())
        ...
        private fun RefusjonsopplysningerBuilder.leggTil(refusjonsopplysning: Refusjonsopplysning) =
            leggTil(refusjonsopplysning, LocalDateTime.now())
    }
}
