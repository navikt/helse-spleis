...
internal class RefusjonTilBeløpstidslinjeTest {
    ...
    fun `Siste refusjonsdag er satt`() {
        val refusjonstidslinje =
            refusjontidslinje(31.januar, førsteFraværsdag = 1.januar, beløp = 100.daglig, sisteRefusjonsdag = 20.januar)
        assertEquals(
            Beløpstidslinje.fra(1.januar til 20.januar, 100.daglig, kilde) + Beløpstidslinje.fra(21.januar til 31.januar, INGEN, kilde),
            refusjonstidslinje,
        )
    }
    ...
    fun `Siste refusjonsdag er satt til siste dag i vedtaksperioden`() {
        val refusjonstidslinje =
            refusjontidslinje(31.januar, førsteFraværsdag = 1.januar, beløp = 100.daglig, sisteRefusjonsdag = 31.januar)
        assertEquals(Beløpstidslinje.fra(1.januar til 31.januar, 100.daglig, kilde), refusjonstidslinje)
    }
    ...
    fun `Endringer i refusjon`() {
        ...
        assertEquals(
            Beløpstidslinje.fra(1.januar til 20.januar, 100.daglig, kilde) + Beløpstidslinje.fra(21.januar til 21.januar, INGEN, kilde) +
    ...
    fun `siste refusjonsdag før første fraværsdag`() {
        ...
        assertEquals(
            Beløpstidslinje.fra(5.januar til 5.januar, 100.daglig, kilde) + Beløpstidslinje.fra(6.januar til 31.januar, INGEN, kilde),
            refusjonstidslinje,
        )
    }
