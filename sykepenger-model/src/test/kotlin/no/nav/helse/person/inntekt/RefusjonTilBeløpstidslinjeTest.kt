...
internal class RefusjonTilBeløpstidslinjeTest {
    ...
    fun `Siste refusjonsdag er satt`() {
        val refusjonstidslinje = refusjontidslinje(
            31.januar,
        ...
        assertEquals(
            Beløpstidslinje.fra(
                ...
                100.daglig,
                kilde
            ) + Beløpstidslinje.fra(21.januar til 31.januar, INGEN, kilde), refusjonstidslinje
        )
    ...
    fun `Endringer i refusjon`() {
        ...
        assertEquals(
            Beløpstidslinje.fra(
                ...
                21.januar til 21.januar,
                INGEN,
                kilde
            ) + Beløpstidslinje.fra(
                22.januar til 30.januar,
                250.daglig,
                kilde
            ) + Beløpstidslinje.fra(31.januar til 31.januar, 125.daglig, kilde), refusjonstidslinje
        )
    }
    ...
    fun `siste refusjonsdag før første fraværsdag`() {
        ...
        assertEquals(
            Beløpstidslinje.fra(
                ...
                100.daglig,
                kilde
            ) + Beløpstidslinje.fra(6.januar til 31.januar, INGEN, kilde), refusjonstidslinje
        )
    }
