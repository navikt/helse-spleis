...
internal class ArbeidsgiverInntektsopplysningTest {
    ...
    fun `overstyr inntekter`() {
        ...
        assertEquals(
            expected,
            original.overstyrInntekter(skjæringstidspunkt, opptjening, emptyList(), EmptyLog),
        )
        assertEquals(
            listOf(a1Overstyrt, a2Opplysning),
            original.overstyrInntekter(skjæringstidspunkt, opptjening, new, EmptyLog),
        )
        val forMange = listOf(a1Overstyrt, a3Overstyrt)
        assertEquals(
            listOf(a1Overstyrt, a2Opplysning),
            original.overstyrInntekter(skjæringstidspunkt, opptjening, forMange, EmptyLog),
        )
    }
    ...
    fun `ny inntektsmelding uten endring i beløp endrer kun omregnet årsinntekt for skjønnsmessig fastsatt`() {
        ...
        val actual = original.overstyrInntekter(skjæringstidspunkt, opptjening, new, EmptyLog)
    ...
    fun `subsummerer etter overstyring`() {
        ...
        listOf(a1Opplysning)
            .overstyrInntekter(skjæringstidspunkt, opptjening, listOf(a1Overstyrt), jurist)
        SubsumsjonInspektør(subsumsjonslogg)
            .assertBeregnet(
                paragraf = paragraf,
                ...
                input =
                    mapOf(
                        ...
                        "overstyrtInntektFraSaksbehandler" to
                            mapOf("dato" to skjæringstidspunkt, "beløp" to overstyrtBeløp.månedlig),
    ...
    fun `deaktiverer en inntekt`() {
        ...
        val (aktive, deaktiverte) =
            opprinnelig.deaktiver(emptyList(), "a2", "Denne må bort", EmptyLog)
        assertEquals(a1Opplysning, aktive.single())
        assertEquals(a2Opplysning, deaktiverte.single())

        val (nyDeaktivert, nyAktivert) =
            deaktiverte.aktiver(aktive, "a2", "Jeg gjorde en feil, jeg angrer!", EmptyLog)
        ...
        assertThrows<RuntimeException> {
            emptyList<ArbeidsgiverInntektsopplysning>()
                .aktiver(opprinnelig, "a3", "jeg vil aktivere noe som ikke finnes", EmptyLog)
        }
    }
    ...
    fun `subsummerer deaktivering`() {
        ...
        val opprinnelig = listOf(a1Opplysning, a2Opplysning)
        val (aktive, deaktiverte) =
            opprinnelig.deaktiver(emptyList(), "a2", "Denne må bort", jurist)
        assertEquals(a1Opplysning, aktive.single())
        assertEquals(a2Opplysning, deaktiverte.single())
        SubsumsjonInspektør(subsumsjonslogg)
            .assertOppfylt(
    ...
    fun `subsummerer aktivering`() {
        ...
        val (deaktiverte, aktive) =
            opprinneligDeaktiverte.aktiver(opprinneligAktive, "a2", "Denne må tilbake", jurist)
