...
internal class ArbeidsgiverInntektsopplysningTest {
    ...
    fun `overstyr inntekter`() {
        ...
        val a1Overstyrt =
            ArbeidsgiverInntektsopplysning(
                "a1",
                skjæringstidspunkt til LocalDate.MAX,
                Saksbehandler(skjæringstidspunkt, UUID.randomUUID(), 3000.månedlig, "", null, LocalDateTime.now()),
                Refusjonsopplysninger(),
            )
        val a3Overstyrt =
            ArbeidsgiverInntektsopplysning(
                "a3",
                skjæringstidspunkt til LocalDate.MAX,
                Saksbehandler(skjæringstidspunkt, UUID.randomUUID(), 4000.månedlig, "", null, LocalDateTime.now()),
                Refusjonsopplysninger(),
            )
    ...
    fun `ny inntektsmelding uten endring i beløp i forhold Skatt endrer kun omregnet årsinntekt for skjønnsmessig fastsatt`() {
        ...
        val a1Opplysning =
            ArbeidsgiverInntektsopplysning(
                "a1",
                skjæringstidspunkt til LocalDate.MAX,
                SkjønnsmessigFastsatt(UUID.randomUUID(), skjæringstidspunkt, UUID.randomUUID(), 900.månedlig, skattA1, LocalDateTime.now()),
                Refusjonsopplysninger(),
            )
        val a2Opplysning =
            ArbeidsgiverInntektsopplysning(
    ...
    fun `deaktiverer en inntekt`() {
        ...
        assertThrows<RuntimeException> {
            emptyList<ArbeidsgiverInntektsopplysning>().aktiver(opprinnelig, "a3", "jeg vil aktivere noe som ikke finnes", EmptyLog)
        }
    }
