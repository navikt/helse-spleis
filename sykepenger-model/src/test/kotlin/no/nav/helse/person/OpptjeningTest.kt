...
internal class OpptjeningTest {
    ...
    fun `konkret opptjeningsperiode`() {
        ...
        assertEquals(
            (mandag den 29.januar).somPeriode(),
            arbeidsforhold.opptjeningsperiode(tirsdag den 30.januar),
        )
    }

    @Test
    fun `deaktivert arbeidsforhold`() {
        val arbeidsforhold = listOf(Arbeidsforhold(EPOCH, null, true))
        assertEquals(7.januar.somPeriode(), arbeidsforhold.opptjeningsperiode(8.januar))
    }

    @Test
    fun `uendelig opptjeningsperiode`() {
        val arbeidsforhold = listOf(Arbeidsforhold(EPOCH, null, false))
        assertEquals(EPOCH til 9.oktober, arbeidsforhold.opptjeningsperiode(10.oktober))
    }

    @Test
    fun `ingen opptjeningsperiode`() {
        val arbeidsforhold = listOf(Arbeidsforhold(8.januar, null, false))

        assertEquals(
            7.januar.somPeriode(),
            emptyList<Arbeidsforhold>().opptjeningsperiode(8.januar),
        )
        assertEquals(7.januar.somPeriode(), arbeidsforhold.opptjeningsperiode(8.januar))
    }
        ...
        val arbeidsforhold =
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    "a1",
                    listOf(Arbeidsforhold(1.januar, null, false)),
                )
            )
    ...
    fun `startdato for deaktivert arbeidsforhold`() {
        val arbeidsforhold =
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    "a1",
                    listOf(Arbeidsforhold(1.januar, null, true)),
                )
            )
        val opptjening = Opptjening.nyOpptjening(arbeidsforhold, 1.mars)
        ...
        val arbeidsforhold =
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    "orgnummer",
                    listOf(
                        Arbeidsforhold(ansattFom = 1.januar, ansattTom = null, deaktivert = false)
                    ),
                )
            )
        ...
        val arbeidsforhold =
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    "orgnummer",
                    listOf(
                        Arbeidsforhold(ansattFom = 1.januar, ansattTom = null, deaktivert = true)
                    ),
                )
            )
        val opptjening = Opptjening.nyOpptjening(arbeidsforhold, 1.januar.plusDays(28))
        ...
        val arbeidsforhold =
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    ...
                    listOf(
                        Arbeidsforhold(
                            ansattFom = søndag den 1.oktober(2017),
                            ansattTom = lørdag den 30.april(2022),
                            deaktivert = false,
                        )
                    ),
                ),
            ...
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    ...
                    listOf(
                        Arbeidsforhold(
                            ansattFom = søndag den 1.oktober(2017),
                            ansattTom = fredag den 29.april(2022),
                            deaktivert = false,
                        )
                    ),
                ),
            ...
            listOf(
                Opptjening.ArbeidsgiverOpptjeningsgrunnlag(
                    ...
                    listOf(
                        Arbeidsforhold(
                            ansattFom = søndag den 1.oktober(2017),
                            ansattTom = torsdag den 28.april(2022),
                            deaktivert = false,
                        )
                    ),
                ),
