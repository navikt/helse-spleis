...
internal class SpesifikkKontekstTest {
    ...
    fun `to string`() {
        assertEquals(
            "Person fødselsnummer: 1 aktørId: 2", SpesifikkKontekst(
            "Person", mapOf(
            "fødselsnummer" to "1",
            "aktørId" to "2"
        )
    ...
    fun `samme type og like kontekster er like`() {
        val ytelserKontekst = SpesifikkKontekst(
            "Utbetalingshistorikk", mapOf(
            "fødselsnummer" to "1",
            "aktørId" to "2",
        )
        )
        val utbetalingshistorikkKontekst = SpesifikkKontekst(
            "Utbetalingshistorikk", mapOf(
            "fødselsnummer" to "1",
            "aktørId" to "2",
        )
    ...
    fun `forskjellige typer gir forskjellige hashCodes`() {
        val kontekst1 = SpesifikkKontekst(
            "a", mapOf(
            "b" to "c",
            "c" to "e",
        )
        )
        val kontekst2 = SpesifikkKontekst(
            "b", mapOf(
            "b" to "c",
            "c" to "e",
        )
