...
internal class InfotrygdInntektsopplysningTest {
    ...
    fun `Bruker inntekt fra infotrygd fremfor inntekt fra inntektsmelding for å beregne sykepengegrunnlaget`() {
        ...
        assertEquals(25000.månedlig, historikk.grunnlagForSykepengegrunnlag(1.januar(2018))?.grunnlagForSykepengegrunnlag())
    }
    ...
    fun `Finner nærmeste inntekt fra Infotrygd, hvis det ikke finnes inntekt for skjæringstidspunkt`() {
        ...
        assertEquals(30000.månedlig, historikk.grunnlagForSykepengegrunnlag(1.januar, 11.januar)?.grunnlagForSykepengegrunnlag())
        assertEquals(25000.månedlig, historikk.grunnlagForSykepengegrunnlag(1.januar, 9.januar)?.grunnlagForSykepengegrunnlag())
