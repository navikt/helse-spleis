...
internal class Behovsamler(
    ...
    internal fun harBedtOmReplay(vedtaksperiodeId: UUID) = replays.any { it.vedtaksperiodeId == vedtaksperiodeId }
    ...
    private fun bekreftBehov(
        ...
        assertTrue(harBehov(filter, *behovtyper)) {
            ...
            "Forventer at [${behovtyper.joinToString { it.toString() }}] skal være etterspurt. Fant bare: [${behover.joinToString {
                it.type
                    .toString()
            }}]. ${melding()}"
        }
