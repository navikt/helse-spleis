...
internal abstract class AbstractDslTest {
    ...
    private val TestPerson.TestArbeidsgiver.testArbeidsgiverAsserter get() =
    ...
    protected fun List<String>.nyeVedtak(
        ...
        arbeidsforhold: List<Vilkårsgrunnlag.Arbeidsforhold> =
            map { orgnr ->
                Vilkårsgrunnlag.Arbeidsforhold(orgnr, LocalDate.EPOCH, null, Vilkårsgrunnlag.Arbeidsforhold.Arbeidsforholdtype.ORDINÆRT)
            },
    ) {
        forEach {
            it {
    ...
    protected fun nyttVedtak(
        ...
        a1,
    ).nyttVedtak(vedtaksperiode, grad, førsteFraværsdag, beregnetInntekt, refusjon, arbeidsgiverperiode, status, sykepengegrunnlagSkatt)
