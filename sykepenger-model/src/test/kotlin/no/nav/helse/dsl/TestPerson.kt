...
internal class TestPerson(
    ...
    inner class TestArbeidsgiver(
        ...
        internal fun håndterAvbruttSøknad(sykmeldingsperiode: Periode) =
            arbeidsgiverHendelsefabrikk.lagAvbruttSøknad(sykmeldingsperiode).håndter(Person::håndter)
                ...
                .lagVilkårsgrunnlag(
                    ...
                    arbeidsforhold
                        ?: arbeidsgivere.map { (orgnr, _) ->
                            Vilkårsgrunnlag.Arbeidsforhold(orgnr, LocalDate.EPOCH, null, Arbeidsforholdtype.ORDINÆRT)
                        },
                    inntektsvurderingForSykepengegrunnlag
                        ?: lagStandardSykepengegrunnlag(this.orgnummer, inntekt, inspektør.skjæringstidspunkt(vedtaksperiodeId)),
...
internal fun TestPerson.TestArbeidsgiver.nyttVedtak(
    ...
    val vedtaksperiode =
        tilGodkjenning(periode, grad, førsteFraværsdag, beregnetInntekt, refusjon, arbeidsgiverperiode, status, sykepengegrunnlagSkatt)
