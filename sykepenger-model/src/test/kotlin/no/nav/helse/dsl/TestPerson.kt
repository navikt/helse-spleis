...
internal class TestPerson(
    ...
    internal val person =
        Person(personidentifikator, fødselsdato.alder, jurist).also {
    ...
    internal fun arbeidsgiver(orgnummer: String) = arbeidsgivere.getOrPut(orgnummer) { TestArbeidsgiver(orgnummer) }
    ...
    inner class TestArbeidsgiver(
        ...
        internal fun håndterForkastSykmeldingsperioder(periode: Periode) = arbeidsgiverHendelsefabrikk.lagHåndterForkastSykmeldingsperioder(periode).håndter(Person::håndter)

        internal fun håndterAnmodningOmForkasting(vedtaksperiodeId: UUID) = arbeidsgiverHendelsefabrikk.lagAnmodningOmForkasting(vedtaksperiodeId).håndter(Person::håndter)
        ...
        private fun håndterInntektsmeldingReplay(forespørsel: Forespørsel) {
            ...
            arbeidsgiverHendelsefabrikk
                .lagInntektsmeldingReplay(forespørsel, håndterteInntektsmeldinger)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterYtelser(
            ...
            arbeidsgiverHendelsefabrikk
                .lagYtelser(vedtaksperiodeId, foreldrepenger, svangerskapspenger, pleiepenger, omsorgspenger, opplæringspenger, institusjonsoppholdsperioder, arbeidsavklaringspenger, dagpenger)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterUtbetalingsgodkjenning(
            ...
            val utbetalingId = UUID.fromString(kontekst.getValue("utbetalingId"))
            arbeidsgiverHendelsefabrikk
                .lagUtbetalingsgodkjenning(vedtaksperiodeId, godkjent, automatiskBehandling, utbetalingId, godkjenttidspunkt)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterVedtakFattet(
            ...
            arbeidsgiverHendelsefabrikk
                .lagVedtakFattet(vedtaksperiodeId, utbetalingId, automatisert, vedtakFattetTidspunkt)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterKanIkkeBehandlesHer(
            ...
            arbeidsgiverHendelsefabrikk
                .lagKanIkkeBehandlesHer(vedtaksperiodeId, utbetalingId, automatisert)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterUtbetalt(status: Oppdragstatus = Oppdragstatus.AKSEPTERT) {
            ...
            behovsamler.detaljerFor(orgnummer, Utbetaling).forEach { (detaljer, kontekst) ->
                ...
                val fagsystemId = detaljer.getValue("fagsystemId") as String
                arbeidsgiverHendelsefabrikk
                    .lagUtbetalinghendelse(utbetalingId, fagsystemId, status)
                    .håndter(Person::håndter)
            }
        }
        ...
        internal fun håndterPåminnelse(
            ...
            arbeidsgiverHendelsefabrikk
                .lagPåminnelse(vedtaksperiodeId, tilstand, tilstandsendringstidspunkt, nåtidspunkt, reberegning = reberegning)
                .håndter(Person::håndter)
        }
        ...
        internal fun håndterOverstyrTidslinje(overstyringsdager: List<ManuellOverskrivingDag>) =
            arbeidsgiverHendelsefabrikk
                .lagHåndterOverstyrTidslinje(overstyringsdager)
                .håndter(Person::håndter)
        ...
        internal fun håndterOverstyrInntekt(
            ...
            .lagOverstyrInntekt(hendelseId, skjæringstidspunkt, inntekt, organisasjonsnummer)
            .håndter(Person::håndter)
        ...
        internal fun håndterUtbetalingshistorikkEtterInfotrygdendring(
            ...
            .lagUtbetalingshistorikkEtterInfotrygdendring(utbetalinger, inntektshistorikk, besvart, id)
            .håndter(Person::håndter)

        internal fun håndterUtbetalingshistorikkForFeriepenger(opptjeningsår: Year) =
            personHendelsefabrikk
        ...
        internal fun antallFeriepengeutbetalingerTilArbeidsgiver() =
            behovsamler
                .detaljerFor(orgnummer, Utbetaling)
                .count { (behov, _) ->
