    ...
    fun `Vurderer alle dagtyper hvorvidt de er aktuelle i tidslinjen for subsumméring`() {
        val dager =
            listOf(
                    ...
                    3.januar.ikkeSubsummérbar {
                        Dag.ArbeidsgiverHelgedag(it, Økonomi.ikkeBetalt(), INGEN)
                    },
                    4.januar.ikkeSubsummérbar {
                        Dag.Arbeidsgiverdag(it, Økonomi.ikkeBetalt(), INGEN)
                    },
                    5.januar.ikkeSubsummérbar { Dag.ArbeidIkkeGjenopptattDag(it, INGEN) },
                    6.januar.subsummérbar { Dag.Feriedag(it, INGEN) },
                    7.januar.ikkeSubsummérbar {
                        Dag.ForeldetSykedag(it, Økonomi.ikkeBetalt(), INGEN)
                    },
        ...
        val (subsummérbareDager, ikkeSubsummérbareDager) =
            dager.partition { (_, _, skalSubsumméres) -> skalSubsumméres }
