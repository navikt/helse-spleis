...
internal class ArbeidsgiverUtbetalingerTest {
    ...
    private fun undersøke(
        ...
        ArbeidsgiverUtbetalinger(
            NormalArbeidstaker,
            fødselsdato.alder,
            mapOf(person.arbeidsgiver(ORGNUMMER) to { arbeidsgiverTidslinje }),
            historiskTidslinje,
            null,
        ...
        inspektør = person.arbeidsgiver(ORGNUMMER).inspektør.sisteUtbetalingstidslinjeberegning().inspektør
    }
