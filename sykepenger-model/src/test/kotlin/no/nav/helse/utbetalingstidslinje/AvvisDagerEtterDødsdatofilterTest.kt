...
internal class AvvisDagerEtterDødsdatofilterTest {
    ...
    fun `avvis dager for begge tidslinjer`() {
        val tidslinjer = listOf(tidslinjeOf(16.AP, 5.NAV), tidslinjeOf(16.AP, 5.NAV))
        val periode = Periode(1.januar, 21.januar)
    ...
    private fun undersøke(
        ...
        val resultat =
            AvvisDagerEtterDødsdatofilter(Alder(EPOCH, dødsdato))
                .filter(tidslinjer, periode, aktivitetslogg, EmptyLog)
