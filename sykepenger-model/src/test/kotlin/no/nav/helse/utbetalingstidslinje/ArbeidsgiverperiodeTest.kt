...
internal class ArbeidsgiverperiodeTest {
    ...
    fun `arbeidsgiverperiode anses som like om de slutter på samme dag`() {
        ...
        assertFalse(
            agp(1.januar til 16.januar)
                .apply { kjentDag(17.januar) }
    ...
    fun `arbeidsgiverperiode anses som like om de slutter på fredag eller helg`() {
        ...
        assertFalse(
            agp(12.januar til 27.januar)
                .apply { kjentDag(29.januar) }
    ...
    fun `har betalt`() {
        assertFalse(
            agp(1.januar til 16.januar).erFørsteUtbetalingsdagFørEllerLik(1.januar til 17.januar)
        )
        assertTrue(
            agp(1.januar til 16.januar)
                .utbetalingsdag(17.januar)
    ...
    fun `forventer opplysninger fra arbeidsgiver etter periode med opphold`() {
        agp(1.januar til 16.januar)
            .utbetalingsdag(17.januar)
            .oppholdsdag(18.januar)
            .utbetalingsdag(fredag den 19.januar)
            .utbetalingsdag(mandag den 22.januar)
            .also { agp ->
    ...
    fun `forventer opplysninger fra arbeidsgiver etter periode med opphold i helg`() {
        agp(1.januar til 16.januar)
            ...
            .utbetalingsdag(18.januar)
            .utbetalingsdag(fredag den 19.januar)
            .oppholdsdag(lørdag den 20.januar)
            .utbetalingsdag(mandag den 22.januar)
            .also { agp ->
    ...
    fun `forventer ikke opplysninger fra arbeidsgiver etter periode med kun helg`() {
        agp(1.januar til 16.januar)
            ...
            .also { agp ->
                ...
                assertFalse(
                    agp.forventerOpplysninger(lørdag den 20.januar til (søndag den 21.januar))
                )
                assertFalse(agp.forventerOpplysninger(20.januar til 21.januar))
                assertFalse(agp.forventerOpplysninger(22.januar til 23.januar))
                assertFalse(
                    agp.forventerOpplysninger(lørdag den 20.januar til (mandag den 22.januar))
                )
                assertFalse(
                    agp.forventerOpplysninger(fredag den 19.januar til (mandag den 22.januar))
                )
            }
    }
