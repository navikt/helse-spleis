...
internal class FeriepengeberegnerTest {
    ...
    private fun String.itPerson(periode: Periode) = periode.map { Feriepengeberegner.UtbetaltDag.InfotrygdPerson(this, it, InfotrygdPersonbeløp) }

    private fun itArbeidsgiver(periode: Periode) = ORGNUMMER.itArbeidsgiver(periode)

    private fun String.itArbeidsgiver(periode: Periode) = periode.map { Feriepengeberegner.UtbetaltDag.InfotrygdArbeidsgiver(this, it, InfotrygdArbeidsgiverbeløp) }
    ...
    private fun String.spleisArbeidsgiver(periode: Periode) = periode.map { Feriepengeberegner.UtbetaltDag.SpleisArbeidsgiver(this, it, SpleisArbeidsgiverbeløp) }

    private fun String.spleisPerson(periode: Periode) = periode.map { Feriepengeberegner.UtbetaltDag.SpleisPerson(this, it, SpleisPersonbeløp) }
