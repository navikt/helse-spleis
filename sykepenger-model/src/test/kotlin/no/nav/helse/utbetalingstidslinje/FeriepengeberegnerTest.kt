...
internal class FeriepengeberegnerTest {
    ...
    fun `kun utbetaling i spleis - 48 utbetalte dager`() {
        val feriepengeberegner =
            feriepengeberegner(spleisArbeidsgiver = spleisArbeidsgiver(1.januar til 17.januar))
    ...
    fun `kun utbetaling i spleis - 49 utbetalte dager`() {
        val feriepengeberegner =
            feriepengeberegner(spleisArbeidsgiver = spleisArbeidsgiver(1.januar til 18.februar))
    ...
    fun `feriepengedager beregnet fra arbeidsgiverutbetalinger i både spleis og infotrygd`() {
        ...
        assertEquals(
            (1.januar til 10.februar).toList() + (1.mars til 7.mars).toList(),
            feriepengeberegner.feriepengedatoer(),
        )
    }
    ...
    fun `beregner spleis sitt bidrag til feriepengene`() {
        ...
        assertEquals(
            41 * SpleisArbeidsgiverbeløp * UNG_SATS,
    ...
    fun `beregner infotrygd-arbeidsgiver sitt bidrag til feriepengene`() {
        ...
        assertEquals(
            10 * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdArbeidsgiver(),
        )
    }
    ...
    fun `beregner infotrygd sitt totale bidrag til feriepengene`() {
        ...
        assertEquals(
            (12 * InfotrygdPersonbeløp + 10 * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd(),
        )
    }
    ...
    fun `beregner spleis sitt bidrag til feriepengene for en arbeidsgiver`() {
        val feriepengeberegner =
            feriepengeberegner(spleisArbeidsgiver = spleisArbeidsgiver(1.januar til 10.januar))

        assertEquals(
            10 * SpleisArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForSpleisArbeidsgiver(ORGNUMMER),
        )
    ...
    fun `beregner spleis sitt bidrag til feriepengene for to arbeidsgivere`() {
        val feriepengeberegner =
            feriepengeberegner(
                spleisArbeidsgiver =
                    "456789123".spleisArbeidsgiver(1.januar til 10.januar) +
                        "789123456".spleisArbeidsgiver(1.januar til 12.januar)
            )

        assertEquals(
            (10 + 12) * SpleisArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForSpleisArbeidsgiver(),
        )
        assertEquals(
            10 * SpleisArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForSpleisArbeidsgiver("456789123"),
        )
        assertEquals(
            12 * SpleisArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForSpleisArbeidsgiver("789123456"),
        )
    }
    ...
    fun `beregner infotrygd-person sitt bidrag til feriepengene for en arbeidsgiver`() {
        val feriepengeberegner =
            feriepengeberegner(infotrygdPerson = itPerson(1.januar til 10.januar))

        assertEquals(
            10 * InfotrygdPersonbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdPerson(ORGNUMMER),
        )
    ...
    fun `beregner infotrygd-person sitt bidrag til feriepengene for to arbeidsgivere`() {
        val feriepengeberegner =
            feriepengeberegner(
                infotrygdPerson =
                    "456789123".itPerson(1.januar til 10.januar) +
                        "789123456".itPerson(1.januar til 12.januar)
            )

        assertEquals(
            (10 + 12) * InfotrygdPersonbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdPerson(),
        )
        assertEquals(
            10 * InfotrygdPersonbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdPerson("456789123"),
        )
        assertEquals(
            12 * InfotrygdPersonbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdPerson("789123456"),
        )
    }
    ...
    fun `beregner infotrygd-arbeidsgiver sitt bidrag til feriepengene for en arbeidsgiver`() {
        val feriepengeberegner =
            feriepengeberegner(infotrygdArbeidsgiver = itArbeidsgiver(1.januar til 10.januar))

        assertEquals(
            10 * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdArbeidsgiver(ORGNUMMER),
        )
        ...
        val feriepengeberegner =
            feriepengeberegner(
                infotrygdArbeidsgiver =
                    "456789123".itArbeidsgiver(1.januar til 10.januar) +
                        "789123456".itArbeidsgiver(1.januar til 12.januar)
            )

        assertEquals(
            (10 + 12) * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdArbeidsgiver(),
        )
        assertEquals(
            10 * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdArbeidsgiver("456789123"),
        )
        assertEquals(
            12 * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygdArbeidsgiver("789123456"),
        )
    }
    ...
    fun `beregner infotrygd sitt totale bidrag til feriepengene for en arbeidsgiver`() {
        ...
        assertEquals(
            (10 * InfotrygdPersonbeløp + 12 * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd(ORGNUMMER),
        )
            ...
            feriepengeberegner(
                infotrygdPerson =
                    "456789123".itPerson(1.januar til 10.januar) +
                        "789123456".itPerson(1.januar til 12.januar),
                infotrygdArbeidsgiver =
                    "456789123".itArbeidsgiver(1.januar til 14.januar) +
                        "789123456".itArbeidsgiver(1.januar til 16.januar),
            )

        assertEquals(
            ((10 + 12) * InfotrygdPersonbeløp + (14 + 16) * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd(),
        )
        assertEquals(
            (10 * InfotrygdPersonbeløp + 14 * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd("456789123"),
        )
        assertEquals(
            (12 * InfotrygdPersonbeløp + 16 * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd("789123456"),
        )
    }
    ...
    fun `beregner feriepengene for gammel person`() {
        ...
        assertEquals(
            (10 * InfotrygdPersonbeløp + 14 * InfotrygdArbeidsgiverbeløp) * GAMMEL_SATS,
            feriepengeberegner.beregnFeriepengerForInfotrygd(),
        )
        assertEquals(
            17 * SpleisArbeidsgiverbeløp * GAMMEL_SATS,
            feriepengeberegner.beregnFeriepengerForSpleisArbeidsgiver(),
        )
    }
    ...
    fun `beregner totalen av feriepengene til en arbeidsgiver`() {
        ...
        assertEquals(
            (10 * InfotrygdArbeidsgiverbeløp + 10 * SpleisArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForArbeidsgiver(ORGNUMMER),
        )
    }
    ...
    fun `beregner totalen av feriepengene til en person`() {
        ...
        assertEquals(
            (20 * InfotrygdPersonbeløp + 10 * SpleisPersonbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengerForPerson(ORGNUMMER),
        )
    }
    ...
    fun `beregner differansen av feriepengene som er utbetalt fra infotrygd og det som faktisk skal utbetales for arbeidsgiver`() {
        ...
        assertEquals(
            10 * SpleisArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnFeriepengedifferansenForArbeidsgiver(ORGNUMMER),
        )
    }
    ...
    fun `beregner differansen av feriepengene som er utbetalt fra infotrygd og det som faktisk skal utbetales for arbeidsgiver der infotrygd har brukt opp alle feriepengedagene`() {
        ...
        assertEquals(
            (10 * SpleisArbeidsgiverbeløp - 10 * InfotrygdArbeidsgiverbeløp) * UNG_SATS,
            feriepengeberegner.beregnFeriepengedifferansenForArbeidsgiver(ORGNUMMER),
        )
    }
    ...
    fun `beregner utbetalte feriepenger i infotrygd for en arbeidsgiver`() {
        ...
        assertEquals(
            38 * InfotrygdArbeidsgiverbeløp * UNG_SATS,
            feriepengeberegner.beregnUtbetalteFeriepengerForInfotrygdArbeidsgiver(ORGNUMMER),
        )
    }

    private fun itPerson(periode: Periode) = ORGNUMMER.itPerson(periode)

    private fun String.itPerson(periode: Periode) =
        periode.map {
            Feriepengeberegner.UtbetaltDag.InfotrygdPerson(this, it, InfotrygdPersonbeløp)
        }

    private fun itArbeidsgiver(periode: Periode) = ORGNUMMER.itArbeidsgiver(periode)

    private fun String.itArbeidsgiver(periode: Periode) =
        periode.map {
            Feriepengeberegner.UtbetaltDag.InfotrygdArbeidsgiver(
                this,
                it,
                InfotrygdArbeidsgiverbeløp,
            )
        }

    private fun spleisArbeidsgiver(periode: Periode) = ORGNUMMER.spleisArbeidsgiver(periode)

    private fun spleisPerson(periode: Periode) = ORGNUMMER.spleisPerson(periode)

    private fun String.spleisArbeidsgiver(periode: Periode) =
        periode.map {
            Feriepengeberegner.UtbetaltDag.SpleisArbeidsgiver(this, it, SpleisArbeidsgiverbeløp)
        }
    ...
    private fun feriepengeberegner(
        ...
        infotrygdArbeidsgiver: List<Feriepengeberegner.UtbetaltDag.InfotrygdArbeidsgiver> =
            emptyList(),
