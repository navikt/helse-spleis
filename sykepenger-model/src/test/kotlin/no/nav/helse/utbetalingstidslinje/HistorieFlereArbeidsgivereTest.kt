...
internal class HistorieFlereArbeidsgivereTest : HistorieTest() {
    ...
    fun `infotrygd ag1 - spleis ag 2 - spleis ag 1`() {
        ...
        assertSkjæringstidspunkt(utbetalingstidslinjeAG1, 1.mars til 16.mars, null)
        assertSkjæringstidspunkt(utbetalingstidslinjeAG1, 17.mars til 31.mars, 17.januar)
        ...
        assertSkjæringstidspunkt(utbetalingstidslinjeAG2, 1.februar til 16.februar, null)
        assertSkjæringstidspunkt(utbetalingstidslinjeAG2, 17.februar til 28.februar, 17.januar)
