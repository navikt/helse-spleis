...
internal class SykdomsgradfilterTest {
    ...
    fun `avvis dager for begge tidslinjer`() {
        val tidslinjer =
            listOf(tidslinjeOf(16.AP, 5.NAV(1200, 19.0)), tidslinjeOf(16.AP, 5.NAV(1200, 19.0)))
        val periode = Periode(1.januar, 21.januar)
    ...
    fun `avviser utbetaling når samlet grad er under 20 prosent`() {
        val tidslinjer =
            listOf(tidslinjeOf(16.AP, 5.NAV, 1.NAV(1200, 39)), tidslinjeOf(16.AP, 5.NAV, 1.FRI))
    ...
    fun `avviser ikke utbetaling når samlet grad er minst 20 prosent`() {
        val tidslinjer =
            listOf(tidslinjeOf(16.AP, 5.NAV, 1.NAV(1200, 40)), tidslinjeOf(16.AP, 5.NAV, 1.FRI))
        val periode = Periode(1.januar, 22.januar)
        val resultat = undersøke(tidslinjer, periode)
    ...
    private fun undersøke(
        ...
        val resultat =
            Sykdomsgradfilter(MinimumSykdomsgradsvurdering())
                .filter(tidslinjer, periode, aktivitetslogg, jurist)
