 ...
 */
internal class Skjæringstidspunkt(
    private val personsykdomstidslinje: Sykdomstidslinje,
) {
    fun beregnSkjæringstidspunkt(vedtaksperiode: Periode): LocalDate =
        beregnSkjæringstidspunktOrNull(vedtaksperiode) ?: vedtaksperiode.start

    fun beregnSkjæringstidspunktOrNull(vedtaksperiode: Periode): LocalDate? = finnSkjæringstidspunkt(vedtaksperiode)?.skjæringstidspunkt
    ...
    private fun søkEtterSkjæringstidspunkt(søkeperiode: Periode): Søkekontekst =
        traverserTidslinjenBaklengs(søkeperiode) { søkekontekst, dagen, dato ->
            when (dagen) {
                ...
                -> søkekontekst.oppholdsdag(søkeperiode, dato)
                ...
                is Dag.Sykedag,
                is Dag.SykedagNav,
                -> søkekontekst.potensieltSkjæringstidspunkt(dato)
    ...
    private sealed interface Søketilstand {
        ...
        fun potensieltSkjæringstidspunkt(
            kontekst: Søkekontekst,
            dagen: LocalDate,
        ): Søkekontekst = kontekst.copy(tilstand = HarPotensieltSkjæringstidspunkt, skjæringstidspunkt = dagen)

        // en dag som potensielt kan bygge bro mellom to sykdomsperioder (ferie, andre ytelser)
        fun potensieltGyldigOppholdsperiode(
            kontekst: Søkekontekst,
            dagen: LocalDate,
