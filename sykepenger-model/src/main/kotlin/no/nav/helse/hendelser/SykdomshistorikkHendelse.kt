...
interface SykdomshistorikkHendelse {
    ...
    class Hendelseskilde(
        ...
        companion object {
            ...
            private fun kildenavn(hendelse: Melding): String = hendelse.simpleName ?: "Ukjent"
        ...
        override fun equals(other: Any?) =
            other is Hendelseskilde &&
                type == other.type &&
                tidsstempel == other.tidsstempel &&
                meldingsreferanseId == other.meldingsreferanseId
        ...
        // todo: midlertidig fordi "Inntektsmelding" ikke er en SykdomshistorikkHendelse. Alle dager
        // med kilde "Inntektsmelding" må migreres til "BitFraInntektsmelding"
