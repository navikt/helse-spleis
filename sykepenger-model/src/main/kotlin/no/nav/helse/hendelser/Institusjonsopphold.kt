...
class Institusjonsopphold(private val perioder: List<Institusjonsoppholdsperiode>) {
    ...
    internal fun overlapper(aktivitetslogg: IAktivitetslogg, sykdomsperiode: Periode): Boolean {
        ...
        return perioder
            ...
            .also { overlapper ->
                if (!overlapper)
                    aktivitetslogg.info(
                        "Bruker har institusjonsoppholdsperioder, men det slår ikke ut på overlappssjekken"
                    )
            }
    }
}
