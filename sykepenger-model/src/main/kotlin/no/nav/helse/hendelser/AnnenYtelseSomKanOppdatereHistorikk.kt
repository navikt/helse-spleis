...
abstract class AnnenYtelseSomKanOppdatereHistorikk {
    ...
    companion object {
        ...
        internal fun List<GradertPeriode>.skalOppdatereHistorikkIHalen(
            ...
            val ytelseIHalen =
                vedtaksperiode.overlapperMed(ytelseperiode) && ytelseperiode.slutterEtter(
                    vedtaksperiode.endInclusive
                )
    ...
    internal fun skalOppdatereHistorikk(
        ...
        val (skalOppdatereHistorikk, hvorforIkke) = ytelse.skalOppdatereHistorikk(
            vedtaksperiode,
            skjæringstidspunkt,
