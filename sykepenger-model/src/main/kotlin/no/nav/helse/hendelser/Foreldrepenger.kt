...
class Foreldrepenger(
    ...
    private fun varselHvisForlengerForeldrepengerMerEnn14Dager(
        ...
        val harForeldrepengerAlleDager =
            foreldrepengeperiodeFør.periode.erRettFør(sykdomsperiode) && foreldrepengeperiodeFør.periode.count() > 14 && foreldrepengeperiodeFør.grad == 100
    ...
    override fun sykdomstidslinje(
        ...
        require(foreldrepengeytelse.map { it.periode }
            .grupperSammenhengendePerioder().size == 1) { "Ikke trygt å kalle sykdomstidslinjen til ${this.javaClass.simpleName} når det er huller i ytelser" }
        val hendelseskilde =
        ...
        val sykdomstidslinje = Sykdomstidslinje.andreYtelsedager(
            førsteDag,
            sisteDag,
            hendelseskilde,
