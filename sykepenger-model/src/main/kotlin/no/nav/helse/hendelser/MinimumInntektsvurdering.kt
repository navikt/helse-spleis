...
import no.nav.helse.person.Aktivitetslogg.Aktivitet.Etterlevelse.Vurderingsresultat.Companion.`§8-3 ledd 2 punktum 1`
...
internal fun validerMinimumInntekt(
    ...
    if (alder.forhøyetInntektskrav(skjæringstidspunkt))
        ...
        aktivitetslogg.`§8-3 ledd 2 punktum 1`(oppfylt, skjæringstidspunkt, grunnlagForSykepengegrunnlag.grunnlagForSykepengegrunnlag, minimumInntekt)
