...
class Inntektsmelding(
    ...
    private val refusjonsElement get() =
    ...
    internal val refusjonsservitør get() =
        Refusjonsservitør.fra(
            refusjon.refusjonstidslinje(type.refusjonsdato(this), arbeidsgiverperioder, metadata.meldingsreferanseId, metadata.innsendt),
        )
    ...
    internal fun nyeArbeidsgiverInntektsopplysninger(
        ...
        val startskudd =
            if (builder.ingenRefusjonsopplysninger(
    ...
    class Refusjon(
        ...
        internal fun refusjonstidslinje(
            ...
            check(
                alleRefusjonsopplysninger.isNotEmpty(),
            ...
            val refusjonstidslinje =
                alleRefusjonsopplysninger
                    .zipWithNext { nåværende, neste ->
                        Beløpstidslinje.fra(
                            nåværende.endringsdato.somPeriode().oppdaterTom(neste.endringsdato.forrigeDag),
                            nåværende.beløp,
                            kilde,
                        )
        ...
        private fun startskuddet(
            ...
            arbeidsgiverperioder.maxOf { it.start }
        } else {
            arbeidsgiverperioder.map { it.start }.plus(førsteFraværsdag).max()
        }
    ...
    internal fun dager(): DagerFraInntektsmelding = dager
    ...
    internal fun ikkeHåndert(
        ...
        val relevanteSykmeldingsperioder =
            sykmeldingsperioder.overlappendePerioder(dager) + sykmeldingsperioder.perioderInnenfor16Dager(dager)
    ...
    internal fun valider(
        ...
        if (førsteValidering ||
            type is ForkastetPortalinntektsmelding
        ) {
    ...
    private data class KlassiskInntektsmelding(
        ...
        override fun alternativInntektsdatoForInntekthistorikk(
            inntektsmelding: Inntektsmelding,
            alternativInntektsdato: LocalDate,
        ) = alternativInntektsdato.takeUnless {
            it ==
                inntektsdato(inntektsmelding)
        }
