...
private constructor(
    ...
    internal companion object {
        ...
        fun arbeidsforhold(hendelse: Hendelse, skjæringstidspunkt: LocalDate) =
            Revurderingseventyr(
                Arbeidsforhold,
                skjæringstidspunkt,
        ...
        fun tidligsteEventyr(a: Revurderingseventyr?, b: Revurderingseventyr?) =
            when {
                b == null ||
                    (a != null && a.periodeForEndring.start <= b.periodeForEndring.start) -> a
                else -> b
            }
    }
    ...
    private sealed interface RevurderingÅrsak {
        ...
        data object KorrigertInntektsmeldingInntektsopplysninger : RevurderingÅrsak {
            ...
            override fun dersomInngått(
                ...
                if (ingenAndrePåmeldt)
                    aktivitetslogg.varsel(
                        RV_IM_4,
                        "Inngår i revurdering på grunn av korrigert inntektsmelding",
                    )
                aktivitetslogg.info(
                    "korrigert inntektsmelding trigget revurdering på grunn av inntektsopplysninger"
                )
            }
