...
class ModelSendtSøknad(hendelseId: UUID,
    ...
    sealed class Periode {
        ...
        internal open fun valider(problemer: Problems) {}
        ...
        class Sykdom(internal val fom: LocalDate, internal val tom: LocalDate, private val grad: Int, private val faktiskGrad: Double = grad.toDouble()): Periode() {
            override fun sykdomstidslinje(sendtSøknad: ModelSendtSøknad) =
                ConcreteSykdomstidslinje.sykedager(fom, tom, sendtSøknad)

            override fun valider(problemer: Problems){
