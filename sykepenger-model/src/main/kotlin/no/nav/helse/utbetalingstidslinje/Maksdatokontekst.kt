...
internal data class Maksdatokontekst(
    ...
    internal fun beregnMaksdatoOgSubsummer(
        ...
        val maksdatoBegrensetRett = maxOf(
            forrigeVirkedag,
            alder.redusertYtelseAlder.sisteVirkedagInklusiv()
        ...
        val tidligsteDag =
            if (startdatoSykepengerettighet == LocalDate.MIN) startdatoTreårsvindu else minOf(
