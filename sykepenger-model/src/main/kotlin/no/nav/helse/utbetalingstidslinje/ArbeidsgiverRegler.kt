...
internal interface ArbeidsgiverRegler : DekningsgradKilde {
    ...
    companion object {
        internal object NormalArbeidstaker : ArbeidsgiverRegler {
            ...
            override fun burdeStarteNyArbeidsgiverperiode(oppholdsdagerBrukt: Int) = oppholdsdagerBrukt >= oppholdsdagerFørNyArbeidsgiverperiode

            override fun arbeidsgiverperiodenGjennomført(arbeidsgiverperiodedagerBrukt: Int) = arbeidsgiverperiodedagerBrukt >= arbeidsgiverperiodelengde
