...
internal class Arbeidsgiverperiodeberegner(
    ...
    private fun arbeidsgiverperiodeResultatet(dato: LocalDate): Arbeidsgiverperioderesultat =
        aktivArbeidsgiverperioderesultat ?: Arbeidsgiverperioderesultat(
    ...
    internal fun resultat(
        ...
        sykdomstidslinje.forEach { dag ->
            when (dag) {
                ...
                is Dag.UkjentDag -> {
                    if (dag.dato.erHelg()) {
                        tilstand.feriedag(this, dag.dato)
                    } else {
                        arbeidsdag(dag.dato)
                    }
                }
    ...
    private interface Tilstand {
        ...
        fun oppholdsdag(
            ...
            builder.aktivArbeidsgiverperioderesultat =
                builder.arbeidsgiverperiodeResultatet(dato).utvideMed(
                    dato = dato,
    ...
    private object Initiell : Tilstand {
        ...
        override fun feriedagMedSykmelding(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
        ) = feriedag(builder, dato)

        override fun andreYtelser(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
        ) = feriedag(builder, dato)

        override fun feriedagSomSyk(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
    ...
    private object ArbeidsgiverperiodeSisteDag : Tilstand {
        ...
        override fun feriedagMedSykmelding(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
        ): Unit = throw IllegalStateException("kan ikke ha fridag som siste dag i arbeidsgiverperioden")
        ...
        override fun andreYtelser(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
        ): Unit = throw IllegalStateException("kan ikke ha andre ytelser som siste dag i arbeidsgiverperioden")
    }

    private object Utbetaling : Tilstand {
        private fun kjentDag(
            builder: Arbeidsgiverperiodeberegner,
            dato: LocalDate,
        ) {
            builder.aktivArbeidsgiverperioderesultat =
