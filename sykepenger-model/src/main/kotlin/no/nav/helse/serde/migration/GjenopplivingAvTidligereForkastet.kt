...
internal abstract class GjenopplivingAvTidligereForkastet(version: Int): JsonMigration(version = version) {
    override val description = """Gjenoppliver tidligere forkastet vedtaksperioder som fortsatt har aktiv utbetaling"""

    protected abstract fun finnPerioder(jsonNode: ObjectNode): Set<String>

    protected fun finnPerioder(jsonNode: ObjectNode, predikat: (vedtaksperiodensPeriode: Periode, utbetalingensPeriode: Periode) -> Boolean): Set<String> {
                    ...
                    val utbetaling = utbetalinger.firstNotNullOfOrNull { (_, utbetalinger) ->
                        utbetalinger
                            ...
                            ?.takeIf { sisteUtbetaling ->
                                ...
                                predikat(vedtaksperiodensPeriode, utbetalingensPeriode)
                            }
                    }
