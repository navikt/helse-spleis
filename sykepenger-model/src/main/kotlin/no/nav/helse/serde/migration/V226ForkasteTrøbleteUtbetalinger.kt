...
internal class V227ForkasteTrøbleteUtbetalinger: JsonMigration(227) {
    ...
    override val description = "fjerner trøblete utbetalinger"
    ...
    override fun doMigration(jsonNode: ObjectNode, meldingerSupplier: MeldingerSupplier) {
        jsonNode.path("arbeidsgivere").forEach { arbeidsgiver ->
            ...
            if (trøbleteUtbetalinger.isNotEmpty()) {
                trøbleteUtbetalinger.forEach {
                    (it as ObjectNode).put("status", "FORKASTET")
                }
                ...
                sikkerlogg.info("V226: {} fjerner {} trøblete utbetalinger på arbeidsgiver {}: {}$ekstragreier",
