...
internal class FagsystemId private constructor(oppdragsliste: List<Oppdrag>) {
    ...
    internal fun annullere(aktivitetslogg: IAktivitetslogg, maksdato: LocalDate, saksbehandler: String, saksbehandlerEpost: String, godkjenttidspunkt: LocalDateTime) {
    ...
    private fun utbetale(aktivitetslogg: IAktivitetslogg, maksdato: LocalDate, saksbehandler: String, saksbehandlerEpost: String, godkjenttidspunkt: LocalDateTime, erAnnullering: Boolean) {
        head.utbetal(this)
