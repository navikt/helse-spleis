...
internal enum class Turneringsnøkkel {
    ...
    companion object {
        fun fraDag(dag: Dag) = when (dag) {
            ...
            is no.nav.helse.sykdomstidslinje.dag.ForeldetSykedag -> Kun_arbeidsgiverdag // TODO rename nøkkelen til det samme som dagen
            ...
            is SykHelgedag.Sykmelding -> SykHelgedag_SM // TODO: bruk samme nøkkel som sykedag, trenger vel ikke egen for helgedager
