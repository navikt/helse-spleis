...
internal enum class Turneringsnøkkel {
    ...
    companion object {
        fun fraDag(dag: Dag) =
            when {
                dag is Arbeidsgiverdag && dag.kommerFra(OverstyrTidslinje::class) ->
                    Arbeidsgiverdag_SB
                ...
                dag is ArbeidsgiverHelgedag && dag.kommerFra("Inntektsmelding") ->
                    ArbeidsgiverHelgedag_IM
                dag is SykHelgedag && dag.kommerFra("Inntektsmelding") -> ArbeidsgiverHelgedag_IM
                dag is ArbeidsgiverHelgedag && dag.kommerFra(Søknad::class) ->
                    ArbeidsgiverHelgedag_SØ
                ...
                dag is Dag.UkjentDag -> UkjentDag
                    ...
                    throw IllegalArgumentException(
                        "Ingen turneringsnøkkel definert for ${dag::class.simpleName}"
                    )
            }
    }
}
