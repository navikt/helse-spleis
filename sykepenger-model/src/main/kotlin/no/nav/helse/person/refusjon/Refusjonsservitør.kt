...
internal class Refusjonsservitør(input: Map<LocalDate, Beløpstidslinje> = emptyMap()) {
    ...
    internal fun servér(startdato: LocalDate, periode: Periode): Beløpstidslinje {
        ...
        val refusjonstidslinje = aktuelle.values.fold(Beløpstidslinje(), Beløpstidslinje::plus)
    ...
    internal fun dto() =
        RefusjonsservitørDto(refusjonsrester.mapValues { (_, beløpstidslinje) -> beløpstidslinje.dto() })
    ...
    internal companion object {
        ...
        internal fun fra(
            ...
            val sisteBit =
                sorterteStartdatoer.last() to refusjonstidslinje.fraOgMed(sorterteStartdatoer.last())
            val refusjonsopplysningerPerStartdato =
                sorterteStartdatoer.zipWithNext { nåværende, neste ->
        ...
        internal fun gjenopprett(dto: RefusjonsservitørDto) =
            Refusjonsservitør(dto.refusjonstidslinjer.mapValues { (_, beløpstidslinje) ->
