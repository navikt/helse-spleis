...
internal class Refusjonsopplysning(
    ...
    internal companion object {
        ...
        internal fun List<Refusjonsopplysning>.merge(nyeOpplysninger: List<Refusjonsopplysning>) = nyeOpplysninger.fold(this) { eksisterendeOpplysninger, nyOpplysning ->
            eksisterendeOpplysninger.fold(emptyList<Refusjonsopplysning>()) { hensyntattNyOpplysning, eksisterendeOpplysning ->
                hensyntattNyOpplysning + eksisterendeOpplysning.minus(nyOpplysning)
            }.plus(nyOpplysning).sortedBy { it.fom } // Litt teit da, nå kunne vel dette vært et Set?
        }
    }
