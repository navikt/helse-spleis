...
internal constructor(
    ...
    override fun overstyrer(gammel: SkjønnsmessigFastsatt) =
        if (erOmregnetÅrsinntektEndret(this, gammel)) this else gammel.overstyrer(this)
    ...
    internal companion object {
        internal fun gjenopprett(
            dto: InntektsopplysningInnDto.InntektsmeldingDto
        ): Inntektsmelding {
        ...
        internal fun List<Inntektsmelding>.avklarSykepengegrunnlag(
            ...
            val skatt =
                skattSykepengegrunnlag
                    ?.takeIf { it.kanBrukes(skjæringstidspunkt) }
