...
import no.nav.helse.person.etterlevelse.Bokstav.BOKSTAV_A
import no.nav.helse.person.etterlevelse.Bokstav.BOKSTAV_B
import no.nav.helse.person.etterlevelse.Bokstav.BOKSTAV_C
...
import no.nav.helse.person.etterlevelse.Ledd.LEDD_1
import no.nav.helse.person.etterlevelse.Ledd.LEDD_2
import no.nav.helse.person.etterlevelse.Ledd.LEDD_3
import no.nav.helse.person.etterlevelse.Ledd.LEDD_5
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_10
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_11
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_12
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_13
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_15
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_16
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_17
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_19
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_2
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_28
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_29
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_3
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_30
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_51
import no.nav.helse.person.etterlevelse.Paragraf.PARAGRAF_8_9
import no.nav.helse.person.etterlevelse.Punktum.Companion.punktum
