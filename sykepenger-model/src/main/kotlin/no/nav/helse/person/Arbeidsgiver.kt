...
internal class Arbeidsgiver private constructor(
    ...
    internal companion object {
        ...
        internal fun List<Arbeidsgiver>.håndterOverstyringAvRefusjon(
            ...
            forEach { arbeidsgiver ->
                ...
                val servitør = hendelse.refusjonsservitør(
                    startdatoer,
        ...
        internal fun Iterable<Arbeidsgiver>.nestemann() =
            sistePeriodeSomHarPågåendeUtbetaling() ?: periodeSomSkalGjenopptas()
        ...
        internal fun søppelbøtte(
            ...
            arbeidsgivere.flatMap { it.søppelbøtte(hendelse, aktivitetslogg, filter) }
        ...
        internal fun gjenopprett(
            ...
            val arbeidsgiver = Arbeidsgiver(
                ...
                feriepengeutbetalinger = dto.feriepengeutbetalinger.map {
                    Feriepengeutbetaling.gjenopprett(
                        alder,
                        it
                    )
                }.toMutableList(),
    ...
    private fun migrerUbrukteRefusjonsopplysninger(
        ...
        val sisteTom = listOfNotNull(
            sisteVedtaksperiode?.periode()?.endInclusive,
            sisteUtbetalteDagIInfotrygd
        ).maxOrNull()
        val refusjonsservitørFraRefusjonshistorikk = refusjonshistorikk.refusjonsservitør(
    ...
    override fun utbetalingUtbetalt(
        ...
        person.utbetalingUtbetalt(
            PersonObserver.UtbetalingUtbetaltEvent(
                ...
                personOppdrag = PersonObserver.UtbetalingUtbetaltEvent.OppdragEventDetaljer.mapOppdrag(
                    personOppdrag
                ),
    ...
    internal fun arbeidsgiverperiodeHensyntattEgenmeldinger(periode: Periode): Arbeidsgiverperiode? {
        ...
        val tøyseteKilde = SykdomshistorikkHendelse.Hendelseskilde(
            Søknad::class,
            UUID.randomUUID(),
            LocalDateTime.now()
        )
    ...
    internal fun finnSammenhengendeVedtaksperioder(vedtaksperiode: Vedtaksperiode): List<Vedtaksperiode> {
        val (perioderFør, perioderEtter) = vedtaksperioder.sorted()
            .partition { it før vedtaksperiode }
    ...
    private fun søppelbøtte(
        ...
        aktivitetslogg.kontekst(this)
        val perioder: List<Pair<Vedtaksperiode, Vedtaksperiode.VedtaksperiodeForkastetEventBuilder>> =
            vedtaksperioder
                .filter(filter)
    ...
    internal fun finnFørsteFraværsdag(
        ...
        val førstePeriodeMedUtbetaling = vedtaksperioder.filter(vedtaksperiodeFilter)
            .firstOrNull(SKAL_INNGÅ_I_SYKEPENGEGRUNNLAG(skjæringstidspunkt))
            ?: vedtaksperioder.filter(vedtaksperiodeFilter)
    ...
    private fun finnAlternativInntektsdato(
        ...
        return sykdomstidslinje().sisteSkjæringstidspunkt(inntektsdato.somPeriode())
            ?.takeUnless { it == inntektsdato }
    }
