...
internal class Infotrygdhistorikk private constructor(
    ...
    internal fun harEndretHistorikk(utbetaling: Utbetaling): Boolean {
        if (!harHistorikk()) return false
        val aktivtElementNårUtbetalingBleLaget = elementer.firstOrNull{
            it.varAktivFor(utbetaling)
        } ?: return true
        return siste.erEndretUtbetaling(aktivtElementNårUtbetalingBleLaget)
    }
