...
private constructor(
    ...
    internal companion object {
        ...
        internal fun gjenopprett(
            dto: InntektsopplysningInnDto.SkattSykepengegrunnlagDto
    ...
    override fun erSamme(other: Inntektsopplysning): Boolean {
        return other is SkattSykepengegrunnlag &&
            this.dato == other.dato &&
            this.inntektsopplysninger == other.inntektsopplysninger
    }
...
class AnsattPeriode(private val ansattFom: LocalDate, private val ansattTom: LocalDate?) {
    ...
    companion object {
        ...
        private fun List<AnsattPeriode>.harArbeidetMindreEnn(
            ...
            this.filter { it.harArbeidetMindreEnn(skjæringstidspunkt, antallMåneder) }
                .filter { it.gjelder(skjæringstidspunkt) }

        fun gjenopprett(dto: AnsattPeriodeDto) =
            AnsattPeriode(ansattFom = dto.fom, ansattTom = dto.tom)
    }
