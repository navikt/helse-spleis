...
internal class Inntektsgrunnlag private constructor(
    ...
    internal fun avvis(
        ...
        if (tidslinjeperiode.starterEtter(skjæringstidspunktperiode) ||
        ...
        val avvisningsperiode =
            skjæringstidspunktperiode.start til minOf(tidslinjeperiode.endInclusive, skjæringstidspunktperiode.endInclusive)
        val avvisteDager =
    ...
    internal fun overstyrArbeidsgiveropplysninger(
        ...
        val builder =
            ArbeidsgiverInntektsopplysningerOverstyringer(skjæringstidspunkt, arbeidsgiverInntektsopplysninger, opptjening, subsumsjonslogg)
    ...
    internal fun nyeArbeidsgiverInntektsopplysninger(
        ...
        val builder =
            ArbeidsgiverInntektsopplysningerOverstyringer(skjæringstidspunkt, arbeidsgiverInntektsopplysninger, null, subsumsjonslogg)
    ...
    internal class ArbeidsgiverInntektsopplysningerOverstyringer(
        ...
        internal fun ingenRefusjonsopplysninger(organisasjonsnummer: String) =
            opprinneligArbeidsgiverInntektsopplysninger.ingenRefusjonsopplysninger(organisasjonsnummer)

        internal fun resultat(): List<ArbeidsgiverInntektsopplysning> =
            opprinneligArbeidsgiverInntektsopplysninger.overstyrInntekter(
                skjæringstidspunkt,
                opptjening,
