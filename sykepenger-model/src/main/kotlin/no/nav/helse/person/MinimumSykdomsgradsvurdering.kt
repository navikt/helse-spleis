...
internal class MinimumSykdomsgradsvurdering(
    ...
    internal fun fjernDagerSomSkalUtbetalesLikevel(tentativtAvslåtteDager: List<Periode>) = tentativtAvslåtteDager.fjernPerioder(perioderMedMinimumSykdomsgradVurdertOK)
