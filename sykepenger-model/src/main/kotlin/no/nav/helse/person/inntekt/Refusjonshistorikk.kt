...
internal class Refusjonshistorikk {
    ...
    internal class Refusjon(
        ...
        private fun muligDuplikat(other: Refusjon) = this.meldingsreferanseId == other.meldingsreferanseId && this.utledetFørsteFraværsdag() == other.utledetFørsteFraværsdag()
        ...
        internal data class EndringIRefusjon(
            ...
            internal companion object {
                ...
                private fun List<Refusjon>.leggTilRefusjonsopplysninger(refusjonsopplysningerBuilder: RefusjonsopplysningerBuilder) = forEach { it.leggTilRefusjoneropplysninger(refusjonsopplysningerBuilder) }
                    ...
                    (endringerIRefusjon + hovedRefusjonsopplysning)
                        .forEach { endring ->
                            if (sisteRefusjonsdag != null && endring.endringsdato > sisteRefusjonsdag) {
                                return@forEach
                            } else if (endring.endringsdato < startskuddet) {
                                return@forEach
                            } else {
...
data class RefusjonshistorikkView(
    val refusjoner: List<RefusjonView>
)
