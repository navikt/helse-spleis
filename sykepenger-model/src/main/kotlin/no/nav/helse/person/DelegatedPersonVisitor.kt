...
internal class DelegatedPersonVisitor(private val delegateeFun: () -> PersonVisitor) : PersonVisitor {
    ...
    override fun visitInfo(aktivitet: Aktivitet.Info) {
        delegatee.visitInfo(aktivitet)
    }

    override fun visitVarsel(aktivitet: Aktivitet.Varsel) {
        delegatee.visitVarsel(aktivitet)
    }
