...
data class NyInntektUnderveis(
    ...
    companion object {
        internal fun List<NyInntektUnderveis>.finnEndringsdato(tidligere: List<NyInntektUnderveis>): LocalDate? {
        ...
        internal fun List<NyInntektUnderveis>.overstyr(hendelse: OverstyrArbeidsgiveropplysninger): List<NyInntektUnderveis> = hendelse.overstyr(this)
