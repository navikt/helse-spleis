...
class Dokumentsporing private constructor(
    val id: UUID,
    ...
    companion object {
        ...
        internal fun Iterable<Dokumentsporing>.tilSubsumsjonsformat() =
            map {
                Subsumsjonskontekst(
                    type =
    ...
    override fun hashCode(): Int = Objects.hash(id, dokumentType)
