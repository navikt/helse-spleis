...
data class ArbeidsgiverInntektsopplysning(
    ...
    private fun fastsattÅrsinntekt(
        acc: Inntekt,
        skjæringstidspunkt: LocalDate
    ): Inntekt = acc + beregningsgrunnlag(skjæringstidspunkt)

    private fun omregnetÅrsinntekt(
        acc: Inntekt,
        skjæringstidspunkt: LocalDate
    ): Inntekt = acc + omregnetÅrsinntekt(skjæringstidspunkt)
    ...
    internal companion object {
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.validerSkjønnsmessigAltEllerIntet(skjæringstidspunkt: LocalDate) = omregnetÅrsinntekter(skjæringstidspunkt, this).validerSkjønnsmessigAltEllerIntet()
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.overstyrTilkommendeInntekter(
            ...
            val somBeløpstidslinjer =
                this.mapNotNull { inntekt ->
                    if (!nyInntektUnderveis.erRelevantForOverstyring(skjæringstidspunkt, inntekt.gjelder)) {
                        null
                    } else {
                        inntekt.medBeløpstidslinje(kilde)
                    }
                }
        ...
        ): Boolean = Inntektsopplysning.erOmregnetÅrsinntektEndret(omregnetÅrsinntekter(skjæringstidspunkt, før), omregnetÅrsinntekter(skjæringstidspunkt, etter))

        private fun omregnetÅrsinntekter(
            skjæringstidspunkt: LocalDate,
            opplysninger: List<ArbeidsgiverInntektsopplysning>
        ): List<Inntektsopplysning> = opplysninger.filter { it.gjelderPåSkjæringstidspunktet(skjæringstidspunkt) }.map { it.inntektsopplysning }
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.markerFlereArbeidsgivere(aktivitetslogg: IAktivitetslogg) = map { it.inntektsopplysning }.markerFlereArbeidsgivere(aktivitetslogg)

        internal fun List<ArbeidsgiverInntektsopplysning>.refusjonsopplysninger(organisasjonsnummer: String) = singleOrNull { it.gjelder(organisasjonsnummer) }?.refusjonsopplysninger ?: Refusjonsopplysninger()
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.fastsattÅrsinntekt(skjæringstidspunkt: LocalDate) = fold(INGEN) { acc, item -> item.fastsattÅrsinntekt(acc, skjæringstidspunkt) }

        internal fun List<ArbeidsgiverInntektsopplysning>.totalOmregnetÅrsinntekt(skjæringstidspunkt: LocalDate) = fold(INGEN) { acc, item -> item.omregnetÅrsinntekt(acc, skjæringstidspunkt) }

        internal fun List<ArbeidsgiverInntektsopplysning>.finnEndringsdato(other: List<ArbeidsgiverInntektsopplysning>): LocalDate? {
            val endringsDatoer =
                this.mapNotNull { ny ->
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.harGjenbrukbareOpplysninger(organisasjonsnummer: String) = singleOrNull { it.orgnummer == organisasjonsnummer }?.inntektsopplysning?.gjenbrukbarInntekt() != null
