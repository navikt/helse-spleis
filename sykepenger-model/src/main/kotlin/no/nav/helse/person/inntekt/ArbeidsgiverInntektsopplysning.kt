...
data class ArbeidsgiverInntektsopplysning(
    ...
    internal companion object {
        ...
        private fun erOmregnetÅrsinntektEndret(
            ...
            Inntektsopplysning.erOmregnetÅrsinntektEndret(
        ...
        private fun omregnetÅrsinntekter(
            ...
            opplysninger
                .filter {
                    it.gjelderPåSkjæringstidspunktet(skjæringstidspunkt)
        ...
        internal fun List<ArbeidsgiverInntektsopplysning>.markerFlereArbeidsgivere(aktivitetslogg: IAktivitetslogg) =
            ...
            }.markerFlereArbeidsgivere(aktivitetslogg)
                    ...
                    builder.arbeidsgiverinntekt(
                        ...
                        skjønnsfastsatt =
                            if (arbeidsgiver.inntektsopplysning is SkjønnsmessigFastsatt) {
                                arbeidsgiver.inntektsopplysning
                                    .fastsattÅrsinntekt()
                            } else {
                                null
                            },
