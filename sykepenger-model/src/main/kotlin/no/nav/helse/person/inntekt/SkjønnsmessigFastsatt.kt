...
internal constructor(
    ...
    override fun omregnetÅrsinntekt(): Inntektsopplysning {
        return checkNotNull(overstyrtInntekt) { "overstyrt inntekt kan ikke være null" }
            .omregnetÅrsinntekt()
    }

    override fun gjenbrukbarInntekt(beløp: Inntekt?) =
        checkNotNull(overstyrtInntekt) { "overstyrt inntekt kan ikke være null" }
            .gjenbrukbarInntekt(beløp)
