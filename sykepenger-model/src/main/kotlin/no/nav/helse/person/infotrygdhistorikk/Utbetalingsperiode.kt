...
sealed class Utbetalingsperiode(
    ...
    override fun funksjoneltLik(other: Infotrygdperiode): Boolean {
        ...
        return this.orgnr == other.orgnr &&
            this.periode.start == other.periode.start &&
...
class ArbeidsgiverUtbetalingsperiode(
    ...
    internal companion object {
        internal fun gjenopprett(
            dto: InfotrygdArbeidsgiverutbetalingsperiodeInnDto
...
class PersonUtbetalingsperiode(
    ...
    internal companion object {
        internal fun gjenopprett(
            dto: InfotrygdPersonutbetalingsperiodeInnDto
