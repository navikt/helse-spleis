...
internal class ForkastetVedtaksperiode(private val vedtaksperiode: Vedtaksperiode) {
    ...
    internal companion object {
        ...
        internal fun List<ForkastetVedtaksperiode>.overlapperMed(
        ...
        internal fun Iterable<ForkastetVedtaksperiode>.slåSammenSykdomstidslinjer(
        ...
        internal fun hørerTilArbeidsgiverperiode(
            ...
            (forkastede.map { it.vedtaksperiode } + vedtaksperioder).sorted().filter {
