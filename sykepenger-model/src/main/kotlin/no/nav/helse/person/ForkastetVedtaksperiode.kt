...
internal class ForkastetVedtaksperiode(
    ...
    internal companion object {
        ...
        internal fun hørerTilArbeidsgiverperiode(forkastede: List<ForkastetVedtaksperiode>, vedtaksperioder: List<Vedtaksperiode>, arbeidsgiverperiode: Arbeidsgiverperiode): List<Vedtaksperiode> {
            val vedtaksperioderFraForkastede = forkastede.map { it.vedtaksperiode }
            return (vedtaksperioderFraForkastede + vedtaksperioder).sorted().filter {
