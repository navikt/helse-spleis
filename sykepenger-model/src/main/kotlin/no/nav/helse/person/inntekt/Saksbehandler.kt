...
internal constructor(
    ...
    constructor(
        ...
        tidsstempel: LocalDateTime,
    ) : this(UUID.randomUUID(), dato, hendelseId, beløp, forklaring, subsumsjon, null, tidsstempel)

    override fun gjenbrukbarInntekt(beløp: Inntekt?) =
        overstyrtInntekt?.gjenbrukbarInntekt(beløp ?: this.beløp)
    ...
    override fun subsumerSykepengegrunnlag(
        ...
        requireNotNull(forklaring) {
            "Det skal være en forklaring fra saksbehandler ved overstyring av inntekt"
        }
        if (
            subsumsjon.paragraf == Paragraf.PARAGRAF_8_28.ref &&
                subsumsjon.ledd == Ledd.LEDD_3.nummer &&
                subsumsjon.bokstav == Bokstav.BOKSTAV_B.ref.toString()
        ) {
            requireNotNull(startdatoArbeidsforhold) {
            ...
            subsumsjonslogg.logg(
                `§ 8-28 ledd 3 bokstav b`(
                    ...
                    overstyrtInntektFraSaksbehandler =
                        mapOf("dato" to dato, "beløp" to beløp.månedlig),
            ...
            subsumsjon.paragraf == Paragraf.PARAGRAF_8_28.ref &&
                subsumsjon.ledd == Ledd.LEDD_5.nummer
        ) {
            subsumsjonslogg.logg(
                `§ 8-28 ledd 5`(
                    organisasjonsnummer = organisasjonsnummer,
    ...
    internal companion object {
        fun gjenopprett(
            dto: InntektsopplysningInnDto.SaksbehandlerDto,
