...
internal class Vedtaksperiode private constructor(
    ...
    private fun håndterDager(
        ...
        val hendelse =
            dager.bitAvInntektsmelding(aktivitetslogg, periode) ?: dager.tomBitAvInntektsmelding(
                aktivitetslogg,
                periode,
            )
    ...
    internal fun håndter(
        ...
        if (behandlinger.gjelderIkkeFor(
    ...
    private val startdatoPåSammenhengendeVedtaksperioder
        get() =
            arbeidsgiver.startdatoPåSammenhengendeVedtaksperioder(
                this,
            )
    ...
    private fun manglerNødvendigInntektVedTidligereBeregnetSykepengegrunnlag(): Boolean =
        vilkårsgrunnlag?.harNødvendigInntektForVilkårsprøving(arbeidsgiver.organisasjonsnummer) == false
    ...
    private fun håndterOverlappendeSøknadRevurdering(
        ...
        if (søknad.delvisOverlappende(periode)) {
            return aktivitetslogg.funksjonellFeil(
        ...
        val vedtaksperioder =
            when {
                ...
                PersonObserver.Arbeidsgiverperiode in forespurteOpplysninger ->
                    vedtaksperioderIArbeidsgiverperiodeTilOgMedDenne(
                        arbeidsgiverperiode,
                    )
    ...
    private fun oppdaterHistorikk(
        ...
        ytelser.oppdaterHistorikk(
            ...
            skjæringstidspunkt,
            person
                .nåværendeVedtaksperioder(OVERLAPPENDE_ELLER_SENERE_MED_SAMME_SKJÆRINGSTIDSPUNKT(this))
                .firstOrNull()
                ?.periode,
        ) {
            oppdaterHistorikk(
    ...
    internal fun refusjonsservitørForUbrukteRefusjonsopplysninger(sisteUtbetalteDagIInfotrygd: LocalDate?): Refusjonsservitør? {
        val beløpstidslinje =
            vilkårsgrunnlag?.refusjonsopplysninger(arbeidsgiver.organisasjonsnummer)?.beløpstidslinje() ?: return null
    ...
    private fun beregnUtbetalinger(aktivitetslogg: IAktivitetslogg): Maksdatoresultat {
        ...
        val (maksdatofilter, beregnetTidslinjePerArbeidsgiver) =
            beregnUtbetalingstidslinjeForOverlappendeVedtaksperioder(
                aktivitetslogg,
                grunnlagsdata,
            )
    ...
    private fun filtrerUtbetalingstidslinjer(
        ...
        return maksdatofilter to
            beregnetTidslinjePerArbeidsgiver.mapValues { (arbeidsgiver, resultat) ->
                listOfNotNull(
                    historisktidslinjePerArbeidsgiver[arbeidsgiver],
                    resultat,
    ...
    private data object EtterInntektsmelding : ArbeidsgiveropplysningerStrategi() {
        ...
        override fun lagreGjenbrukbareOpplysninger(
            ...
            if (vedtaksperiode.tilstand == AvventerBlokkerendePeriode &&
                !arbeidsgiverperiode.forventerInntekt(
                    vedtaksperiode.periode,
                )
            ) {
    ...
    internal data object AvventerInntektsmelding : Vedtaksperiodetilstand {
        ...
        override fun igangsettOverstyring(
            ...
            if (vedtaksperiode.tilstand == AvventerInntektsmelding &&
                vedtaksperiode.sjekkTrengerArbeidsgiveropplysninger(
                    aktivitetslogg,
                )
            ) {
    ...
    internal data object AvventerBlokkerendePeriode : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            if (vedtaksperiode.forventerInntekt()) {
                return vedtaksperiode.håndterKorrigerendeInntektsmelding(
                    dager,
                    aktivitetslogg,
                )
            }
    ...
    internal companion object {
        ...
        internal fun List<Vedtaksperiode>.migrerRefusjonsopplysningerPåBehandlinger(
            ...
            forEach {
                it.behandlinger.migrerRefusjonsopplysninger(
                    aktivitetslogg,
                    orgnummer,
                    it::eksisterendeRefusjonsopplysninger,
                )
            }
        }
        ...
        internal val MED_SAMME_AGP_OG_SKJÆRINGSTIDSPUNKT = fun(segSelv: Vedtaksperiode): VedtaksperiodeFilter {
            ...
            return fun(other: Vedtaksperiode): Boolean {
                if (arbeidsgiverperiode != null &&
                    ...
                    return true // Forkaster samme arbeidsgiverperiode (kun for samme arbeidsgiver)
                }
        ...
        private fun sykmeldingsperioder(vedtaksperioder: List<Vedtaksperiode>): List<Periode> =
            vedtaksperioder.map { it.sykmeldingsperiode }
        ...
        internal fun List<Vedtaksperiode>.harIngenSporingTilInntektsmeldingISykefraværet(): Boolean =
            all {
                !it.behandlinger.harHåndtertInntektTidligere() && !it.behandlinger.harHåndtertDagerTidligere()
            }
            ...
            Vedtaksperiode(
                ...
                egenmeldingsperioder =
                    dto.egenmeldingsperioder.map { egenmeldingsperiode ->
                        egenmeldingsperiode.fom til
                            egenmeldingsperiode.tom
                    },
