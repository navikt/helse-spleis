...
internal class Vedtaksperiode private constructor(
    ...
    private fun håndterInntektsmelding(hendelse: Inntektsmelding, hvisInnenforArbeidsgiverperioden: Vedtaksperiodetilstand, hvisUtenforArbeidsgiverperioden: Vedtaksperiodetilstand) {
        håndterInntektsmelding(hendelse) {
            val nyTilstand = if (erInnenforArbeidsgiverperioden()) hvisInnenforArbeidsgiverperioden else hvisUtenforArbeidsgiverperioden
    ...
    private fun håndterSøknad(hendelse: SykdomstidslinjeHendelse, nesteTilstand: Vedtaksperiodetilstand?) {
        håndterSøknad(hendelse) { nesteTilstand }
    }
    ...
    private fun høstingsresultaterRevurdering(hendelse: ArbeidstakerHendelse, andreVedtaksperioder: List<Vedtaksperiode>) {
        ...
        when {
            Toggle.LageBrukerutbetaling.kanIkkeFortsette(hendelse, utbetaling(), harBrukerutbetaling(andreVedtaksperioder)) -> {
    ...
    internal interface Vedtaksperiodetilstand : Aktivitetskontekst {
        ...
        fun nyRevurderingFør(vedtaksperiode: Vedtaksperiode, revurdert: Vedtaksperiode, hendelse: ArbeidstakerHendelse) {
            ...
            if (revurdert.tilstand != AvsluttetUtenUtbetaling && vedtaksperiode.harSammeArbeidsgiverSom(revurdert) && vedtaksperiode.harUlikFagsystemId(revurdert.utbetaling())) {
    ...
    internal object MottattSykmeldingFerdigForlengelse : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, søknad: SøknadArbeidsgiver) {
            vedtaksperiode.håndterSøknadArbeidsgiver(søknad, vedtaksperiode.avgjørTilstandForInntekt())
    ...
    internal object MottattSykmeldingUferdigForlengelse : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, søknad: SøknadArbeidsgiver) {
            vedtaksperiode.håndterSøknadArbeidsgiver(søknad, AvventerInntektsmeldingUferdigForlengelse)
            søknad.info("Fullført behandling av søknad til arbeidsgiver")
        }
    ...
    internal object MottattSykmeldingFerdigGap : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            vedtaksperiode.håndterInntektsmelding(inntektsmelding, AvventerArbeidsgiversøknadFerdigGap, AvventerSøknadFerdigGap)
        }
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, søknad: SøknadArbeidsgiver) {
            vedtaksperiode.håndterSøknadArbeidsgiver(søknad, AvventerInntektsmeldingEllerHistorikkFerdigGap)
            søknad.info("Fullført behandling av søknad til arbeidsgiver")
        }
    ...
    internal object MottattSykmeldingUferdigGap : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, søknad: SøknadArbeidsgiver) {
            vedtaksperiode.håndterSøknadArbeidsgiver(søknad, AvventerInntektsmeldingUferdigGap)
            søknad.info("Fullført behandling av søknad til arbeidsgiver")
        }
        ...
        override fun håndter(
            ...
            vedtaksperiode.håndterInntektsmelding(inntektsmelding, AvventerArbeidsgiversøknadUferdigGap, AvventerSøknadUferdigGap)
        }
    }
    ...
    internal object AvventerSøknadFerdigGap : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, søknad: SøknadArbeidsgiver) {
            when {
                vedtaksperiode.erInnenforArbeidsgiverperioden() -> vedtaksperiode.håndterSøknad(søknad, AvsluttetUtenUtbetaling)
                else -> vedtaksperiode.forberedMuligUtbetaling(søknad)
            }
            søknad.info("Fullført behandling av søknad til arbeidsgiver")
        }
    }
    ...
    internal object AvventerInntektsmeldingUferdigGap : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, inntektsmelding: Inntektsmelding) {
            vedtaksperiode.håndterInntektsmelding(inntektsmelding, UtenUtbetalingMedInntektsmeldingUferdigGap, AvventerUferdigGap)
        }
    ...
    internal object AvventerInntektsmeldingUferdigForlengelse : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, inntektsmelding: Inntektsmelding) {
            vedtaksperiode.håndterInntektsmelding(inntektsmelding, UtenUtbetalingMedInntektsmeldingUferdigForlengelse, AvventerUferdigForlengelse)
        }
    }
