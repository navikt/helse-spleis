...
internal class Vedtaksperiode private constructor(
    ...
    internal fun kanForkastes(utbetalinger: List<Utbetaling>, vedtaksperioder: List<Vedtaksperiode>): Boolean {
    ...
    internal fun forkast(hendelse: IAktivitetslogg, utbetalinger: List<Utbetaling>, vedtaksperioder: List<Vedtaksperiode>): VedtaksperiodeForkastetEventBuilder? {
        if (!kanForkastes(utbetalinger, vedtaksperioder)) return null
        kontekst(hendelse)
