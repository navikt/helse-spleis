...
internal class Vedtaksperiode private constructor(
    ...
    private fun skalHåndtereDagerRevurdering(
        ...
        skalHåndtereDager(dager, aktivitetslogg) { sammenhengende ->
    ...
    private fun skalHåndtereDager(
        ...
        val sammenhengende =
            arbeidsgiver
                .finnSammenhengendeVedtaksperioder(this)
                .map { it.periode }
    ...
    internal fun håndter(
        ...
        person.igangsettOverstyring(Revurderingseventyr.Companion.annullering(hendelse, annullering.periode()), aktivitetslogg)
    }
    ...
    private fun manglerNødvendigInntektVedTidligereBeregnetSykepengegrunnlag(): Boolean = vilkårsgrunnlag?.harNødvendigInntektForVilkårsprøving(arbeidsgiver.organisasjonsnummer) == false
    ...
    private fun harTilkomneInntekter(): Boolean = vilkårsgrunnlag?.harTilkommendeInntekter() ?: false
    ...
    private fun håndterOverlappendeSøknad(
        ...
        person.igangsettOverstyring(Revurderingseventyr.Companion.korrigertSøknad(søknad, skjæringstidspunkt, periode), aktivitetslogg)
    }
    ...
    private fun håndterOverlappendeSøknadRevurdering(
        ...
        if (søknad.utenlandskSykmelding()) {
            return aktivitetslogg.funksjonellFeil(RV_SØ_29)
        } else {
    ...
    private fun håndterVilkårsgrunnlag(
        ...
        val sykepengegrunnlag = vilkårsgrunnlag.avklarSykepengegrunnlag(person, aktivitetslogg, jurist)
    ...
    private fun sendTrengerArbeidsgiveropplysninger(arbeidsgiverperiode: Arbeidsgiverperiode? = finnArbeidsgiverperiode()) {
        ...
        val forespurtInntektOgRefusjon =
            person.forespurtInntektOgRefusjonsopplysninger(arbeidsgiver.organisasjonsnummer, skjæringstidspunkt, periode) ?: listOf(
    ...
    private fun forespurtArbeidsgiverperiode(arbeidsgiverperiode: Arbeidsgiverperiode?) = if (trengerArbeidsgiverperiode(arbeidsgiverperiode)) PersonObserver.Arbeidsgiverperiode else null
    ...
    private fun forventerInntekt(): Boolean = Arbeidsgiverperiode.forventerInntekt(finnArbeidsgiverperiode(), periode)
    ...
    private fun venterTil(venterPå: Vedtaksperiode) =
        if (id == venterPå.id) {
            ...
            minOf(makstid(), venterPå.makstid())
        }

    private fun venteårsak() = tilstand.venteårsak(this)

    private fun makstid(tilstandsendringstidspunkt: LocalDateTime = oppdatert) = tilstand.makstid(this, tilstandsendringstidspunkt)
    ...
    private fun førstePeriodeAnnenArbeidsgiverSomTrengerInntektsmelding() = førstePeriodeAnnenArbeidsgiverSomTrengerInntekt() ?: førstePeriodeAnnenArbeidsgiverSomTrengerRefusjonsopplysninger()
    ...
    private fun filtrerUtbetalingstidslinjer(
        ...
        val historisktidslinje =
            historisktidslinjePerArbeidsgiver.values
    ...
    internal sealed interface Vedtaksperiodetilstand : Aktivitetskontekst {
        ...
        fun håndterRevurdering(aktivitetslogg: IAktivitetslogg): IAktivitetslogg = FunksjonelleFeilTilVarsler(aktivitetslogg)
    ...
    internal data object AvventerRevurdering : Vedtaksperiodetilstand {
        ...
        override fun venteårsak(vedtaksperiode: Vedtaksperiode): Venteårsak? = tilstand(vedtaksperiode, Aktivitetslogg()).venteårsak()
        ...
        private data class TrengerInntektsmelding(
        ...
        private data class HarFlereSkjæringstidspunkt(
            private val vedtaksperiode: Vedtaksperiode
        ) : Tilstand {
            override fun venterPå() = vedtaksperiode
    ...
    internal data object AvventerHistorikkRevurdering : Vedtaksperiodetilstand {
        ...
        override fun venteårsak(vedtaksperiode: Vedtaksperiode) = BEREGNING fordi OVERSTYRING_IGANGSATT
    ...
    internal data object AvventerInntektsmelding : Vedtaksperiodetilstand {
        ...
        override fun venteårsak(vedtaksperiode: Vedtaksperiode) = if (vedtaksperiode.harFlereSkjæringstidspunkt()) HJELP fordi FLERE_SKJÆRINGSTIDSPUNKT else INNTEKTSMELDING.utenBegrunnelse
        ...
        override fun skalHåndtereDager(
            ...
            dager: DagerFraInntektsmelding,
            aktivitetslogg: IAktivitetslogg
        ): Boolean = vedtaksperiode.skalHåndtereDagerAvventerInntektsmelding(dager, aktivitetslogg)
    ...
    internal data object AvventerBlokkerendePeriode : Vedtaksperiodetilstand {
        ...
        override fun venteårsak(vedtaksperiode: Vedtaksperiode): Venteårsak? = tilstand(Aktivitetslogg(), vedtaksperiode).venteårsak()
    ...
    internal data object AvventerVilkårsprøving : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            vedtaksperiode.håndterVilkårsgrunnlag(vilkårsgrunnlag, aktivitetslogg, AvventerHistorikk)
        }
    ...
    internal data object AvventerSimulering : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            if (!vedtaksperiode.behandlinger.erKlarForGodkjenning()) return aktivitetslogg.info("Kan ikke gå videre da begge oppdragene ikke er simulert.")
    ...
    internal data object RevurderingFeilet : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            arbeidsgivere: List<Arbeidsgiver>,
            infotrygdhistorikk: Infotrygdhistorikk
        ): Unit = throw IllegalStateException("Kan ikke håndtere søknad mens perioden er i RevurderingFeilet")
    ...
    internal data object TilInfotrygd : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            arbeidsgivere: List<Arbeidsgiver>,
            infotrygdhistorikk: Infotrygdhistorikk
        ): Unit = throw IllegalStateException("Kan ikke håndtere søknad mens perioden er i TilInfotrygd")
        ...
        override fun igangsettOverstyring(
            ...
            revurdering: Revurderingseventyr,
            aktivitetslogg: IAktivitetslogg
        ): Unit = throw IllegalStateException("Revurdering håndteres av en periode i til_infotrygd")
    }
    ...
    internal companion object {
        ...
        internal fun List<Vedtaksperiode>.finnSkjæringstidspunktFor(vedtaksperiodeId: UUID): LocalDate? = firstOrNull { it.id == vedtaksperiodeId }?.skjæringstidspunkt
        ...
        internal val SAMMENHENGENDE_PERIODER_HOS_ARBEIDSGIVER = fun(segSelv: Vedtaksperiode): VedtaksperiodeFilter {
            ...
            return fun (other: Vedtaksperiode): Boolean = other in sammenhengendeVedtaksperioder
        }
        ...
        internal fun List<Vedtaksperiode>.harIngenSporingTilInntektsmeldingISykefraværet(): Boolean = all { !it.behandlinger.harHåndtertInntektTidligere() && !it.behandlinger.harHåndtertDagerTidligere() }
        ...
        internal fun Iterable<Vedtaksperiode>.nestePeriodeSomSkalGjenopptas() = filter(IKKE_FERDIG_BEHANDLET).førstePeriode()
        ...
        internal fun List<Vedtaksperiode>.venter(nestemann: Vedtaksperiode) = mapNotNull { vedtaksperiode -> vedtaksperiode.tilstand.venter(vedtaksperiode, nestemann) }
        ...
        internal fun List<Vedtaksperiode>.slåSammenForkastedeSykdomstidslinjer(sykdomstidslinje: Sykdomstidslinje): Sykdomstidslinje = map { it.sykdomstidslinje }.plusElement(sykdomstidslinje).slåSammenForkastedeSykdomstidslinjer()
                    ...
                    PersonObserver.OverlappendeInfotrygdperiodeEtterInfotrygdendring(
                        ...
                        infotrygdperioder =
                            overlappende.map {
                                when (it) {
                                    is Friperiode ->
                                        PersonObserver.OverlappendeInfotrygdperiodeEtterInfotrygdendring.Infotrygdperiode(
