...
internal class Vedtaksperiode private constructor(
    ...
    internal fun håndterHistorikkFraInfotrygd(hendelse: Hendelse, infotrygdhistorikk: Infotrygdhistorikk) {
        kontekst(hendelse)
        infotrygdhistorikk.utbetalingshistorikkEtterInfotrygdendring(id, periode, tilstand.type.toString(), organisasjonsnummer, person) // TODO: Før ble bare dette sendt ved "endring", men bare bonus-feature at det nå også sendes ved vanlig utbetalingshistorikk?
    ...
    internal object AvsluttetUtenUtbetaling : Vedtaksperiodetilstand {
        ...
        override fun håndter(
            ...
            if (!vedtaksperiode.forventerInntekt()) return
            håndterInfotrygdendring(hendelse, vedtaksperiode, infotrygdhistorikk) // TODO: Denne kunne jo egentlig blitt inlinet nå
        }
