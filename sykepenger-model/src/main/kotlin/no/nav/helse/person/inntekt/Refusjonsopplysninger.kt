...
data class Refusjonsopplysning(
    ...
    private fun oppdatertTom(nyTom: LocalDate) =
        if (nyTom <
            ...
            Refusjonsopplysning(meldingsreferanseId, fom, nyTom, beløp, avsender, tidsstempel)
        }

    private fun begrensTil(dato: LocalDate): Refusjonsopplysning? =
        if (dekker(dato)) {
            oppdatertTom(dato.forrigeDag)
        } else {
            this
        }
    ...
    private fun aksepterer(
        skjæringstidspunkt: LocalDate,
        dag: LocalDate,
    ) = dag >= skjæringstidspunkt && dag < fom

    private fun funksjoneltLik(other: Refusjonsopplysning) = this.periode == other.periode && this.beløp == other.beløp
    ...
    class Refusjonsopplysninger private constructor(
        ...
        internal fun merge(other: Refusjonsopplysninger): Refusjonsopplysninger =
            Refusjonsopplysninger(validerteRefusjonsopplysninger.mergeInnNyeOpplysninger(other.validerteRefusjonsopplysninger))
        ...
        private fun harNødvendigRefusjonsopplysninger(
            ...
            val førsteRefusjonsopplysning =
                førsteRefusjonsopplysning() ?: return false.also {
                    aktivitetslogg.info(
        ...
        internal fun harNødvendigRefusjonsopplysninger(
            ...
            aktivitetslogg: IAktivitetslogg,
            organisasjonsnummer: String,
        ) = hensyntattSisteOppholdagFørPerioden(
            sisteOppholdsdagFørPerioden,
        ).harNødvendigRefusjonsopplysninger(skjæringstidspunkt, utbetalingsdager, aktivitetslogg, organisasjonsnummer)
