...
class Refusjonsopplysning(
    ...
    private fun trim(nyOpplysning: Refusjonsopplysning): List<Refusjonsopplysning> {
        return this.periode
            .trim(nyOpplysning.periode)
            .map {
                Refusjonsopplysning(
                    fom = it.start,
    ...
    internal companion object {
        ...
        private fun List<Refusjonsopplysning>.mergeInnNyOpplysning(nyOpplysning: Refusjonsopplysning, begrensetFra: LocalDate): List<Refusjonsopplysning> {
            ...
            // Beholder de delene som ikke dekkes av den nye opplysningen
            return flatMap { eksisterendeOpplysning -> eksisterendeOpplysning.trim(nyOpplysningBegrensetStart) }.plus(nyOpplysningBegrensetStart)
        }
    }
