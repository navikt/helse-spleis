...
sealed class Inntektsopplysning(
    ...
    internal open fun overstyrer(gammel: Saksbehandler): Inntektsopplysning = throw IllegalStateException("Kan ikke overstyre saksbehandler-inntekt")

    internal open fun overstyrer(gammel: SkjønnsmessigFastsatt): Inntektsopplysning = throw IllegalStateException("Kan ikke overstyre skjønnsmessig fastsatt-inntekt")
