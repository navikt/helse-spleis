...
class Alder(val fødselsdato: LocalDate, val dødsdato: LocalDate?) {
    ...
    companion object {
        ...
        internal fun gjenopprett(dto: AlderDto): Alder {
            return Alder(fødselsdato = dto.fødselsdato, dødsdato = dto.dødsdato)
        }
    ...
    // Forhøyet inntektskrav gjelder fra dagen _etter_ 67-årsdagen - se § 8-51 andre ledd der det
    // spesifiseres _mellom_.
    ...
    internal fun begrunnelseForMinimumInntekt(skjæringstidspunkt: LocalDate) =
        if (forhøyetInntektskrav(skjæringstidspunkt)) Begrunnelse.MinimumInntektOver67
        else Begrunnelse.MinimumInntekt
    ...
    internal fun beregnFeriepenger(opptjeningsår: Year, beløp: Int): Double {
        ...
        // TODO: subsumsjonObserver.`§8-33 ledd 3`(beløp, opptjeningsår, prosentsats,
        // alderVedSluttenAvÅret, feriepenger)
        return feriepenger
    }
