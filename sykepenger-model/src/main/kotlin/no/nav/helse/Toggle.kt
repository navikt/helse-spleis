...
class Toggle private constructor(enabled: Boolean) {
    ...
    companion object {
        ...
        val BrukRefusjonsopplysningerPåBehandling = Toggle(false)
        val RefusjonsopplysningerTilSpeilFraBehandling = fraEnv("REFUSJONSOPPLYSNINGER_TIL_SPEIL_FRA_BEHANDLING", true)
